...
class Faktor4 extends Controller
{
    ...
    public function ubah4()
    {
        ...
        if (isset($_POST['ubah4'])) {
            ...
            if (!$val) {
                ...
                //Update data
                $success = $this->model->ubah4($data, $id);
                if ($success) {
    ...
    public function approve($idFaktor4)
    {
        if (!is_numeric($idFaktor4) || $idFaktor4 <= 0) {
            session()->setFlashdata('err', 'ID Faktor tidak valid.');
            return redirect()->back();
        }

        $faktor = $this->faktor4Model->find($idFaktor4);
        if (!$faktor) {
        ...
        if ($this->faktor4Model->save($dataUpdate)) {
    ...
    public function unapprove($idFaktor4)
    {
        if (!is_numeric($idFaktor4) || $idFaktor4 <= 0) {
            session()->setFlashdata('err', 'ID Faktor tidak valid.');
            return redirect()->back();
    ...
    public function approveSemua()
    {
        ...
        // Update all records
        if ($this->faktor4Model->builder()->update($dataUpdate)) {
