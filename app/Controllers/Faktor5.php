...
class Faktor5 extends Controller
{
    ...
    public function approve($idFaktor5)
    {
        if (!is_numeric($idFaktor5) || $idFaktor5 <= 0) {
            session()->setFlashdata('err', 'ID Faktor tidak valid.');
            return redirect()->back();
        }

        $faktor = $this->faktor5Model->find($idFaktor5);
        if (!$faktor) {
        ...
        if ($this->faktor5Model->save($dataUpdate)) {
    ...
    public function unapprove($idFaktor5)
    {
        if (!is_numeric($idFaktor5) || $idFaktor5 <= 0) {
            session()->setFlashdata('err', 'ID Faktor tidak valid.');
            return redirect()->back();
    ...
    public function approveSemua()
    {
        ...
        // Update all records
        if ($this->faktor5Model->builder()->update($dataUpdate)) {
