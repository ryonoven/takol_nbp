...
class Showtks extends Controller
{
    protected $auth;
    protected $session;
    ...
    public function __construct()
    {
        ...
        $this->periodeModel = new M_periodetks();
    ...
    public function index()
    {
        ...
        $this->showtksModel->simpanProfilRisiko($dataToSave);
        ...
        $showtks = $this->showtksModel->getByKodebprAndPeriode($this->userKodebpr, $this->periodeId);

        if ($showtks && !empty($showtks['tanggal'])) {
            $showtks['tanggal_display'] = $this->formatDateForDisplay($showtks['tanggal']);
        } else {
            $showtks['tanggal_display'] = '';
        }

        $data = [
            'judul' => 'Laporan Tingkat Kesehatan Bank (TKS)',
            'bprData' => $bprData,
    ...
    private function calculateAllRiskValues($kodebpr, $periodeId, $force = false)
    {
        ...
        $existing = $this->showtksModel->getByKodebprAndPeriode($kodebpr, $periodeId);
    ...
    public function updateNtotalrisk()
    {
        ...
        try {
            ...
            $this->showtksModel->update($id, $data);

            return redirect()->to(base_url('Showtks'))
    ...
    public function resetNtotalrisk()
    {
        ...
        try {
            $existingData = $this->showtksModel->find($id);
    ...
    public function update()
    {
        ...
        $this->showtksModel->update($id, $data);
        return redirect()->to(base_url('Showtks'))->with('message', 'Data berhasil diupdate!');
    }
    ...
    public function updatecover()
    {
        ...
        if (empty($id)) {
            return redirect()->to(base_url('Showtks'))->with('error', 'ID tidak ditemukan!');
        }
    ...
    public function exporttxtlapprofrisk()
    {
        ...
        $tanggal = new \DateTime($profilTks['tanggal']);

        $titleDate = $tanggal->format('Ymd');
        $exportDate = $tanggal->format('Y-m-d');
        // Fetch data
        $data_showtks = $this->showtksModel->getDataByKodebprAndPeriode($kodebpr, $periodeId);
        ...
        usort($data_showtks, function ($a, $b) {
        ...
        $nkredit = isset($profilTks['nkredit']) ? str_replace(["\r", "\n"], ' ', $profilTks['nkredit']) : '0';
        $nbelumkredit = isset($profilTks['nbelumkredit']) ? str_replace(["\r", "\n"], ' ', $profilTks['nbelumkredit']) : '0';
        ...
        $nOperasional = isset($profilTks['noperasional']) ? str_replace(["\r", "\n"], ' ', $profilTks['noperasional']) : '0';
        $nbelumOperasional = isset($profilTks['nbelumoperasional']) ? str_replace(["\r", "\n"], ' ', $profilTks['nbelumoperasional']) : '0';
        ...
        $nKepatuhan = isset($profilTks['nkepatuhan']) ? str_replace(["\r", "\n"], ' ', $profilTks['nkepatuhan']) : '0';
        $nbelumKepatuhan = isset($profilTks['nbelumkepatuhan']) ? str_replace(["\r", "\n"], ' ', $profilTks['nbelumkepatuhan']) : '0';
        ...
        $nLikuiditas = isset($profilTks['nlikuiditas']) ? str_replace(["\r", "\n"], ' ', $profilTks['nlikuiditas']) : '0';
        $nbelumLikuiditas = isset($profilTks['nbelumlikuiditas']) ? str_replace(["\r", "\n"], ' ', $profilTks['nbelumlikuiditas']) : '0';
        ...
        $nReputasi = isset($profilTks['nreputasi']) ? str_replace(["\r", "\n"], ' ', $profilTks['nreputasi']) : '0';
        $nbelumReputasi = isset($profilTks['nbelumreputasi']) ? str_replace(["\r", "\n"], ' ', $profilTks['nbelumreputasi']) : '0';
        ...
        $nStratejik = isset($profilTks['nstratejik']) ? str_replace(["\r", "\n"], ' ', $profilTks['nstratejik']) : '0';
        $nbelumStratejik = isset($profilTks['nbelumstratejik']) ? str_replace(["\r", "\n"], ' ', $profilTks['nbelumstratejik']) : '0';
        $nTotalrisk = isset($profilTks['ntotalrisk']) ? str_replace(["\r", "\n"], ' ', $profilTks['ntotalrisk']) : '0';
        $nbelumTotalrisk = isset($profilTks['nbelumtotalrisk']) ? str_replace(["\r", "\n"], ' ', $profilTks['nbelumtotalrisk']) : '0';
        // $kesimpulan = isset($profilTks['kesimpulan']) ? str_replace(["\r", "\n"], ' ', $profilTks['kesimpulan']) : ' ';
        ...
        $kesimpulan = isset($profilTks['kesimpulan']) ? sanitizeText($profilTks['kesimpulan']) : ' ';
    ...
    public function exporttxtriskinheren()
    {
        ...
        $nkredit = isset($profilTks['nkredit']) ? str_replace(["\r", "\n"], ' ', $profilTks['nkredit']) : '';
        $kesimpulan1 = isset($profilTks['kesimpulan1']) ? str_replace(["\r", "\n"], ' ', $profilTks['kesimpulan1']) : '';
    ...
    public function exporttxtoperasional()
    {
        ...
        $noperasional = isset($profilTks['noperasional']) ? str_replace(["\r", "\n"], ' ', $profilTks['noperasional']) : '';
        $kesimpulan2 = isset($profilTks['kesimpulan2']) ? str_replace(["\r", "\n"], ' ', $profilTks['kesimpulan2']) : '';
    ...
    public function exporttxtkepatuhan()
    {
        ...
        $nkepatuhan = isset($profilTks['nkepatuhan']) ? str_replace(["\r", "\n"], ' ', $profilTks['nkepatuhan']) : '';
        $kesimpulan3 = isset($profilTks['kesimpulan3']) ? str_replace(["\r", "\n"], ' ', $profilTks['kesimpulan3']) : '';
    ...
    public function exporttxtlikuiditas()
    {
        ...
        $nlikuiditas = isset($profilTks['nlikuiditas']) ? str_replace(["\r", "\n"], ' ', $profilTks['nlikuiditas']) : '';
        $kesimpulan4 = isset($profilTks['kesimpulan4']) ? str_replace(["\r", "\n"], ' ', $profilTks['kesimpulan4']) : '';
    ...
    public function exporttxtreputasi()
    {
        ...
        $nreputasi = isset($profilTks['nreputasi']) ? str_replace(["\r", "\n"], ' ', $profilTks['nreputasi']) : '0';
        $kesimpulan5 = isset($profilTks['kesimpulan5']) ? str_replace(["\r", "\n"], ' ', $profilTks['kesimpulan5']) : '0';
    ...
    public function exporttxtstratejik()
    {
        ...
        $nstratejik = isset($profilTks['nstratejik']) ? str_replace(["\r", "\n"], ' ', $profilTks['nstratejik']) : '0';
        $kesimpulan6 = isset($profilTks['kesimpulan6']) ? str_replace(["\r", "\n"], ' ', $profilTks['kesimpulan6']) : '0';
    ...
    public function exportAllPDFToZipView()
    {
        ...
        return view('showtks/export_all_pdf_zip', $data);
    }
    ...
    public function exportAllToZip()
    {
        ...
        $laporanDate = new \DateTime($profilTks['tanggal']);
        $zipDate = $laporanDate->format('d-m-Y');


        $zipFileName = 'LAPORAN TKS NBPSIMPEL - ' . $namaBpr . " (" . $zipDate . ")" . '.zip';
    ...
    public function viewLembarPernyataan()
    {
        ...
        // Return view
        return view('showtks/lembar_pernyataan_pdf', $data);
    }
    ...
    public function exportLembarPernyataanJSON()
    {
        ...
        // Format tanggal
        $tanggal = '';
        if (!empty($showtks['tanggal'])) {
            $dateObj = \DateTime::createFromFormat('Y-m-d', $showtks['tanggal']);
            if ($dateObj) {
                // Format: 31 Juli 2025
                $bulan = [
                    '01' => 'Januari',
        ...
        return $this->response->setJSON([
            ...
            'data' => [
                ...
                'profil' => [
                    'lokasi' => $showtks['lokasi'] ?? '',
                    'tanggal' => $tanggal,
                    'pe' => $showtks['pe'] ?? '',
                    'dirut' => $showtks['dirut'] ?? '',
                    'dirkep' => $showtks['dirkep'] ?? ''
                ]
            ]
        ]);
    }
    ...
    public function viewLaporanProfilRisiko()
    {
        ...
        // Return view
        return view('Showtks/laporan_profil_risiko_pdf');
    }
