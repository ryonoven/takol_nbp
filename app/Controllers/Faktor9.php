...
class Faktor9 extends Controller
{
    ...
    public function approve($idFaktor9)
    {
        if (!is_numeric($idFaktor9) || $idFaktor9 <= 0) {
            session()->setFlashdata('err', 'ID Faktor tidak valid.');
            return redirect()->back();
        }

        $faktor = $this->faktor9Model->find($idFaktor9);
        if (!$faktor) {
        ...
        if ($this->faktor9Model->save($dataUpdate)) {
    ...
    public function unapprove($idFaktor9)
    {
        if (!is_numeric($idFaktor9) || $idFaktor9 <= 0) {
            session()->setFlashdata('err', 'ID Faktor tidak valid.');
            return redirect()->back();
    ...
    public function approveSemua()
    {
        ...
        // Update all records
        if ($this->faktor9Model->builder()->update($dataUpdate)) {
