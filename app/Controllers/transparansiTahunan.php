...
use App\Models\M_transparansiTahunan;

class transparansitahunan extends Controller
{
    protected $model;
    public function __construct()
    {
        $this->model = new M_transparansiTahunan();
    ...
    public function index()
    {
        ...
        $data = [
            'judul' => 'Transparansi Tahunan',
            'transparansiTahunan' => $this->model->getAllData()
        ];

        echo view('templates/v_header', $data);
        echo view('templates/v_sidebar');
        echo view('templates/v_topbar');
        echo view('transparansiTahunan/index', $data);
