        ...
        <div class="table-vertical">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span style="flex: 1; text-align: left;">
                    <?php
                    $allApproved = true;
                    $requiredFaktor4Ids = range(12, 12);
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php if (empty($faktors4)) { ?>
                            <tr>
                                <td scope="row"></td>
                                <td>Tidak Diisi (Modal inti dibawah Rp50.000.000.000)</td>
                                <td>Tidak Diisi (Modal inti dibawah Rp50.000.000.000)</td>
                                <td>Tidak Diisi (Modal inti dibawah Rp50.000.000.000)</td>
                                <td>Tidak Diisi (Modal inti dibawah Rp50.000.000.000)</td>
                            </tr>
                                ...
                                <td colspan="5" class="text-center">
                                    ...
                                    switch ($rataRata) {
                                        ...
                                        case 5:
                                            ...
                                            break;
                                        default:
                                            echo "Tidak Diisi (Modal inti dibawah Rp50.000.000.000).";
                                            break;
                                    }
                                    ?>
                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url('faktor4/ubah'); ?>" method="post">
                        ...
                        <input type="hidden" name="faktor4id" id="id-faktor4" value="">
                        <div class="mb-3">
...
<?php if (!empty($faktors4)) { ?>
    <div class="modal fade" id="modalUbahkesimpulan">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Kesimpulan Penilaian Faktor 4 </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
        ...
        <div class="modal-content">
            <form action="<?= base_url('faktor4/tambahNilai'); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor4_id" id="id-faktor4" readonly>
                    <div class="mb-3">
                        <label for="sub_category" class="form-label">Sub Kategori: </label>
                        <textarea class="form-control" name="sub_category" id="sub_category" style="height: 100px"
                            readonly></textarea>
