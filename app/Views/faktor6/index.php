            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url('faktor6/ubah'); ?>" method="post">
                        ...
                        <input type="text" name="faktor6id" id="id-faktor6" value="">
                        <div class="mb-3">
        ...
        <div class="modal-content">
            <form action="<?= base_url('faktor6/tambahNilai'); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="faktor6_id" id="id-faktor6" readonly>
                    <div class="mb-3">
                        <label for="sub_category" class="form-label">Sub Kategori: </label>
                        <textarea class="form-control" name="sub_category" id="sub_category" style="height: 100px"
                            readonly></textarea>
...
<script>
    $(document).ready(function () {
        // When the "Tambah Nilai" button is clicked, populate the id-faktor6 input field
        $('#modaltambahNilai').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var faktor6Id = button.data('id'); // Extract the faktor6_id from data-id attribute

            var modal = $(this);
            modal.find('#id-faktor6').val(faktor6Id); // Set the value of #id-faktor6 input
        });

        // Optional: if you need to clear the value of #id-faktor6 when closing the modal
        $('#modaltambahNilai').on('hidden.bs.modal', function () {
            $(this).find('#id-faktor6').val('');
        });
    });
</script>
