                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="totalaset"
                                            name="totalaset"
                                            placeholder="<?= !empty($kalkulatorData['totalaset'] ?? null) ? number_format($kalkulatorData['totalaset'], 0, ',', '.') : 'Masukkan nilai' ?>"
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBothOptions2"
                        ...
                        <div class="offcanvas-body">
                            <form id="riskForm2">
                                ...
                                <div class="mb-3">
                                    <label for="kydnpl5" class="form-label">KYD NPL Kolektibilitas 5</label>
                                    <div class="input-group">
                                        <span class="input-group-text">Rp</span>
                                        <input type="number" step="0.01" class="form-control" id="kydnpl5" name="kydnpl5"
                                            placeholder="<?= !empty($kalkulatorData['kydnpl5']) ? number_format($kalkulatorData['kydnpl5'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                            value="<?= esc($kalkulatorData['kydnpl5']) ?>" required>
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="kreditbermasalah" class="form-label">Kredit Bermasalah Neto</label>
                                    <div class="input-group">
                                        <span class="input-group-text">Rp</span>
                                ...
                                <div class="mb-3">
                                    <label for="kreditdpk2" class="form-label">Kredit Kolektibilitas 2 (DPK - Dalam Perhatian Khusus)</label>
                                    <div class="input-group">
                                        <span class="input-group-text">Rp</span>
