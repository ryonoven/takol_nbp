        ...
        <div class="table-vertical">
            <div class="button-bar">
                <a href="Showprofilresiko" class="kpmr-btn icon-link icon-link-hover" id="btn-laporan">🡸 Laporan Profil
                    Risiko</a>
                <a href="Risikokreditkpmr" class="kpmr-btn" id="btn-risiko">Risiko Kredit KPMR 🡺</a>
            </div>
                ...
                <div class="text-center flex-grow-1">
                    <div class="text-center">
                        <h4 class="mb-0">
                            ...
                            <strong>Tingkat Risiko Kredit</strong>
                        </h4>
            ...
            <div style="text-align: right;">
                <?php if ($allApproved): ?>
                    <span class="badge badge-success" style="font-size: 14px;">
                        ...
                        <?php
                        $approvedAt = $faktorsLookup[1]['approved_at'] ?? null;
                        echo $approvedAt
                            ? date('d/m/Y H:i:s', strtotime($approvedAt))
                            : '-';
                        ?>
                    </span>
                <?php else: ?>
            ...
            <div class="card-body">
                ...
                <button class="btn btn-primary mr-2 mb-3" type="button" data-bs-toggle="offcanvas"
                    ...
                    Kalkulator Komposisi Portofolio Aset dan Tingkat Konsentrasi Kredit
                </button>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBothOptions"
                    ...
                    <div class="offcanvas-body">
                        <form id="riskForm">
                            <div class="mb-3">
                                <label for="aba" class="form-label">Antar Bank Aktiva (ABA)</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="aba" name="aba"
                                        placeholder="<?= !empty($kalkulatorData['aba']) ? number_format($kalkulatorData['aba'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['aba']) ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="kydbank" class="form-label">Kredit Yang Diberikan (KYD) Kepada Bank
                                    (Gross)</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="kydbank" name="kydbank"
                                        placeholder="<?= !empty($kalkulatorData['kydbank']) ? number_format($kalkulatorData['kydbank'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['kydbank']) ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="kydpihak3" class="form-label">Kredit Yang Diberikan (KYD) Kepada Pihak
                                    Ketiga
                                    Bukan Bank (Gross)</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="kydpihak3"
                                        name="kydpihak3"
                                        placeholder="<?= !empty($kalkulatorData['kydpihak3']) ? number_format($kalkulatorData['kydpihak3'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['kydpihak3']) ?>" required>
                                </div>
                            </div>
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="totalaset"
                                        name="totalaset"
                            ...
                            <div class="mb-3">
                                <label for="total25debitur" class="form-label">Total Baki Debet 25 Debitur
                                    Terbesar</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="total25debitur"
                                        name="total25debitur"
                                        placeholder="<?= !empty($kalkulatorData['total25debitur']) ? number_format($kalkulatorData['total25debitur'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['total25debitur']) ?>" required>
                                </div>
                            </div>
                            <h5><b>Tiga Sektor Ekonomi Terbesar</b></h5>
                            <div class="mb-3">
                                <label for="perdagangan" class="form-label">Sektor Perdagangan</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="perdagangan"
                                        name="perdagangan"
                                        placeholder="<?= !empty($kalkulatorData['perdagangan']) ? number_format($kalkulatorData['perdagangan'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['perdagangan']) ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="jasa" class="form-label">Sektor Jasa</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="jasa" name="jasa"
                                        placeholder="<?= !empty($kalkulatorData['jasa']) ? number_format($kalkulatorData['jasa'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['jasa']) ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="konsumsirumah" class="form-label">Sektor Konsumsi Rumah Tangga</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="konsumsirumah"
                                        name="konsumsirumah"
                                        placeholder="<?= !empty($kalkulatorData['konsumsirumah']) ? number_format($kalkulatorData['konsumsirumah'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['konsumsirumah']) ?>" required>
                                </div>
                            </div>

                            <!-- Hidden fields for results -->
                            <input type="hidden" id="kydgross_hidden">
                            <input type="hidden" id="asetproduktif_hidden">
                            <input type="hidden" id="rasioasetproduktif_hidden">
                            <input type="hidden" id="rasiokreditdiberikan_hidden">
                            <input type="hidden" id="rasio25debitur_hidden">
                            <input type="hidden" id="sektorekonomi_hidden">
                            <input type="hidden" id="rasioekonomi_hidden">
                            <input type="hidden" id="rasioasetproduktif_submit">
                            <input type="hidden" id="rasiokreditdiberikan_submit">
                            <input type="hidden" id="rasio25debitur_submit">
                            <input type="hidden" id="rasioekonomi_submit">
                        ...
                        <div id="detailResult" style="display: none;" class="mt-4">
                            ...
                            <table class="table table-sm">
                                ...
                                <tr>
                                    <td>Total Aset</td>
                                    <td id="totalaset_display">-</td>
                                </tr>
                                <tr>
                                    <td>Rasio Aset Produktif</td>
                                    <td id="rasioasetproduktif">-</td>
                                </tr>
                                <tr>
                                    <td>Rasio Kredit Diberikan</td>
                                    <td id="rasiokreditdiberikan">-</td>
                                </tr>
                                <tr>
                                    <td>Rasio 25 Debitur</td>
                                    <td id="rasio25debitur">-</td>
                                </tr>
                                <tr>
                                    <td>Sektor Ekonomi</td>
                                    <td id="sektorekonomi">-</td>
                                </tr>
                                <tr>
                                    <td>Rasio Ekonomi</td>
                                    <td id="rasioekonomi">-</td>
                                </tr>
                            </table>
                ...
                <!-- Offcanvas Kalkulator 2 -->
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBothOptions2"
                    aria-labelledby="offcanvasWithBothOptions2Label">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasWithBothOptions2Label">
                            Kalkulator Kualitas Aset
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="offcanvas"
                            aria-label="Close">&times;</button>
                    ...
                    <div class="offcanvas-body">
                        <form id="riskForm2">
                            <div class="mb-3">
                                <label for="abanpl" class="form-label">ABA NPL</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="abanpl" name="abanpl"
                                        placeholder="<?= !empty($kalkulatorData['abanpl']) ? number_format($kalkulatorData['abanpl'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['abanpl']) ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="kydnpl3" class="form-label">KYD NPL Kolektibilitas 3</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="kydnpl3" name="kydnpl3"
                                        placeholder="<?= !empty($kalkulatorData['kydnpl3']) ? number_format($kalkulatorData['kydnpl3'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['kydnpl3']) ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="kydnpl4" class="form-label">KYD NPL Kolektibilitas 4</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="kydnpl4" name="kydnpl4"
                                        placeholder="<?= !empty($kalkulatorData['kydnpl4']) ? number_format($kalkulatorData['kydnpl4'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['kydnpl4']) ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="kreditdpk2" class="form-label">Kredit DPK 2</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="kreditdpk2"
                                        name="kreditdpk2"
                                        placeholder="<?= !empty($kalkulatorData['kreditdpk2']) ? number_format($kalkulatorData['kreditdpk2'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['kreditdpk2']) ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="kreditbermasalah" class="form-label">Kredit Bermasalah</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="kreditbermasalah"
                                        name="kreditbermasalah"
                                        placeholder="<?= !empty($kalkulatorData['kreditbermasalah']) ? number_format($kalkulatorData['kreditbermasalah'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['kreditbermasalah']) ?>" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="kreditrestruktur1" class="form-label">Kredit Restruktur 1</label>
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control" id="kreditrestruktur1"
                                        name="kreditrestruktur1"
                                        placeholder="<?= !empty($kalkulatorData['kreditrestruktur1']) ? number_format($kalkulatorData['kreditrestruktur1'], 0, ',', '.') : 'Masukkan nilai' ?>"
                                        value="<?= esc($kalkulatorData['kreditrestruktur1']) ?>" required>
                                </div>
                            </div>

                            <!-- Hidden fields -->
                            <input type="hidden" id="kydkoleknpl_hidden">
                            <input type="hidden" id="asetproduktifbermasalah_hidden">
                            <input type="hidden" id="rasioasetproduktifbermasalah_hidden">
                            <input type="hidden" id="rasiokreditbermasalah_hidden">
                            <input type="hidden" id="rasiokreditkualitasrendah_hidden">
                            <input type="hidden" id="rasioasetproduktifbermasalah_submit">
                            <input type="hidden" id="rasiokreditbermasalah_submit">
                            <input type="hidden" id="rasiokreditkualitasrendah_submit">

                            <button type="button" class="btn btn-primary w-100" onclick="calculateRiskKalkulator2()">
                                <i class="fas fa-calculator"></i> Hitung
                            </button>
                        </form>

                        <div id="riskResult2" class="risk-result mt-3"></div>

                        <div id="detailResult2" style="display: none;" class="mt-4">
                            <h6>Hasil Perhitungan:</h6>
                            <table class="table table-sm">
                                <tr>
                                    <td>KYD Kolek NPL</td>
                                    <td id="kydkoleknpl_display">-</td>
                                </tr>
                                <tr>
                                    <td>Aset Produktif Bermasalah</td>
                                    <td id="asetproduktifbermasalah_display">-</td>
                                </tr>
                                <tr>
                                    <td>Aset Produktif</td>
                                    <td id="asetproduktif_display2">-</td>
                                </tr>
                                <tr>
                                    <td>Rasio Aset Produktif Bermasalah</td>
                                    <td id="rasioasetproduktifbermasalah_display">-</td>
                                </tr>
                                <tr>
                                    <td>Rasio Kredit Bermasalah</td>
                                    <td id="rasiokreditbermasalah_display">-</td>
                                </tr>
                                <tr>
                                    <td>Rasio Kredit Kualitas Rendah</td>
                                    <td id="rasiokreditkualitasrendah_display">-</td>
                                </tr>
                            </table>

                            <button type="button" id="btnInsertRasio2" class="btn btn-success w-100 mt-2"
                                style="display: none;" onclick="insertRasioKualitasAsetToKertasKerja()">
                                <i class="fas fa-save"></i> Masukkan ke Kertas Kerja
                            </button>
                        </div>
                    </div>
...
<div class="modal fade" id="modalUbahkesimpulan">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Kepatuhankpmr/ubahkesimpulan'); ?>" method="post">
                    <?= csrf_field() ?>
...
<script>
    ...
    function calculateRiskKalkulator() {
        ...
        // Simpan nilai ANGKA BIASA (tanpa format) ke hidden input untuk submit
        ['kydgross', 'asetproduktif', 'rasioasetproduktif', 'rasiokreditdiberikan',
            'rasio25debitur', 'sektorekonomi', 'rasioekonomi'].forEach(field => {
                setHiddenValue(`${field}_hidden`, eval(field));
                if (field.startsWith('rasio')) {
                    setHiddenValue(`${field}_submit`, eval(field));
                }
            });
    ...
    function calculateRiskKalkulator2() {
        ...
        const kydkoleknpl = kydnpl3 + kydnpl4;
        const asetproduktifbermasalah = abanpl + kydkoleknpl;
        const kreditkualitasrendah = kreditdpk2 + kreditbermasalah + kreditrestruktur1;
        ...
        // Simpan nilai ANGKA BIASA ke hidden input
        ['kydkoleknpl', 'asetproduktifbermasalah', 'rasioasetproduktifbermasalah',
            'rasiokreditbermasalah', 'rasiokreditkualitasrendah'].forEach(field => {
                setHiddenValue(`${field}_hidden`, eval(field));
                if (field.startsWith('rasio')) {
                    setHiddenValue(`${field}_submit`, eval(field));
                }
        ...
        if (btnInsertRasio2 && (abanpl > 0 || kydnpl3 > 0 || kydnpl4 > 0)) {
    ...
    function insertRasioToKertasKerja() {
        insertRasioAjax('/Risikokredit/insertRasioToKertasKerja', {
            rasioasetproduktif: $('#rasioasetproduktif_submit').val(),
            rasiokreditdiberikan: $('#rasiokreditdiberikan_submit').val(),
            rasio25debitur: $('#rasio25debitur_submit').val(),
            rasioekonomi: $('#rasioekonomi_submit').val()
        }, '#btnInsertRasio', 'Rasio berhasil dimasukkan');
    }

    function insertRasioKualitasAsetToKertasKerja() {
        insertRasioAjax('/Risikokredit/insertRasioKualitasAsetToKertasKerja', {
            rasioasetproduktifbermasalah: $('#rasioasetproduktifbermasalah_submit').val(),
            rasiokreditbermasalah: $('#rasiokreditbermasalah_submit').val(),
            rasiokreditkualitasrendah: $('#rasiokreditkualitasrendah_submit').val()
        }, '#btnInsertRasio2', 'Rasio kualitas aset berhasil dimasukkan');
    }
            ...
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    ${factor.type === 'category' ? `
                        ...
                        <span style="display:none;" class="debug-keterangan-${factor.faktor_id}">
                            ${nilai?.keterangan || 'KOSONG'}
                        </span>
    ...
    $(document).ready(function () {
        ...
        $('form[action*="Risikokredit/ubahkesimpulan"]').on('submit', function (e) {
            e.preventDefault();
        ...
        // Approve/Unapprove semua handlers
