...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h1 class="h3 mb-4 text-gray-800 text-center"><?= $judul; ?><br>(E0900)</h1>
            <form id="paketKebijakanForm">
                ...
                <table class="table table-info table-hover mb-4">
                    <thead class="thead-primary">
                        <tr>
                            <th>1.1. Permasalah Hukum yang Telah Selesai (telah mempunyai kekuatan hukum yang tetap)
                            </th>
                        </tr>
                    </thead>
                </table>
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label for="hukumperdataselesai">a. Permasalahan Hukum Perdata yang Telah Selesai (telah
                                mempunyai
                                kekuatan hukum yang tetap):</label>
                            <div class="input-group">
                                <input type="text" name="hukumperdataselesai" id="hukumperdataselesai"
                                    class="form-control" style="height: 45px"
                                    value="<?= esc($masalahhukum[0]['hukumperdataselesai'] ?? '') ?>" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            <label for="hukumpidanaselesai">b. Permasalahan Hukum Pidana yang Telah Selesai (telah
                                mempunyai kekuatan hukum yang tetap):</label>
                            <div class="input-group">
                                <input type="text" name="hukumpidanaselesai" id="hukumpidanaselesai"
                                    class="form-control" style="height: 45px"
                                    value="<?= esc($masalahhukum[0]['hukumpidanaselesai'] ?? '') ?>" required>
                                <span class="input-group-text">Kasus</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-2 mt-4">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label for="hukumperdataproses">Permasalahan Hukum Perdata yang Dalam Proses
                                Penyelesaian:</label>
                            <div class="input-group">
                                <input type="text" name="hukumperdataproses" id="hukumperdataproses"
                                    class="form-control format-currency" style="height: 45px"
                                    value="<?= esc($masalahhukum[0]['hukumperdataproses'] ?? '') ?>" required>
                                <span class="input-group-text">Kasus</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label for="hukumpidanaproses">Permasalahan Hukum Pidana yang Dalam Proses
                                Penyelesaian:</label>
                            <div class="input-group">
                                <input type="text" name="hukumpidanaproses" id="hukumpidanaproses"
                                    class="form-control format-currency" style="height: 45px"
                                    value="<?= esc($masalahhukum[0]['hukumpidanaproses'] ?? '') ?>" required>
                                <span class="input-group-text">Kasus</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-2 mt-4">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label for="totalselesai">Total Permasalah Hukum yang Telah Selesai :</label>
                            <div class="input-group">
                                <input type="text" name="totalselesai" id="totalselesai"
                                    class="form-control format-currency" style="height: 45px"
                                    value="<?= esc($masalahhukum[0]['totalselesai'] ?? '') ?>" required readonly>
                                <span class="input-group-text">Kasus</span>
                                <input type="hidden" name="totalselesai" id="totalselesai_raw"
                                    value="<?= esc($masalahhukum[0]['totalselesai'] ?? '') ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label for="totalproses">Permasalah Hukum yang Dalam Proses Penyelesaian:</label>
                            <div class="input-group">
                                <input type="text" name="totalproses" id="totalproses"
                                    class="form-control format-currency" style="height: 45px"
                                    value="<?= esc($masalahhukum[0]['totalproses'] ?? '') ?>" required readonly>
                                <span class="input-group-text">Kasus</span>
                                <input type="hidden" name="totalproses" id="totalproses_raw"
                                    value="<?= esc($masalahhukum[0]['totalproses'] ?? '') ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <?php if (empty($penjelastindak)) { ?>
                            <tr>
                                <th class="table-info" style="width: 30%; color: black;">Penjelasan Lebih Lanjut mengenai
                                    Permasalahan Hukum yang Dihadapi (Opsional) :
                                </th>
                            </tr>
                            <tr>
                            ...
                            <div class="card shadow-sm approval-card">
                                <div class="card-body approval-card-body">
                                    ...
                                    <div class="approval-buttons-container"> <a
                                            href="<?= base_url('Masalahhukum/approveSemuaKom') ?>"
                                        ...
                                        <a href="<?= base_url('Masalahhukum/unapproveSemuaKom') ?>"
                        ...
                        <div class="col-md-3">
                            <div class="card shadow-sm approvaldir-card">
                                <div
                                    ...
                                    <div class="approval-buttons-container"> <a
                                            href="<?= base_url('Masalahhukum/approveSemuaDirut') ?>"
                                        ...
                                        <a href="<?= base_url('Masalahhukum/unapproveSemuaDirut') ?>"
                ...
                <div class="d-flex justify-content-center gap-2 mb-5 mt-4">
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        <a href="<?= base_url('Masalahhukum/exporttxtmasalahhukum'); ?>" class="btn btn-secondary btn-sm">
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group me-2" role="group" aria-label="First group">
                                <button type="button" class="btn btn-outline-primary btn-sm"
                                    onclick="window.location.href='<?= base_url('Fraudinternal') ?>'">
                                    << </button>
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            onclick="window.location.href='<?= base_url('Transaksikepentingan') ?>'">>></button>
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-1">
                        <a href="<?= base_url('Transaksikepentingan'); ?>" class="btn btn-link btn-sm">Kembali ke
                            halaman
                            periode</a>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Masalahhukum/tambahketerangan'); ?>" method="post">
...
<div class="modal fade" id="modaleditketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Ubah Penjelasan dan Tindak Lanjut (Opsional)</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('Masalahhukum/editketerangan'); ?>" method="post">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        $(document).ready(function () {
            function calculateTotals() {
                var totalSelesai = 0;
                totalSelesai += parseFloat($('#hukumperdataselesai').val().replace(/\D/g, '') || 0);
                totalSelesai += parseFloat($('#hukumpidanaselesai').val().replace(/\D/g, '') || 0);
                $('#totalselesai').val(new Intl.NumberFormat('id-ID').format(totalSelesai));
                $('#totalselesai_raw').val(totalSelesai.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ''));

                var totalProses = 0;
                totalProses += parseFloat($('#hukumperdataproses').val().replace(/\D/g, '') || 0);
                totalProses += parseFloat($('#hukumpidanaproses').val().replace(/\D/g, '') || 0);
                $('#totalproses').val(new Intl.NumberFormat('id-ID').format(totalProses));
                $('#totalproses_raw').val(totalProses.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ''));
            }

            $('input[id*="hukum"]').on('input', function () {
            ...
            $('#paketKebijakanForm').submit(function (e) {
                ...
                $.ajax({
                    url: '/Masalahhukum/tambahpenjelasAjax',
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
                    beforeSend: function () {
...
<script>
    ...
    $(document).ready(function () {
        $('#tambahPenjelasForm').submit(function (e) {
            ...
            $.ajax({
                url: '<?= base_url('Masalahhukum/tambahpenjelasAjax') ?>',
                type: 'POST',
                data: formData,
                dataType: 'json',
                success: function (response) {
                    if (response.status === 'success') {
                        form.find('#hukumperdataselesai').val(form.find('#hukumperdataselesai').val());
                        form.find('#hukumpidanaselesai').val(form.find('#hukumpidanaselesai').val());
                        form.find('#hukumperdataproses').val(form.find('#hukumperdataproses').val());
                        form.find('#hukumpidanaproses').val(form.find('#hukumpidanaproses').val());
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchAndDisplayComments(Id, kodebpr, periodeId) {
            ...
            $.ajax({
                url: '<?= base_url('masalahhukum/getKomentarByFaktorId'); ?>/' + Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                $.ajax({
                    url: '<?= base_url('Masalahhukum/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function pollUnreadCounts() {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('Masalahhukum/getUnreadCommentCountForFactor'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function refreshBadgeForAllUsers(exceptUserId) {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('Masalahhukum/getUnreadCommentCountForAllUsers'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
