...
<div class="container-fluid">
    ...
    <div class="card card-body">
        <div class="table-vertical">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span style="flex: 1; text-align: left;">
                    <?php
                    $allApproved = true;
                    $requiredFaktor12Ids = range(1, 8);

                    foreach ($requiredFaktor12Ids as $faktor12Id) {
                        $item = array_filter(
                            $faktors12,
                            fn($f) =>
                            $f['id'] == $faktor12Id
                            ...
                            <?php foreach ($faktors12 as $row): ?>
                                <?php if ($row['sph'] == 'Struktur'): ?>
                                    <tr>
                                        ...
                                        $userSpecificData = array_filter($faktors12, function ($item) use ($row, $kodebpr, $periodeId) {
                                        ...
                                        <td>
                                            ...
                                            $initialUnreadCount = $commentReads12Model->countUnreadCommentsForUserByFactor(
                                                $row['id'],
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekomValue == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor12/unapprovedekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor12id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor12/accdekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor12id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom2): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekom2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor12/unapprovedekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor12id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor12/accdekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor12id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDireksi2 || $userInGroupDireksi): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdir2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor12/unapprovedir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor12id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor12/accdir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor12id" value="<?= $row['id']; ?>" />
        ...
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <span class="label" style="flex: 3; margin-right: 10px;">
                <strong>Kesimpulan Penilaian Faktor 12 (Rencana Bisnis BPR)</strong>
            </span>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <thead>
                    <tr>
                        <th colspan="5" class="text-center">Nilai Faktor 12</th>
                    </tr>
                                ...
                                <td colspan="5" class="text-center">
                                    ...
                                    switch ($rataRata) {
                                        case 1:
                                            ...
                                            echo "<li>Rencana bisnis BPR telah disusun secara realistis, komprehensif, dan terukur (achievable) oleh Direksi dan disetujui oleh Dewan Komisaris sesuai dengan visi dan misi BPR, serta menggambarkan rencana strategis jangka panjang dan rencana bisnis tahunan dan direalisasikan sesuai dengan perencanaan sehingga indikator kinerja keuangan dan nonkeuangan dalam rencana bisnis tercapai melebihi target yang ditetapkan, termasuk penyampaian laporan rencana bisnis secara lengkap, akurat, kini, utuh, dan tepat waktu.</li>";
                                            echo "<li>Rencana bisnis BPR yang telah disusun didukung oleh pemegang saham yang ditunjukkan dengan pemenuhan seluruh komitmen dalam rangka memperkuat permodalan dan infrastruktur.</li>";
                                            echo "</ol>";
                                            break;
                                        case 2:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<li>Rencana bisnis BPR yang telah disusun didukung oleh pemegang saham yang ditunjukkan dengan pemenuhan sebagian besar komitmen dalam rangka memperkuat permodalan dan infrastruktur.</li>";
                                            echo "</ol>";
                                            break;
                                        case 3:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Rencana bisnis BPR telah disusun secara realistis, komprehensif, dan terukur (achievable) oleh Direksi dan disetujui oleh Dewan Komisaris sesuai dengan visi dan misi BPR, serta menggambarkan rencana strategis jangka panjang dan rencana bisnis tahunan dan sebagian besar direalisasikan sesuai dengan perencanaan sehingga indikator kinerja keuangan dan nonkeuangan dalam rencana bisnis tercapai sebagian sesuai target yang ditetapkan, termasuk penyampaian laporan rencana bisnis secara lengkap, akurat, kini, utuh, dan tepat waktu.</li>";
                                            echo "<li>Rencana bisnis BPR yang telah disusun didukung oleh pemegang saham namun pemenuhan komitmen dalam rangka memperkuat permodalan dan infrastruktur hanya dilakukan sebagian.</li>";
                                            echo "</ol>";
                                            break;
                                        case 4:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Rencana bisnis BPR belum sepenuhnya disusun secara realistis, komprehensif, dan terukur (achievable) oleh Direksi dan disetujui oleh Dewan Komisaris, serta kurang menggambarkan rencana strategis jangka panjang dan rencana bisnis tahunan dan direalisasikan kurang sesuai dengan perencanaan sehingga indikator kinerja keuangan dan nonkeuangan dalam rencana bisnis tidak tercapai target yang ditetapkan, termasuk laporan rencana bisnis tidak sepenuhnya disampaikan secara lengkap, akurat, kini, utuh dan tepat waktu.</li>";
                                            echo "<li>Rencana bisnis BPR yang telah disusun belum sepenuhnya didukung oleh pemegang saham yang ditunjukkan dengan pemenuhan sebagian kecil komitmen dalam rangka memperkuat permodalan dan infrastruktur.</li>";
                                            echo "</ol>";
                                            break;
                                        case 5:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Rencana bisnis BPR tidak disusun secara realistis, komprehensif, dan terukur (achievable) oleh Direksi dan disetujui oleh Dewan Komisaris, serta tidak menggambarkan rencana strategis jangka panjang dan rencana bisnis tahunan dan tidak direalisasikan sesuai dengan perencanaan sehingga indikator kinerja keuangan dan nonkeuangan dalam rencana bisnis tidak tercapai target yang ditetapkan, termasuk penyampaian laporan rencana bisnis secara tidak lengkap, tidak akurat, tidak kini, tidak utuh, dan melebihi batas waktu.</li>";
                                            echo "<li>Rencana bisnis BPR yang telah disusun tidak didukung oleh pemegang saham yang ditunjukkan dengan tidak terdapat pemenuhan komitmen dalam rangka memperkuat permodalan dan infrastruktur.</li>";
                                            echo "</ol>";
                                            break;
                                        default:
                                            echo "Belum ada nilai faktor12.";
                                            break;
                                    }
                                    ?>
                                </td>
        ...
        <div class="card-body">
                    ...
                    <tr>
                        <th colspan="5" class="text-center">Kesimpulan
                            <?php if ($userInGroupPE || $userInGroupAdmin):
                                ...
                                $kesimpulanData = array_filter($faktors12, function ($item) use ($kodebpr, $periodeId) {
            ...
            <table class="table">
                <tbody>
                    <?php
                    // Filter faktor12 data for current BPR and period
                    $filteredFaktors = array_filter($faktors12, function ($item) use ($kodebpr, $periodeId) {
                        return $item['kodebpr'] == $kodebpr && $item['periode_id'] == $periodeId;
                    });
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url('faktor12/ubah'); ?>" method="post">
                        <!-- Hidden field untuk faktor12id -->
                        <input type="hidden" name="faktor12id" id="id-faktor12" value="">
                        <div class="mb-3">
...
<?php if (!empty($faktors12)) { ?>
    <div class="modal fade" id="modalUbahkesimpulan">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Kesimpulan Penilaian Faktor 12 </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('faktor12/ubahkesimpulan'); ?>" method="post">
                        <input type="hidden" name="faktor12id" id="id-faktor12" value="">
                        <div class="mb-3">
...
<div class="modal fade" id="modaltambahNilai">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?= base_url('faktor12/tambahNilai'); ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title">Faktor 12</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor12_id" id="id-faktor12" readonly>
                    <div class="mb-3">
                        <label for="sub_category" class="form-label">Sub Kategori: </label>
                        <textarea class="form-control" name="sub_category" id="sub_category" style="height: 100px"
                            readonly></textarea>
...
<script>
    $(document).ready(function () {
        // When the "Tambah Nilai" button is clicked, populate the id-faktor12 input field
        $('#modaltambahNilai').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var faktor12Id = button.data('id'); // Extract the faktor12_id from data-id attribute

            var modal = $(this);
            modal.find('#id-faktor12').val(faktor12Id); // Set the value of #id-faktor12 input
        });

        // Optional: if you need to clear the value of #id-faktor12 when closing the modal
        $('#modaltambahNilai').on('hidden.bs.modal', function () {
            $(this).find('#id-faktor12').val('');
        });
    });
</script>
...
<div class="modal fade" id="modaltambahKomentar">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?= base_url('faktor12/tambahKomentar'); ?>" method="post">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor12_id" id="id-faktor12">
...
<div class="modal fade" id="modalHapusnilai12">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="btnHapusnilai12">Yakin</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?= base_url('faktor12/save_komentar'); ?>',
                method: 'POST',
                data: formData,
                dataType: 'json',
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    window.location.href = "/faktor12/setNullKolom/" + id;
                }
            });
        });
    });
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateBadge(faktor12Id, newCount) {
            const badge = document.getElementById('notification-badge-' + faktor12Id);
            if (badge) {
                if (newCount > 0) {
        ...
        function fetchAndDisplayComments(faktor12Id, kodebpr, periodeId) {
            const modal = $('#modaltambahKomentar');
            modal.find('#komentarLamaList').html('<li>Memuat komentar...</li>'); // Show loading message

            $.ajax({
                url: '<?= base_url('faktor12/getKomentarByFaktorId'); ?>/' + faktor12Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                const faktor12Id = this.getAttribute('data-faktor-id');
                ...
                $('#modaltambahKomentar').find('#id-faktor12').val(faktor12Id);

                // Fetch and display comments when the modal opens
                fetchAndDisplayComments(faktor12Id, kodebpr, periodeId);

                // AJAX call to mark comments as read for the current user
                $.ajax({
                    url: '<?= base_url('faktor12/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        faktor12_id: faktor12Id,
                        kodebpr: kodebpr,
                        user_id: userId,
                        periode_id: periodeId,
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            updateBadge(faktor12Id, 0); // Set badge to 0 after comments are marked read
                        } else {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            const faktor12Id = form.find('#id-faktor12').val(); // Get faktor12Id from the form's hidden input
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        fetchAndDisplayComments(faktor12Id, GLOBAL_KODEBPR, GLOBAL_ACTIVE_PERIODE_ID);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response && typeof response.unread_count !== 'undefined') {
                            updateBadge(faktor12Id, response.unread_count);
                        }
                    },
                    error: function (xhr, status, error) {
                        console.error('Error fetching unread count for factor ' + faktor12Id + ':', error);
                    }
                });
            });
        }
        ...
        pollUnreadCounts();
        // Set up polling interval (e.g., every 120 seconds)
    ...
    $(document).ready(function () {
        $('.btn-accdekom').on('click', function () {
            var faktor12Id = $(this).data('faktorid');
            var kodebpr = $(this).data('kodebpr');
            var periodeId = $(this).data('periodeid');

            $.ajax({
                url: '<?= base_url('faktor12/accdekom'); ?>',
                method: 'POST',
                data: {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor12/accdekom2'); ?>',
                method: 'POST',
                data: {
                    faktor12id: faktor12Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor12/accdekom'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor12id: faktor12Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor12/accdekom2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor12id: faktor12Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdir2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor12/accdir2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor12id: faktor12Id,
                    kodebpr: kodebpr,
