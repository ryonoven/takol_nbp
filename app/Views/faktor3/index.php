...
<div class="container-fluid">
    ...
    <div class="card card-body">
        <div class="table-vertical">
            <div style="display: flex; align-items: center; justify-content: space-between;">
                <span class="label" style="flex: 3; margin-right: 10px; text-align: center;">
                    <h3>Faktor 3</h3>
                    <h4>Pelaksanaan Tugas, Tanggung Jawab, dan Wewenang Dewan Komisaris</h4>
                </span>
                <?php
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span style="flex: 1; text-align: left;">
                    <?php
                    $allApproved = true;
                    $requiredFaktor3Ids = range(1, 27);

                    foreach ($requiredFaktor3Ids as $faktor3Id) {
                        $item = array_filter(
                            $faktors3,
                            fn($f) =>
                            $f['id'] == $faktor3Id
                            ...
                            <?php foreach ($faktors3 as $row): ?>
                                <?php if ($row['sph'] == 'Struktur'): ?>
                                    <tr>
                                        ...
                                        $userSpecificData = array_filter($faktors3, function ($item) use ($row, $kodebpr, $periodeId) {
                                        ...
                                        <td>
                                            <?php if ($userInGroupAdmin || $userInGroupPE): ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <button type="button" data-toggle="modal" data-target="#modalHapusnilai3" id="btn-hapus"
                                        ...
                                        <td>
                                            ...
                                            $initialUnreadCount = $commentReads3Model->countUnreadCommentsForUserByFactor(
                                                $row['id'],
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekomValue == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor3/unapprovedekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor3id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor3/accdekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor3id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom2): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekom2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor3/unapprovedekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor3id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor3/accdekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor3id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDireksi2 || $userInGroupDireksi): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdir2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor3/unapprovedir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor3id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor3/accdir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor3id" value="<?= $row['id']; ?>" />
        ...
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <span class="label" style="flex: 3; margin-right: 10px;">
                <strong>Kesimpulan Penilaian Faktor 3 (Pelaksanaan Tugas, Tanggung Jawab, dan Wewenang Dewan
                    Komisaris)</strong>
            </span>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <thead>
                    <tr>
                        <th colspan="5" class="text-center">Nilai Faktor 3</th>
                    </tr>
                                ...
                                <td colspan="5" class="text-center">
                                    ...
                                    switch ($rataRata) {
                                        case 1:
                                            ...
                                            echo "<li><b>Memenuhi kondisi terpenuhinya struktur dan/atau infrastruktur </b>sesuai ketentuan, proses penerapan tata kelola dilakukan dengan sangat memadai, dan ditunjukkan dengan hasil penerapan tata kelola yang sangat baik. Contoh/ilustrasi kondisi yang dapat menjadi indikator tersebut antara lain:</li>";

                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Dewan Komisaris memenuhi seluruh persyaratan yang harus dipenuhi selama menjabat sesuai dengan ketentuan sehingga pelaksanaan tugas dan tanggung jawab, termasuk pengambilan keputusan berjalan dengan sangat baik serta hasil kinerja Dewan Komisaris dapat dipertanggungjawabkan sepenuhnya kepada pemegang saham melalui RUPS.</li>";
                                            echo "<li>Dewan Komisaris telah memiliki dan menginikan secara berkala pedoman dan tata tertib kerja anggota Dewan Komisaris sehingga pelaksanaan tugas dan pengambilan keputusan rapat Dewan Komisaris terlaksana dengan memperhatikan pedoman dan tata tertib kerja.</li>";
                                            echo "<li>Dewan Komisaris memiliki kemauan dan kemampuan, serta upaya untuk membudayakan pembelajaran secara berkala dan berkelanjutan, sehingga terdapat peningkatan pengetahuan, keahlian, dan kemampuan.</li>";
                                            echo "<li>Dewan Komisaris telah memiliki dan menginikan secara berkala kebijakan remunerasi dan nominasi sehingga pelaksanaan tugas terlaksana dengan memperhatikan kebijakan remunerasi dan nominasi.</li>";
                                            echo "</ol>";
                                            break;
                                        case 2:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<li>Dewan Komisaris telah memiliki dan menginikan pedoman dan tata tertib kerja anggota Dewan Komisaris sehingga pelaksanaan tugas dan pengambilan keputusan rapat Dewan Komisaris terlaksana dengan memperhatikan pedoman dan tata tertib kerja.</li>";
                                            echo "<li>Dewan Komisaris memiliki kemauan dan kemampuan, serta upaya untuk membudayakan pembelajaran secara berkala, sehingga terdapat peningkatan pengetahuan, keahlian, dan kemampuan.</li>";
                                            echo "<li>Dewan Komisaris telah memiliki dan menginikan kebijakan remunerasi dan nominasi sehingga pelaksanaan tugas terlaksana dengan memperhatikan kebijakan remunerasi dan nominasi.</li>";
                                            echo "</ol>";
                                            break;
                                        case 3:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<li>Dewan Komisaris telah memiliki pedoman dan tata tertib kerja anggota Dewan Komisaris sehingga pelaksanaan tugas dan pengambilan keputusan rapat Dewan Komisaris terlaksana dengan memperhatikan pedoman dan tata tertib kerja.</li>";
                                            echo "<li>Dewan Komisaris memiliki kemauan dan kemampuan, serta upaya untuk membudayakan pembelajaran, sehingga terdapat peningkatan pengetahuan, keahlian, dan kemampuan.</li>";
                                            echo "<li>Dewan Komisaris telah memiliki kebijakan remunerasi dan nominasi sehingga pelaksanaan tugas terlaksana dengan memperhatikan kebijakan remunerasi dan nominasi.</li>";
                                            echo "</ol>";
                                            break;
                                        case 4:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Dewan Komisaris memenuhi sebagian persyaratan yang harus dipenuhi selama menjabat sesuai dengan ketentuan sehingga pelaksanaan tugas dan tanggung jawab, termasuk pengambilan keputusan berjalan dengan kurang baik serta hasil kinerja Dewan Komisaris tidak sepenuhnya dapat dipertanggungjawabkan kepada pemegang saham melalui RUPS.</li>";
                                            echo "<li>Dewan Komisaris telah memiliki pedoman dan tata tertib kerja anggota Dewan Komisaris namun ruang lingkup belum sesuai dengan ketentuan sehingga pelaksanaan tugas dan pengambilan keputusan rapat Dewan Komisaris tidak terlaksana dengan baik.</li>";
                                            echo "<li>Dewan Komisaris kurang memiliki kemauan dan kemampuan, serta upaya untuk membudayakan pembelajaran secara berkala, sehingga tidak terdapat peningkatan pengetahuan, keahlian, dan kemampuan.</li>";
                                            echo "<li>Dewan Komisaris telah memiliki kebijakan remunerasi dan nominasi namun ruang lingkup belum sesuai dengan ketentuan sehingga pelaksanaan tugas tidak terlaksana dengan baik.</li>";
                                            echo "</ol>";
                                            break;
                                        case 5:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Dewan Komisaris tidak memenuhi seluruh persyaratan yang harus dipenuhi selama menjabat sesuai dengan ketentuan sehingga pelaksanaan tugas dan tanggung jawab, termasuk pengambilan keputusan tidak berjalan dengan baik dan hasil kinerja Dewan Komisaris tidak dapat dipertanggungjawabkan kepada pemegang saham melalui RUPS.</li>";
                                            echo "<li>Dewan Komisaris tidak memenuhi seluruh persyaratan yang harus dipenuhi selama menjabat sesuai dengan ketentuan sehingga pelaksanaan tugas dan tanggung jawab, termasuk pengambilan keputusan tidak berjalan dengan baik dan hasil kinerja Dewan Komisaris tidak dapat dipertanggungjawabkan kepada pemegang saham melalui RUPS. Dewan Komisaris tidak memiliki pedoman dan tata tertib kerja anggota Dewan Komisaris sehingga pelaksanaan tugas dan pengambilan keputusan rapat Dewan Komisaris tidak dapat terlaksana dengan baik.</li>";
                                            echo "<li>Dewan Komisaris tidak memiliki kemauan dan kemampuan, serta upaya untuk membudayakan pembelajaran secara berkala, sehingga tidak terdapat peningkatan pengetahuan, keahlian, dan kemampuan.</li>";
                                            echo "<li>Dewan Komisaris tidak memiliki kebijakan remunerasi dan nominasi sehingga pelaksanaan tugas tidak dapat terlaksana dengan baik.</li>";
                                            echo "</ol>";
                                            break;
                                        default:
                                            echo "Belum ada nilai faktor3.";
                                            break;
                                    }
                                    ?>
                                </td>
        ...
        <div class="card-body">
                    ...
                    <tr>
                        <th colspan="5" class="text-center">Kesimpulan
                            <?php if ($userInGroupPE || $userInGroupAdmin):
                                ...
                                $kesimpulanData = array_filter($faktors3, function ($item) use ($kodebpr, $periodeId) {
            ...
            <table class="table">
                <tbody>
                    <?php
                    // Filter faktor3 data for current BPR and period
                    $filteredFaktors = array_filter($faktors3, function ($item) use ($kodebpr, $periodeId) {
                        return $item['kodebpr'] == $kodebpr && $item['periode_id'] == $periodeId;
                    });
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url('faktor3/ubah'); ?>" method="post">
                        <!-- Hidden field untuk faktor3id -->
                        <input type="hidden" name="faktor3id" id="id-faktor3" value="">
                        <div class="mb-3">
...
<?php if (!empty($faktors3)) { ?>
    <div class="modal fade" id="modalUbahkesimpulan">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Kesimpulan Penilaian Faktor 3 </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('faktor3/ubahkesimpulan'); ?>" method="post">
                        <input type="hidden" name="faktor3id" id="id-faktor3" value="">
                        <div class="mb-3">
...
<div class="modal fade" id="modaltambahNilai">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?= base_url('faktor3/tambahNilai'); ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title">Faktor 3</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor3_id" id="id-faktor3" readonly>
                    <div class="mb-3">
                        <label for="sub_category" class="form-label">Sub Kategori: </label>
                        <textarea class="form-control" name="sub_category" id="sub_category" style="height: 100px"
                            readonly></textarea>
        ...
        <div class="modal-content">
            <form action="<?= base_url('faktor3/tambahKomentar'); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor3_id" id="id-faktor3">
...
<div class="modal fade" id="modalHapusnilai3">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="btnHapusnilai3">Yakin</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?= base_url('faktor3/save_komentar'); ?>',
                method: 'POST',
                data: formData,
                dataType: 'json',
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateBadge(faktor3Id, newCount) {
            const badge = document.getElementById('notification-badge-' + faktor3Id);
            if (badge) {
                if (newCount > 0) {
        ...
        function fetchAndDisplayComments(faktor3Id, kodebpr, periodeId) {
            const modal = $('#modaltambahKomentar');
            modal.find('#komentarLamaList').html('<li>Memuat komentar...</li>'); // Show loading message

            $.ajax({
                url: '<?= base_url('faktor3/getKomentarByFaktorId'); ?>/' + faktor3Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                const faktor3Id = this.getAttribute('data-faktor-id');
                ...
                $('#modaltambahKomentar').find('#id-faktor3').val(faktor3Id);

                // Fetch and display comments when the modal opens
                fetchAndDisplayComments(faktor3Id, kodebpr, periodeId);

                // AJAX call to mark comments as read for the current user
                $.ajax({
                    url: '<?= base_url('faktor3/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        faktor3_id: faktor3Id,
                        kodebpr: kodebpr,
                        user_id: userId,
                        periode_id: periodeId,
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            updateBadge(faktor3Id, 0); // Set badge to 0 after comments are marked read
                        } else {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            const faktor3Id = form.find('#id-faktor3').val(); // Get faktor3Id from the form's hidden input
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        fetchAndDisplayComments(faktor3Id, GLOBAL_KODEBPR, GLOBAL_ACTIVE_PERIODE_ID);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response && typeof response.unread_count !== 'undefined') {
                            updateBadge(faktor3Id, response.unread_count);
                        }
                    },
                    error: function (xhr, status, error) {
                        console.error('Error fetching unread count for factor ' + faktor3Id + ':', error);
                    }
                });
            });
        }
    ...
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor3/accdekom2'); ?>',
                method: 'POST',
                data: {
                    faktor3id: faktor3Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor3/accdekom'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor3id: faktor3Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor3/accdekom2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor3id: faktor3Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdir2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor3/accdir2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor3id: faktor3Id,
                    kodebpr: kodebpr,
