...
<div class="container-fluid">
    ...
    <div class="card card-body">
        <div class="table-vertical">
            <div style="display: flex; align-items: center; justify-content: space-between;">
                <span class="label" style="flex: 3; margin-right: 10px; text-align: center;">
                    <h3>Faktor 8</h3>
                    <h4>Penerapan Fungsi Audit Extern</h4>
                </span>
                <?php
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span style="flex: 1; text-align: left;">
                    <?php
                    $allApproved = true;
                    $requiredFaktor8Ids = range(1, 6);

                    foreach ($requiredFaktor8Ids as $faktor8Id) {
                        $item = array_filter(
                            $faktors8,
                            fn($f) =>
                            $f['id'] == $faktor8Id
                            ...
                            <?php foreach ($faktors8 as $row): ?>
                                <?php if ($row['sph'] == 'Struktur'): ?>
                                    <tr>
                                        ...
                                        $userSpecificData = array_filter($faktors8, function ($item) use ($row, $kodebpr, $periodeId) {
                                        ...
                                        <td>
                                            <?php if ($userInGroupAdmin || $userInGroupPE): ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <button type="button" data-toggle="modal" data-target="#modalHapusnilai8" id="btn-hapus"
                                        ...
                                        <td>
                                            ...
                                            $initialUnreadCount = $commentReads8Model->countUnreadCommentsForUserByFactor(
                                                $row['id'],
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekomValue == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor8/unapprovedekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor8id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor8/accdekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor8id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom2): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekom2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor8/unapprovedekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor8id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor8/accdekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor8id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDireksi2 || $userInGroupDireksi): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdir2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor8/unapprovedir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor8id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor8/accdir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor8id" value="<?= $row['id']; ?>" />
        ...
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <span class="label" style="flex: 3; margin-right: 10px;">
                <strong>Kesimpulan Penilaian Faktor 8 (Penerapan Fungsi Audit Extern)</strong>
            </span>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <thead>
                    <tr>
                        <th colspan="5" class="text-center">Nilai Faktor 8</th>
                    </tr>
                                ...
                                <td colspan="5" class="text-center">
                                    ...
                                    switch ($rataRata) {
                                        case 1:
                                            ...
                                            echo "<li>Penugasan audit kepada Akuntan Publik dan KAP telah memenuhi seluruh persyaratan sebagaimana diatur dalam ketentuan Otoritas Jasa Keuangan dan ketentuan peraturan perundang-undangan sehingga hasil audit Akuntan Publik dan KAP dan management letter disampaikan secara lengkap, akurat, kini, utuh, dan tepat waktu, serta hasil audit menggambarkan seluruh permasalahan BPR.</li>";
                                            echo "</ol>";
                                            break;
                                        case 2:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Penugasan audit kepada Akuntan Publik dan KAP telah memenuhi seluruh persyaratan sebagaimana diatur dalam ketentuan Otoritas Jasa Keuangan dan ketentuan peraturan perundang-undangan namun hasil audit Akuntan Publik dan KAP dan management letter disampaikan secara lengkap, akurat, kini, utuh, dan tepat waktu, namun hasil audit hanya menggambarkan sebagian besar permasalahan BPR.</li>";
                                            echo "</ol>";
                                            break;
                                        case 3:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Penugasan audit kepada Akuntan Publik dan KAP telah memenuhi seluruh persyaratan sebagaimana diatur dalam ketentuan Otoritas Jasa Keuangan dan ketentuan peraturan perundang-undangan namun hasil audit Akuntan Publik dan KAP dan management letter disampaikan secara cukup lengkap, akurat, kini, utuh, dan tepat waktu, sehingga hasil audit menggambarkan sebagian permasalahan BPR.</li>";
                                            echo "</ol>";
                                            break;
                                        case 4:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Penugasan audit kepada Akuntan Publik dan KAP hanya memenuhi sebagian persyaratan sebagaimana diatur dalam ketentuan Otoritas Jasa Keuangan dan ketentuan peraturan perundang-undangan dan hasil audit Akuntan Publik dan KAP dan management letter disampaikan secara kurang lengkap, kurang akurat, tidak kini, tidak utuh dan melebihi batas waktu, sehingga hasil audit tidak sepenuhnya menggambarkan permasalahan BPR.</li>";
                                            echo "</ol>";
                                            break;
                                        case 5:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
        ...
        <div class="card-body">
                    ...
                    <tr>
                        <th colspan="5" class="text-center">Kesimpulan
                            <?php if ($userInGroupPE || $userInGroupAdmin):
                                ...
                                $kesimpulanData = array_filter($faktors8, function ($item) use ($kodebpr, $periodeId) {
            ...
            <table class="table">
                <tbody>
                    <?php
                    // Filter faktor8 data for current BPR and period
                    $filteredFaktors = array_filter($faktors8, function ($item) use ($kodebpr, $periodeId) {
                        return $item['kodebpr'] == $kodebpr && $item['periode_id'] == $periodeId;
                    });
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url('faktor8/ubah'); ?>" method="post">
                        <!-- Hidden field untuk faktor8id -->
                        <input type="text" name="faktor8id" id="id-faktor8" value="">
                        <div class="mb-3">
...
<?php if (!empty($faktors8)) { ?>
    <div class="modal fade" id="modalUbahkesimpulan">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Kesimpulan Penilaian Faktor 8 </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('faktor8/ubahkesimpulan'); ?>" method="post">
                        <input type="text" name="faktor8id" id="id-faktor8" value="">
                        <div class="mb-3">
...
<div class="modal fade" id="modaltambahNilai">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?= base_url('faktor8/tambahNilai'); ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title">Faktor 8</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <input type="text" name="faktor8_id" id="id-faktor8" readonly>
                    <div class="mb-3">
                        <label for="sub_category" class="form-label">Sub Kategori: </label>
                        <textarea class="form-control" name="sub_category" id="sub_category" style="height: 100px"
                            readonly></textarea>
...
<script>
    $(document).ready(function () {
        // When the "Tambah Nilai" button is clicked, populate the id-faktor8 input field
        $('#modaltambahNilai').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var faktor8Id = button.data('id'); // Extract the faktor8_id from data-id attribute

            var modal = $(this);
            modal.find('#id-faktor8').val(faktor8Id); // Set the value of #id-faktor8 input
        });

        // Optional: if you need to clear the value of #id-faktor8 when closing the modal
        $('#modaltambahNilai').on('hidden.bs.modal', function () {
            $(this).find('#id-faktor8').val('');
        });
    });
</script>
...
<div class="modal fade" id="modaltambahKomentar">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?= base_url('faktor8/tambahKomentar'); ?>" method="post">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor8_id" id="id-faktor8">
...
<div class="modal fade" id="modalHapusnilai8">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="btnHapusnilai8">Yakin</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?= base_url('faktor8/save_komentar'); ?>',
                method: 'POST',
                data: formData,
                dataType: 'json',
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    window.location.href = "/faktor8/setNullKolom/" + id;
                }
            });
        });
    });
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateBadge(faktor8Id, newCount) {
            const badge = document.getElementById('notification-badge-' + faktor8Id);
            if (badge) {
                if (newCount > 0) {
        ...
        function fetchAndDisplayComments(faktor8Id, kodebpr, periodeId) {
            const modal = $('#modaltambahKomentar');
            modal.find('#komentarLamaList').html('<li>Memuat komentar...</li>'); // Show loading message

            $.ajax({
                url: '<?= base_url('faktor8/getKomentarByFaktorId'); ?>/' + faktor8Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                const faktor8Id = this.getAttribute('data-faktor-id');
                ...
                $('#modaltambahKomentar').find('#id-faktor8').val(faktor8Id);

                // Fetch and display comments when the modal opens
                fetchAndDisplayComments(faktor8Id, kodebpr, periodeId);

                // AJAX call to mark comments as read for the current user
                $.ajax({
                    url: '<?= base_url('faktor8/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        faktor8_id: faktor8Id,
                        kodebpr: kodebpr,
                        user_id: userId,
                        periode_id: periodeId,
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            updateBadge(faktor8Id, 0); // Set badge to 0 after comments are marked read
                        } else {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            const faktor8Id = form.find('#id-faktor8').val(); // Get faktor8Id from the form's hidden input
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        fetchAndDisplayComments(faktor8Id, GLOBAL_KODEBPR, GLOBAL_ACTIVE_PERIODE_ID);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response && typeof response.unread_count !== 'undefined') {
                            updateBadge(faktor8Id, response.unread_count);
                        }
                    },
                    error: function (xhr, status, error) {
                        console.error('Error fetching unread count for factor ' + faktor8Id + ':', error);
                    }
                });
            });
        }
        ...
        pollUnreadCounts();
        // Set up polling interval (e.g., every 80 seconds)
    ...
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor8/accdekom2'); ?>',
                method: 'POST',
                data: {
                    faktor8id: faktor8Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor8/accdekom'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor8id: faktor8Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor8/accdekom2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor8id: faktor8Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdir2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor8/accdir2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor8id: faktor8Id,
                    kodebpr: kodebpr,
