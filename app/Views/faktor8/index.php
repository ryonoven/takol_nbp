        ...
        <div class="table-vertical">
            <div style="display: flex; align-items: center; justify-content: space-between;">
                <span class="label" style="flex: 3; margin-right: 10px; text-align: center;">
                    <h3>Faktor 8</h3>
                    <h4>Penerapan Fungsi Audit Ekstern</h4>
                </span>
                <span>
                    <?php
                    $allApproved = true;
                    foreach ($faktor8 as $item) {
            ...
            <?php if ($userInGroupAdmin || $userInGroupDekom || $userInGroupDireksi): ?>
                <div class="col-md" style="display: flex; justify-content: flex-end; align-items: center;">
                    <a href="<?= base_url('faktor8/approveSemua') ?>" class="btn btn-success shadow mt-3 mr-2"
                        onclick="return confirm('Apakah Anda yakin ingin melakukan approval?');">
                        Approve
                    </a>
                    <a href="<?= base_url('faktor8/unapproveSemua') ?>" class="btn btn-danger shadow mt-3 mr-2"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('faktor8/ubah'); ?>" method="post">
                        <input type="hidden" name="id" id="id-faktor8">
                        <div class="mb-3">
                        ...
                        <div class="mt-3">
                            <button type="button" class="btn btn-outline-info btn-sm" id="lihatPanduanFaktor8">Lihat
                                Panduan</button>
                            <div id="panduanNilaiContainerFaktor8" style="display: none; margin-top: 15px;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Apabila memenuhi kondisi terpenuhinya struktur dan/atau infrastruktur sesuai
                                                ...
                                                ditunjukkan dengan hasil penerapan tata kelola yang sangat baik.
                                                Contoh/ilustrasi kondisi yang dapat menjadi indikator tersebut antara lain:
                                                Penugasan audit kepada Akuntan Publik dan KAP telah memenuhi seluruh
                                                persyaratan sebagaimana diatur dalam ketentuan Otoritas Jasa Keuangan dan
                                                ketentuan peraturan perundang-undangan sehingga hasil audit Akuntan Publik
                                                dan KAP dan management letter disampaikan secara lengkap, akurat, kini,
                                                utuh, dan tepat waktu, serta hasil audit menggambarkan seluruh permasalahan
                                                BPR.
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>Apabila memenuhi kondisi terpenuhinya struktur dan/atau infrastruktur sesuai
                                                ...
                                                ditunjukkan dengan hasil penerapan tata kelola yang baik. Contoh/ilustrasi
                                                kondisi yang dapat menjadi indikator tersebut antara lain: Penugasan audit
                                                kepada Akuntan Publik dan KAP telah memenuhi seluruh persyaratan sebagaimana
                                                diatur dalam ketentuan Otoritas Jasa Keuangan dan ketentuan peraturan
                                                perundang-undangan namun hasil audit Akuntan Publik dan KAP dan management
                                                letter disampaikan secara lengkap, akurat, kini, utuh, dan tepat waktu,
                                                namun hasil audit hanya menggambarkan sebagian besar permasalahan BPR.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Nilai 3</td>
                                            <td>Apabila memenuhi kondisi terpenuhinya struktur dan/atau infrastruktur sesuai
                                                ...
                                                ditunjukkan dengan hasil penerapan tata kelola yang cukup baik.
                                                Contoh/ilustrasi kondisi yang dapat menjadi indikator tersebut antara lain:
                                                Penugasan audit kepada Akuntan Publik dan KAP telah memenuhi seluruh
                                                persyaratan sebagaimana diatur dalam ketentuan Otoritas Jasa Keuangan dan
                                                ketentuan peraturan perundang-undangan namun hasil audit Akuntan Publik dan
                                                KAP dan management letter disampaikan secara cukup lengkap, akurat, kini,
                                                utuh, dan tepat waktu, sehingga hasil audit menggambarkan sebagian
                                                permasalahan BPR.
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>Apabila memenuhi kondisi belum sepenuhnya terpenuhi struktur dan/atau
                                                ...
                                                yang kurang baik. Contoh/ilustrasi kondisi yang dapat menjadi indikator
                                                tersebut antara lain: Penugasan audit kepada Akuntan Publik dan KAP hanya
                                                memenuhi sebagian persyaratan sebagaimana diatur dalam ketentuan Otoritas
                                                Jasa Keuangan dan ketentuan peraturan perundang-undangan dan hasil audit
                                                Akuntan Publik dan KAP dan management letter disampaikan secara kurang
                                                lengkap, kurang akurat, tidak kini, tidak utuh dan melebihi batas waktu,
                                                sehingga hasil audit tidak sepenuhnya menggambarkan permasalahan BPR.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Nilai 5</td>
                                            <td>Apabila memenuhi kondisi tidak terpenuhi struktur dan/atau infrastruktur
                                                ...
                                                memadai, dan ditunjukkan dengan hasil penerapan tata kelola yang tidak baik.
                                                Contoh/ilustrasi kondisi yang dapat menjadi indikator tersebut antara lain:
                                                Penugasan audit kepada Akuntan Publik dan KAP tidak memenuhi persyaratan
                                                sebagaimana diatur dalam ketentuan Otoritas Jasa Keuangan dan ketentuan
                                                peraturan perundang-undangan dan hasil audit Akuntan Publik dan KAP dan
                                                management letter disampaikan secara tidak lengkap, tidak akurat, tidak
                                                kini, tidak utuh, dan melebihi batas waktu, serta hasil audit tidak
                                                menggambarkan permasalahan BPR.
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const lihatPanduanButtonFaktor8 = document.getElementById('lihatPanduanFaktor8');
        const panduanContainerFaktor8 = document.getElementById('panduanNilaiContainerFaktor8');

        if (lihatPanduanButtonFaktor8 && panduanContainerFaktor8) {
            lihatPanduanButtonFaktor8.addEventListener('click', function () {
                panduanContainerFaktor8.style.display = panduanContainerFaktor8.style.display === 'none' ? 'block' : 'none';
                lihatPanduanButtonFaktor8.textContent = panduanContainerFaktor8.style.display === 'none' ? 'Lihat Panduan' : 'Sembunyikan Panduan';
            });
        }
    });
</script>
