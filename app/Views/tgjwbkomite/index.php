...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-headertitle">
            ...
            <h1 class="h3 mb-4 text-gray-800 text-center"><?= $judul; ?><br>(E0203)</h1>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-hover">
                <tbody>
                    <?php if (empty($tgjwbkomite) || (isset($tgjwbkomite) && !array_filter($tgjwbkomite, fn($item) => !empty($item['komite'])))) { ?>
                        <tr>
                            <th style="width: 30%; color: black;">Komite :</th>
                            <td colspan="2">Data tidak tersedia</td>
                        </tr>
                        <tr>
                            <th style="width: 30%;">Jumlah Rapat :</th>
                            <td colspan="2">Data tidak tersedia</td>
                        </tr>
                        <tr>
                            <th style="border-bottom: hidden;" colspan="2">Penjelasan Tugas dan Tanggung Jawab :</th>
                        </tr>
                        <tr>
                            <td colspan="2">Data tidak tersedia</td>
                        </tr>
                        <tr>
                            <th style="border-bottom: hidden;" colspan="2">Program Kerja Komite :</th>
                        </tr>
                        <tr>
                            <td colspan="2">Data tidak tersedia</td>
                        </tr>
                        <tr>
                            <th style="border-bottom: hidden;" colspan="2">Realisasi Program Kerja Komite :</th>
                        </tr>
                        <tr>
                            <td colspan="2">Data tidak tersedia</td>
                        </tr>
                    <?php } else { ?>
                        ...
                        <?php foreach ($tgjwbkomite as $row): ?>
                            <?php if (empty($row['komite'])): ?>
                                <tr>
                                    <th style="width: 30%; color: black;">Komite :</th>
                                    <td colspan="2">Data komite tidak tersedia</td>
                                </tr>
                            <?php else: ?>
                                <!-- Baris 1: Nomor + Komite -->
                                <tr>
                                    <th class="table-info" style="width: 3%;" rowspan="9"><?= $i; ?></th>
                                    <th style="width: 25%; color: black;">Komite :</th>
                                    <td>
                                        <?php
                                        // Pemetaan nilai 'komite' ke label lengkap
                                        switch ($row['komite']) {
                                            case '01':
                                                echo "01. Komite Audit";
                                                break;
                                            case '02':
                                                echo "02. Komite Pemantau Risiko";
                                                break;
                                            case '03':
                                                echo "03. Komite Remunerasi dan Nominasi";
                                                break;
                                            case '04':
                                                echo "04. Komite Manajemen Risiko";
                                                break;
                                            case '05':
                                                echo "05. Komite Lainnya**";
                                                break;
                                            default:
                                                echo "Tidak ada komite yang dipilih";
                                                break;
                                        }
                                        ?>
                                    </td>
                                ...
                                <tr>
                                    <th style="width: 25%; color: black;">Jumlah Rapat :</th>
                                    <td><?= $row['jumlahrapat']; ?></td>
                                </tr>

                                <!-- Baris 2: Header Penjelasan Tugas -->
                                <tr>
                                    <th style="border-bottom: hidden;" colspan="2">Penjelasan Tugas dan Tanggung Jawab :</th>
                                </tr>

                                <!-- Baris 3: Isi Tugas dan Tanggung Jawab -->
                                <tr>
                                    <td colspan="2">
                                        <ul style="list-style-type: square; padding-left: 1.5em;">
                                            <?php
                                            $tugastgjwbkomite = explode("\n", $row['tugastgjwbkomite']);
                                            foreach ($tugastgjwbkomite as $poin) {
                                                if (trim($poin) != '') {
                                ...
                                <!-- Baris 5: Header Program Kerja -->
                                <tr>
                                    <th style="border-bottom: hidden;" colspan="2">Program Kerja Komite :</th>
                                </tr>

                                <!-- Baris 6: Isi Program Kerja -->
                                <tr>
                                    <td colspan="2">
                                        <ul style="list-style-type: square; padding-left: 1.5em;">
                                            <?php
                                ...
                                <!-- Baris 7: Header Realisasi Program Kerja -->
                                <tr>
                                    <th style="border-bottom: hidden;" colspan="2">Realisasi Program Kerja Komite :</th>
                                </tr>

                                <!-- Baris 8: Isi Realisasi Program Kerja -->
                                <tr>
                                    <td colspan="2">
                                        <ul style="list-style-type: square; padding-left: 1.5em;">
                                            <?php
                                    ...
                                    <tr>
                                        <td colspan="3" style="padding: 10px;">
                                            <button type="button" class="btn btn-outline-warning btn-sm" data-toggle="modal"
                                                ...
                                                data-hasilprokerkomite="<?= $row['hasilprokerkomite']; ?>">
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    <?php if (empty($penjelastindak)) { ?>
                        <tr>
                            <th class="table-info" style="width: 30%; color: black;">Tindak Lanjut Rekomendasi Program Kerja
                                dan Realisasi Program Kerja Komite (Opsional) :
                            </th>
                        </tr>
                        <tr>
                            <td colspan="2">Data tidak tersedia</td>
                        ...
                        <?php foreach ($penjelastindak as $row): ?>
                            <tr>
                                <th colspan="2" class="table-info" style="width: 30%; color: black;">Tindak Lanjut Rekomendasi
                                    Program Kerja dan Realisasi Program Kerja Komite (Opsional) :</th>
                            </tr>
                            <tr>
                                <td colspan="2">
                        ...
                        <div class="card shadow-sm approval-card">
                            <div class="card-body approval-card-body">
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Tgjwbkomite/approveSemuaKom') ?>"
                                    ...
                                    <a href="<?= base_url('Tgjwbkomite/unapproveSemuaKom') ?>"
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm approvaldir-card">
                            <div
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Tgjwbkomite/approveSemuaDirut') ?>"
                                    ...
                                    <a href="<?= base_url('Tgjwbkomite/unapproveSemuaDirut') ?>"
            ...
            <div class="d-flex justify-content-center mb-5">
                <div class="d-flex justify-content-center gap-2">
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        <a href="<?= base_url('Tgjwbkomite/exporttxttgjwbkomite'); ?>" class="btn btn-secondary btn-sm">
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group me-2" role="group" aria-label="First group">
                                <button type="button" class="btn btn-outline-primary btn-sm"
                                    onclick="window.location.href='<?= base_url('Tgjwbdekom') ?>'">
                                    << </button>
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            onclick="window.location.href='<?= base_url('Strukturkomite') ?>'">>></button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Tgjwbkomite/ubah'); ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select style="height: 45px;" name="komite" id="komite" class="form-control" required>
                                <option value="">-- Pilih Komite --</option>
                                <option value="01" <?= (isset($row['komite']) && $row['komite'] == '01') ? 'selected' : ''; ?>>
                                    01. Komite Audit</option>
                                <option value="02" <?= (isset($row['komite']) && $row['komite'] == '02') ? 'selected' : ''; ?>>
                                    02. Komite Pemantau Risiko</option>
                                <option value="03" <?= (isset($row['komite']) && $row['komite'] == '03') ? 'selected' : ''; ?>>
                                    03. Komite Remunerasi dan Nominasi</option>
                                <option value="04" <?= (isset($row['komite']) && $row['komite'] == '04') ? 'selected' : ''; ?>>
                                    04. Komite Manajemen Risiko</option>
                                <option value="05" <?= (isset($row['komite']) && $row['komite'] == '05') ? 'selected' : ''; ?>>
                                    05. Komite Lainnya**</option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input style="height: 45px;" class="form-control" type="number" name="jumlahrapat"
                                id="jumlahrapat" placeholder="<?= isset($row['jumlahrapat']) && $row['jumlahrapat'] ?>"
                                required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" type="text" name="tugastgjwbkomite" id="tugastgjwbkomite"
                                style="height: 150px"
                                placeholder="<?= isset($row['tugastgjwbkomite']) && $row['tugastgjwbkomite'] ?>"
                                required></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control" type="text" name="prokerkomite" id="prokerkomite"
                                style="height: 150px"
                                placeholder="<?= isset($row['prokerkomite']) && $row['prokerkomite'] ?>"
                                required></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control" type="text" name="hasilprokerkomite" id="hasilprokerkomite"
                                style="height: 150px"
                                placeholder="<?= isset($row['hasilprokerkomite']) && $row['hasilprokerkomite'] ?>"
                                required></textarea>
                        </div>
                </div>
...
<div class="modal fade" id="modalTambahketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Tgjwbkomite/tambahketerangan'); ?>" method="post">
...
<div class="modal fade" id="modaleditketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Tgjwbkomite/editketerangan'); ?>" method="post">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Tgjwbkomite/tambahtgjwbkomite'); ?>" method="post">
                    <div class="form-group">
                        ...
                        <select style="height: 45px;" name="komite" id="komite" class="form-control" required>
                            <option value="">-- Pilih Komite --</option>
                            <option value="01">01. Komite Audit</option>
                            <option value="02">02. Komite Pemantau Risiko</option>
                            <option value="03">03. Komite Remunerasi dan Nominasi</option>
                            <option value="04">04. Komite Manajemen Risiko</option>
                            <option value="05">05. Komite Lainnya**</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="jumlahrapat">Input Jumlah Rapat: </label>
                        <input type="number" name="jumlahrapat" id="jumlahrapat" class="form-control"
                            style="height: 45px;" required></input>
                        <small> Note: Isi menggunakan angka saja</small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="hasilprokerkomite">Realisasi Program Kerja Komite: </label>
                        <textarea class="form-control" type="text" name="hasilprokerkomite" id="hasilprokerkomite"
                            style="height: 150px;" required></textarea>
                    </div>
            </div>
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    ...
                    window.location.href = "/Tgjwbkomite/setNullKolomTindak/" + id;
                }
            });
        });
    });
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    window.location.href = "/Tgjwbkomite/setNullKolomPenjelaslanjut/" + id;
                }
            });
        });
    });
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchAndDisplayComments(Id, kodebpr, periodeId) {
            ...
            $.ajax({
                url: '<?= base_url('Tgjwbkomite/getKomentarByFaktorId'); ?>/' + Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                $.ajax({
                    url: '<?= base_url('Tgjwbkomite/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function pollUnreadCounts() {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('Tgjwbkomite/getUnreadCommentCountForFactor'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function refreshBadgeForAllUsers(exceptUserId) {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('Tgjwbkomite/getUnreadCommentCountForAllUsers'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
