    ...
    <div class="card">
        <nav>
            <div class="nav nav-tabs w-100 d-flex" id="nav-tab" role="tablist">
                <a class="nav-item nav-link flex-fill text-center active" id="nav-home-tab" data-toggle="tab"
                    href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Laporan Tingkat Kesehatan
                    Bank (TKS)</a>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                <div class="container-fluid">
                    <p><a href="Periodetks" class="link-primary custom-link ml-5 mt-5">Kembali ke halaman
                            pilih periode</a>
                    </p>
                    ...
                    <div class="row">
                            ...
                            <div class="row justify-content-center g-4">
                                ...
                                <?php if ($selectedRating): ?>
                                    ...
                                    <div class="col-12 col-md-3 mb-4 d-flex justify-content-center">
                                        <div class="card shadow-lg text-center border-0"
                                            ...
                                            <div class="card-header bg-white fw-bold">
                                                Total Nilai Tingkat Kesehatan Bank (TKS)
                                            </div>
                                            <div class="card-body">
                                                <h2 class="card-title"><?= esc($selectedRating['title']) ?></h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3 mb-4 d-flex justify-content-center">
                                        <div class="card shadow-lg text-center border-0"
                                            style="max-width: 25rem; width: 100%; background-color: <?= esc($selectedRating['color']) ?>;">
                                            <div class="card-header bg-white fw-bold">
                                                Nilai Tingkat Kesehatan Bank (TKS)
                                            </div>
                                            <div class="card-body">
                                                <h2 class="card-title"><?= esc($selectedRating['title']) ?></h2>
                                                <p class="card-text mb-0">
                                                    Tingkat Risiko: <?= esc($selectedRating['level']) ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3 mb-4 d-flex justify-content-center">
                                        <div class="card shadow-lg text-center border-0"
                                            style="max-width: 25rem; width: 100%; background-color: <?= esc($selectedRating['color']) ?>;">
                                            <div class="card-header bg-white fw-bold">
                                                Peringkat Tingkat Kesehatan Bank (TKS)
                                            </div>
                                            <div class="card-body">
                                                <h2 class="card-title"><?= esc($selectedRating['title']) ?></h2>
                                                <p class="card-text mb-0">
                                ...
                                <?php else: ?>
                                    ...
                                    <div class="col-12 d-flex justify-content-center">
                                        <div class="alert alert-dark text-center" style="max-width: 25rem;">
                        ...
                        <?php if (isset($showtks) && !empty($showtks) && !empty($showtks['ntotalrisk'])): ?>
                            <div class="container-fluid d-flex justify-content-center align-items-center mb-4">
                                <div class="card shadow-lg border-0" style="max-width: 450px; width: 100%;">
                                    ...
                                    <div class="collapse" id="mainCardBody">
                                        <div class="card-body">
                                            <form method="post" action="<?= base_url('Showtks/updateNtotalrisk'); ?>"
                                                id="formUpdateNtotalrisk"> <?= csrf_field() ?>
                                                <input type="hidden" name="id" value="<?= esc($showtks['id']); ?>">
                                                ...
                                                <div class="alert alert-info">
                                                    ...
                                                    <?php
                                                    $currentNtotalrisk = $showtks['ntotalrisk'] ?? 'N/A';
                                            ...
                                            <!-- Form Reset (hidden) -->
                                            <form method="post" action="<?= base_url('Showtks/resetNtotalrisk'); ?>"
                        ...
                        <div class="container-fluid d-flex justify-content-center align-items-center min-vh-100">
                            <div class="row g-2" style="width: 85%;">
                                ...
                                <?php if (isset($showtks) && !empty($showtks)): ?>
                                    <div class="col-12 mt-4 mb-4">
                                        <div class="card shadow-sm">
                                            <div class="card-header bg-primary text-white">
                                                <h5 class="mb-0">
                                                    <i class="fas fa-edit"></i> Kesimpulan/Analisis Tingkat Kesehatan Bank
                                                    (TKS)
                                                </h5>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <form id="formKesimpulan" autocomplete="off">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="kesimpulan">
                                                            Kesimpulan dan Analisis Tingkat Kesehatan Bank (TKS)
                                                        ...
                                                        <textarea class="form-control auto-save-kesimpulan" id="kesimpulan"
                                                            ...
                                                            placeholder="Tuliskan kesimpulan analisis Tingkat Kesehatan Bank (TKS) secara keseluruhan..."
                                                            data-field="kesimpulan"><?= esc($showtks['kesimpulan'] ?? ''); ?></textarea>
                                                        <small class="form-text text-muted">
                                                            <i class="fas fa-info-circle"></i>
                                                            Isi dengan analisis komprehensif mengenai Tingkat Kesehatan Bank
                                                            (TKS) BPR
            ...
            <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                <div class="container-fluid">
                                ...
                                <form id="formTtd" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control auto-save" id="dirut" name="dirut"
                                            data-field="dirut" value="<?= esc($showtks['dirut'] ?? ''); ?>" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control auto-save" id="dirkep" name="dirkep"
                                            data-field="dirkep" value="<?= esc($showtks['dirkep'] ?? ''); ?>" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control auto-save" id="pe" name="pe"
                                            data-field="pe" value="<?= esc($showtks['pe'] ?? ''); ?>" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control auto-save" id="tanggal" name="tanggal"
                                            ...
                                            value="<?= esc($showtks['tanggal_display'] ?? ''); ?>" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control auto-save" id="lokasi" name="lokasi"
                                            data-field="lokasi" value="<?= esc($showtks['lokasi'] ?? ''); ?>" required>
                        ...
                        <!-- <div class="col-12 mb-4">
                            <div class="card-body p-4 p-md-5">
                                ...
                                <form method="post" action="<?= base_url('pdfself/uploadPdf'); ?>"
                                    ...
                                    <?php if (!empty($showtks['pdf1_filename'])): ?>
                                        <div class="mt-2">
                                            <p>PDF 1 Terunggah:
                                                <a href="<?= base_url('pdfself/download/' . esc($showtks['pdf1_filename'])); ?>"
                                                    target="_blank">
                                                    <?= esc($showtks['pdf1_filename']); ?>
                                                </a>
                                            </p>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if (!empty($showtks['pdf2_filename'])): ?>
                                        <div class="mt-2">
                                            <p>PDF 2 Terunggah:
                                                <a href="<?= base_url('pdfself/download/' . esc($showtks['pdf2_filename'])); ?>"
                                                    target="_blank">
                                                    <?= esc($showtks['pdf2_filename']); ?>
                                                </a>
                                            </p>
                                        </div>
                                    <?php endif; ?>
                    ...
                    $alertMessage = $allFactorsApproved
                        ? 'Laporan Tingkat Kesehatan Bank (TKS) seluruhnya telah disetujui.'
                ...
                <a href="/Showtks/viewLembarPernyataan"
                ...
                <a href="/Showtks/viewLaporanProfilRisiko"
                    class="btn btn-info shadow mx-2 <?= $disablePdfButton ? 'disabled' : '' ?>" <?= $disablePdfButton ? 'aria-disabled="true"' : '' ?> target="_blank">
                    <i class="fas fa-file-signature"></i> LAPORAN TKS
                </a>                 -->
            </div>
        </div>
    </div>
...
<script>
        ...
        if (btnExport) {
            btnExport.addEventListener('click', function () {
                ...
                const exportWindow = window.open(
                    '<?= base_url('Showtks/exportAllPDFToZipView') ?>',
                    'ExportPDFWindow',
    ...
    function downloadAllPDFDirect() {
        ...
        fetch('<?= base_url('Showtks/exportAllPDFToZipDirect') ?>')
...
<script>
    ...
    $(document).ready(function () {
        ...
        function autoSaveField(id, field, value) {
            ...
            $.ajax({
                url: '<?= base_url("Showtks/ajaxAutoSaveField"); ?>',
                type: 'POST',
                dataType: 'json',
                data: {
                    id: id,
        ...
        $('#formTtd').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?= base_url("Showtks/ajaxUpdateTtd"); ?>',
                type: 'POST',
                dataType: 'json',
                data: formData,
                success: function (response) {
    ...
    function debugLog(message, data) {
        if (typeof console !== 'undefined' && console.log) {
            console.log('[Showtks Debug]', message, data || '');
        }
    }
    ...
    function autoSaveKesimpulan(id, value) {
        ...
        $.ajax({
            url: '<?= base_url("Showtks/ajaxSaveKesimpulan"); ?>',
            type: 'POST',
            dataType: 'json',
            data: {
                id: id,
