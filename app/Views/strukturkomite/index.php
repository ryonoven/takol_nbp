...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-headertitle">
            ...
            <h1 class="h3 mb-4 text-gray-800 text-center"><?= $judul; ?><br>(E0204)</h1>
        ...
        <div class="card-body">
            <table class="table table-info table-hover">
                <thead class="thead-primary">
                    <tr>
                        <th>Struktur, Keanggotaan, Keahlian, dan Independensi Anggota Komite</th>
                    </tr>
                </thead>
            </table>
            ...
            <table class="table table-bordered table-hover">
                <tbody>
                    <?php if (empty($strukturkomite)) { ?>
                        <tr>
                            <th style="width: 30%; color: black;">Nama Anggota Komite :</th>
                        ...
                        <tr>
                            <th style="border-bottom: hidden;" colspan="2">Keahlian :</th>
                        </tr>
                        <tr>
                            <td colspan="2">Data tidak tersedia</td>
                        </tr>
                        ...
                        <tr>
                            <th style="width: 30%;">Jabatan Dalam Komite Manajemen Risiko :</th>
                            <td colspan="2">Data tidak tersedia</td>
                        </tr>
                        <tr>
                    ...
                    <?php } else { ?>
                        ...
                        <?php foreach ($strukturkomite as $row): ?>
                            <!-- Baris 1: Nomor + Komite -->
                            <tr>
                                <th class="table-info" style="width: 3%;" rowspan="11"><?= $i; ?></th>
                                <th style="width: 25%; color: black;">Nama Anggota Komite :</th>
                                <td><?= $row['anggotakomite']; ?></td>
                            </tr>

                            <tr>
                                <th style="width: 25%; color: black;">NIK :</th>
                                <td><?= $row['nikkomite']; ?></td>
                            </tr>

                            <!-- Baris 2: Header Penjelasan Keahlian -->
                            <tr>
                                <th style="border-bottom: hidden;" colspan="2">Keahlian :</th>
                            </tr>

                            <!-- Baris 3: Isi Keahlian -->
                            <tr>
                                <td colspan="2">
                                    <ul style="list-style-type: square; padding-left: 1.5em;">
                                        <?php
                                        $keahlian = explode("\n", $row['keahlian']);
                                        foreach ($keahlian as $poin) {
                                            if (trim($poin) != '') {
                            ...
                            <tr>
                                <th style="width: 25%; color: black;">Jabatan Dalam Komite Audit :</th>
                                <td>
                                    <?php
                                    if ($row['jbtaudit'] == '00') {
                                        echo "Tidak menjabat dalam komite audit";
                                    } elseif ($row['jbtaudit'] == '01') {
                                        echo "Ketua komite audit";
                                    } elseif ($row['jbtaudit'] == '02') {
                                        echo "Anggota komite audit";
                                    } else {
                            ...
                            <tr>
                                <th style="width: 25%; color: black;">Jabatan Dalam Komite Pemantau Risiko :</th>
                                <td>
                                    <?php
                                    if ($row['jbtpantauresiko'] == '00') {
                                        echo "Tidak menjabat dalam komite pemantauan risiko";
                                    } elseif ($row['jbtpantauresiko'] == '01') {
                                        echo "Ketua komite pemantauan resiko";
                                    } elseif ($row['jbtpantauresiko'] == '02') {
                                        echo "Anggota komite pemantauan resiko";
                                    } else {
                                        echo "Data tidak valid";
                                    }
                                    ?>
                            ...
                            <tr>
                                <th style="width: 25%; color: black;">Jabatan Dalam Komite Remunerasi dan Nominasi :</th>
                                <td>
                                    <?php
                                    if ($row['jbtremunerasi'] == '00') {
                                        echo "Tidak menjabat dalam komite remunerasi dan nominasi";
                                    } elseif ($row['jbtremunerasi'] == '01') {
                                        echo "Ketua komite remunerasi dan nominasi";
                                    } elseif ($row['jbtremunerasi'] == '02') {
                                        echo "Anggota komite remunerasi dan nominasi";
                                    } else {
                                        echo "Data tidak valid";
                                    }
                                    ?>
                            ...
                            <tr>
                                <th style="width: 25%; color: black;">Jabatan Dalam Komite Manajemen Risiko :</th>
                                <td>
                                    <?php
                                    if ($row['jbtmanrisk'] == '00') {
                                        echo "Tidak menjabat dalam komite manajemen risiko";
                                    } elseif ($row['jbtmanrisk'] == '01') {
                                        echo "Ketua komite manajemen risiko";
                                    } elseif ($row['jbtmanrisk'] == '02') {
                                        echo "Anggota komite manajemen risiko";
                                    } else {
                                        echo "Data tidak valid";
                                    }
                                    ?>
                            ...
                            <tr>
                                <th style="width: 25%; color: black;">Jabatan Dalam Komite Lainnya :</th>
                                <td>
                                    <?php
                                    if ($row['jbtlain'] == '00') {
                                        echo "Tidak menjabat dalam komite lainnya";
                                    } elseif ($row['jbtlain'] == '01') {
                                        echo "Ketua komite lainnya";
                                    } elseif ($row['jbtlain'] == '02') {
                                        echo "Anggota komite lainnya";
                                    } else {
                                        echo "Data tidak valid";
                                    }
                                    ?>
                            ...
                            <tr>
                                <th style="width: 25%; color: black;">Apakah Merupakan Pihak Independen :</th>
                                <td>
                                    <?php
                                    if ($row['independen'] == 1) {
                                        echo "Iya";
                                    } elseif ($row['independen'] == 2) {
                                        echo "Tidak";
                                    }
                                    ?>
                                </td>
                            </tr>
                            <!-- Baris 9: Tombol Edit/Hapus (jika ada permission) -->
                            <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                                <tr>
                                    <td colspan="3" style="padding: 10px;">
                                        <button type="button" class="btn btn-outline-warning btn-sm" data-toggle="modal"
                                            ...
                                            data-independen="<?= $row['independen']; ?>">
                            ...
                            <!-- Spacer untuk pemisah antar komite -->
                            <tr>
                                <td colspan="3"
            ...
            <table class="table table-bordered table-hover">
                ...
                foreach ($penjelastindak as $item) {
                    if ($item['id']) {
                        // $strukturkomite = $item['tindaklanjut'] ?? '';
                        $id = $item['id'] ?? '';
                ...
                <tbody>
                    <?php if (empty($penjelastindak)) { ?>
                        <tr>
                            <th class="table-info" style="width: 30%; color: black;">Tindak Lanjut Rekomendasi Struktur,
                                Keanggotaan, Keahlian, dan Independensi Anggota Komite (Opsional) :
                            </th>
                        </tr>
                        <tr>
                            <td colspan="2">Data tidak tersedia</td>
                        ...
                        <?php foreach ($penjelastindak as $row): ?>
                            <tr>
                                <th colspan="2" class="table-info" style="width: 30%; color: black;">Tindak Lanjut Rekomendasi
                                    Struktur, Keanggotaan, Keahlian, dan Independensi Anggota Komite (Opsional)
                                    :</th>
                            </tr>
                            <tr>
                                <td colspan="2">
                        ...
                        <div class="card shadow-sm approval-card">
                            <div class="card-body approval-card-body">
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Strukturkomite/approveSemuaKom') ?>"
                                    ...
                                    <a href="<?= base_url('Strukturkomite/unapproveSemuaKom') ?>"
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm approvaldir-card">
                            <div
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Strukturkomite/approveSemuaDirut') ?>"
                                    ...
                                    <a href="<?= base_url('Strukturkomite/unapproveSemuaDirut') ?>"
            ...
            <div class="d-flex justify-content-center mb-5">
                <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                    <div class="d-flex justify-content-center gap-2">
                        <a href="<?= base_url('Strukturkomite/exporttxtstrukturkomite'); ?>"
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group me-2" role="group" aria-label="First group">
                                <button type="button" class="btn btn-outline-primary btn-sm"
                                    onclick="window.location.href='<?= base_url('Tgjwbkomite') ?>'">
                                    << </button>
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            onclick="window.location.href='<?= base_url('Sahamdirdekom') ?>'">>></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <form action="<?= base_url('Strukturkomite/ubah'); ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="anggotakomite" id="anggotakomite"
                                value="<?= isset($row['anggotakomite']) ? esc($row['anggotakomite']) : ''; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="nikkomite" class="form-label">Input NIK:</label>
                            <input class="form-control" type="text" name="nikkomite" id="nikkomite"
                                value="<?= isset($row['nikkomite']) ? esc($row['nikkomite']) : ''; ?>" maxlength="16"
                                required>
                            <small id="nikCounterUbah" class="form-text text-muted">0/16 digit</small>
                        </div>
                        <div class="form-group">
                            <label for="keahlian" class="form-label">Input Keahlian Anggota Komite:
                            </label>
                            <textarea class="form-control" type="text" name="keahlian" id="keahlian" style="height: 150px"
                                placeholder="<?= isset($row['keahlian']) && $row['keahlian'] ?>" required></textarea>
                        </div>

                        <div class="mb-3">
                            <label for="jbtaudit" class="form-label">Jabatan dalam komite audit : </label>
                            <select style="height: 45px;" name="jbtaudit" id="jbtaudit" class="form-control" required>
                                <option value="" disabled>-- Pilih Jabatan --</option>
                                <option value="00" <?= (isset($row['jbtaudit']) && $row['jbtaudit'] == '00') ? 'selected' : ''; ?>>00. Tidak menjabat dalam Komite Audit</option>
                                <option value="01" <?= (isset($row['jbtaudit']) && $row['jbtaudit'] == '01') ? 'selected' : ''; ?>>01. Ketua Komite Audit</option>
                                <option value="02" <?= (isset($row['jbtaudit']) && $row['jbtaudit'] == '02') ? 'selected' : ''; ?>>02. Anggota Komite Audit</option>
                            </select>
                        </div>

                        <div class="mb-3">
                            <label for="jbtpantauresiko" class="form-label">Jabatan dalam Komite Pemantau Risiko : </label>
                            <select style="height: 45px;" name="jbtpantauresiko" id="jbtpantauresiko" class="form-control"
                                required>
                                <option value="" disabled>-- Pilih Jabatan --</option>
                                <option value="00" <?= (isset($row['jbtpantauresiko']) && $row['jbtpantauresiko'] == '00') ? 'selected' : ''; ?>>00. Tidak menjabat dalam Komite Pemantauan Resiko</option>
                                <option value="01" <?= (isset($row['jbtpantauresiko']) && $row['jbtpantauresiko'] == '01') ? 'selected' : ''; ?>>01. Ketua Komite Pemantauan Resiko</option>
                                <option value="02" <?= (isset($row['jbtpantauresiko']) && $row['jbtpantauresiko'] == '02') ? 'selected' : ''; ?>>02. Anggota Komite Pemantauan Resiko</option>
                            </select>
                        </div>

                        <div class="mb-3">
                            <label for="jbtremunerasi" class="form-label">Jabatan dalam Komite Remunerasi dan Nominasi :
                            </label>
                            <select style="height: 45px;" name="jbtremunerasi" id="jbtremunerasi" class="form-control"
                                required>
                                <option value="" disabled>-- Pilih Jabatan --</option>
                                <option value="00" <?= (isset($row['jbtremunerasi']) && $row['jbtremunerasi'] == '00') ? 'selected' : ''; ?>>00. Tidak menjabat dalam Komite Remunerasi dan Nominasi</option>
                                <option value="01" <?= (isset($row['jbtremunerasi']) && $row['jbtremunerasi'] == '01') ? 'selected' : ''; ?>>01. Ketua Komite Remunerasi dan Nominasi</option>
                                <option value="02" <?= (isset($row['jbtremunerasi']) && $row['jbtremunerasi'] == '02') ? 'selected' : ''; ?>>02. Anggota Komite Remunerasi dan Nominasi</option>
                            </select>
                        </div>

                        <div class="mb-3">
                            <label for="jbtmanrisk" class="form-label">Jabatan dalam Komite Manajemen Risiko : </label>
                            <select style="height: 45px;" name="jbtmanrisk" id="jbtmanrisk" class="form-control" required>
                                <option value="" disabled>-- Pilih Jabatan --</option>
                                <option value="00" <?= (isset($row['jbtmanrisk']) && $row['jbtmanrisk'] == '00') ? 'selected' : ''; ?>>00. Tidak menjabat dalam Komite Manajemen Risiko</option>
                                <option value="01" <?= (isset($row['jbtmanrisk']) && $row['jbtmanrisk'] == '01') ? 'selected' : ''; ?>>01. Ketua Komite Manajemen Risiko</option>
                                <option value="02" <?= (isset($row['jbtmanrisk']) && $row['jbtmanrisk'] == '02') ? 'selected' : ''; ?>>02. Anggota Komite Manajemen Risiko</option>
                            </select>
                        </div>

                        <div class="mb-3">
                            <label for="jbtlain" class="form-label">Jabatan dalam Komite Lainnya : </label>
                            <select style="height: 45px;" name="jbtlain" id="jbtlain" class="form-control" required>
                                <option value="" disabled>-- Pilih Jabatan --</option>
                                <option value="00" <?= (isset($row['jbtlain']) && $row['jbtlain'] == '00') ? 'selected' : ''; ?>>00. Tidak menjabat dalam Komite Lainnya</option>
                                <option value="01" <?= (isset($row['jbtlain']) && $row['jbtlain'] == '01') ? 'selected' : ''; ?>>01. Ketua Komite Lainnya</option>
                                <option value="02" <?= (isset($row['jbtlain']) && $row['jbtlain'] == '02') ? 'selected' : ''; ?>>02. Anggota Komite Lainnya</option>
                            </select>
                        </div>

                        <div class="mb-3">
                            <label for="independen" class="form-label">Apakah Merupakan Pihak Independen? : </label>
                            <select style="height: 45px;" name="independen" id="independen" class="form-control" required>
                                <option value="" disabled>-- Apakah pihak independen --</option>
                                <option value="1" <?= (isset($row['independen']) && $row['independen'] == '1') ? 'selected' : ''; ?>>1. Ya</option>
                                <option value="2" <?= (isset($row['independen']) && $row['independen'] == '2') ? 'selected' : ''; ?>>2. Tidak</option>
                            </select>
                        </div>
                </div>
...
<div class="modal fade" id="modalTambahketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Strukturkomite/tambahketerangan'); ?>" method="post">
                    <input type="hidden" name="id" id="id-penjelastindak"> <!-- Hidden field to pass the ID -->

                    <div class="form-group">
                        <label for="tindaklanjut" class="form-label">Tambah Tindak Lanjut Rekomendasi Program Kerja dan
                            Realisasi Program Kerja Komite (Opsional) : </label>
...
<div class="modal fade" id="modaleditketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Strukturkomite/editketerangan'); ?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="tindaklanjut" class="form-label">Ubah Tindak Lanjut Rekomendasi Program Kerja dan
                            Realisasi Program Kerja Komite (Opsional): </label>
                        <textarea class="form-control" name="tindaklanjut" id="tindaklanjut"
...
<div class="modal fade" id="modalTambah">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Tugas, Tanggung Jawab, Program Kerja, dan Realisasi Program Kerja Komite
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                <form action="<?= base_url('Strukturkomite/tambahstrukturkomite'); ?>" method="post">
                    <div class="form-group">
                        <label for="anggotakomite">Input Nama Anggota Komite:</label>
                        <input type="text" name="anggotakomite" id="anggotakomite" class="form-control" required>
                    </div>

                    <div class="mb-3">
                        <label for="nikkomite" class="form-label">Input NIK:</label>
                        <input class="form-control" type="text" name="nikkomite" id="nikTambah" maxlength="16" required>
                        <small id="nikCounterTambah" class="form-text text-muted">0/16 digit</small>
                    </div>

                    <div class="form-group">
                        <label for="keahlian">Input Keahlian Anggota Komite: </label>
                        <textarea type="text" name="keahlian" id="keahlian" class="form-control" style="height: 150px"
                            required></textarea>
                    </div>

                    <div class="form-group">
                        <label for="jbtaudit">Jabatan dalam komite audit :</label>
                        <select style="height: 45px;" name="jbtaudit" id="jbtaudit" class="form-control" required>
                            <option value="">-- Pilih Jabatan --</option>
                            <option value="00">00. Tidak menjabat dalam Komite Audit</option>
                            <option value="01">01. Ketua Komite Audit</option>
                            <option value="02">02. Anggota Komite Audit</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="jbtpantauresiko">Jabatan dalam Komite Pemantau Risiko :</label>
                        <select style="height: 45px;" name="jbtpantauresiko" id="jbtpantauresiko" class="form-control"
                            required>
                            <option value="">-- Pilih Jabatan --</option>
                            <option value="00">00. Tidak menjabat dalam Komite Pemantauan Resiko</option>
                            <option value="01">01. Ketua Komite Pemantauan Resiko</option>
                            <option value="02">02. Anggota Komite Pemantauan Resiko</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="jbtremunerasi">Jabatan dalam Komite Remunerasi dan Nominasi :</label>
                        <select style="height: 45px;" name="jbtremunerasi" id="jbtremunerasi" class="form-control"
                            required>
                            <option value="">-- Pilih Jabatan --</option>
                            <option value="00">00. Tidak menjabat dalam Komite Remunerasi dan Nominasi</option>
                            <option value="01">01. Ketua Komite Remunerasi dan Nominasi</option>
                            <option value="02">02. Anggota Komite Remunerasi dan Nominasi</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="jbtmanrisk">Jabatan dalam Komite Manajemen Risiko :</label>
                        <select style="height: 45px;" name="jbtmanrisk" id="jbtmanrisk" class="form-control" required>
                            <option value="">-- Pilih Jabatan --</option>
                            <option value="00">00. Tidak menjabat dalam Komite Manajemen Risiko</option>
                            <option value="01">01. Ketua Komite Manajemen Risiko</option>
                            <option value="02">02. Anggota Komite Manajemen Risiko</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="jbtlain">Jabatan dalam Komite Lainnya :</label>
                        <select style="height: 45px;" name="jbtlain" id="jbtlain" class="form-control" required>
                            <option value="">-- Pilih Jabatan --</option>
                            <option value="00">00. Tidak menjabat dalam Komite Lainnya</option>
                            <option value="01">01. Ketua Komite Lainnya</option>
                            <option value="02">02. Anggota Komite Lainnya</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="independen">Jabatan dalam Komite Lainnya :</label>
                        <select style="height: 45px;" name="independen" id="independen" class="form-control" required>
                            <option value="">-- Apakah pihak independen --</option>
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    ...
                    window.location.href = "/Strukturkomite/setNullKolomTindak/" + id;
                }
            });
        });
    });
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    window.location.href = "/Strukturkomite/setNullKolomPenjelaslanjut/" + id;
                }
            });
        });
    });
...
<script>
    ...
    handleNikCounter('nikkomite', 'nikCounterUbah');
</script>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchAndDisplayComments(Id, kodebpr, periodeId) {
            ...
            $.ajax({
                url: '<?= base_url('Strukturkomite/getKomentarByFaktorId'); ?>/' + Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                $.ajax({
                    url: '<?= base_url('Strukturkomite/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function pollUnreadCounts() {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('Strukturkomite/getUnreadCommentCountForFactor'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function refreshBadgeForAllUsers(exceptUserId) {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('Strukturkomite/getUnreadCommentCountForAllUsers'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
