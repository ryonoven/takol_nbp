...
<div class="container-fluid">
    ...
    <div class="card card-body">
        <div class="table-vertical">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span style="flex: 1; text-align: left;">
                    <?php
                    $allApproved = true;
                    $requiredFaktor10Ids = range(1, 6);

                    foreach ($requiredFaktor10Ids as $faktor10Id) {
                        $item = array_filter(
                            $faktors10,
                            fn($f) =>
                            $f['id'] == $faktor10Id
                            ...
                            <?php foreach ($faktors10 as $row): ?>
                                <?php if ($row['sph'] == 'Struktur'): ?>
                                    <tr>
                                        ...
                                        $userSpecificData = array_filter($faktors10, function ($item) use ($row, $kodebpr, $periodeId) {
                                        ...
                                        <td>
                                            <?php if ($userInGroupAdmin || $userInGroupPE): ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <button type="button" data-toggle="modal" data-target="#modalHapusnilai10"
                                        ...
                                        <td>
                                            ...
                                            $initialUnreadCount = $commentReads10Model->countUnreadCommentsForUserByFactor(
                                                $row['id'],
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekomValue == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor10/unapprovedekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor10id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor10/accdekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor10id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom2): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekom2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor10/unapprovedekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor10id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor10/accdekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor10id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDireksi2 || $userInGroupDireksi): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdir2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor10/unapprovedir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor10id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor10/accdir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor10id" value="<?= $row['id']; ?>" />
        ...
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <span class="label" style="flex: 3; margin-right: 10px;">
                <strong>Kesimpulan Penilaian Faktor 10 (Batas Maksimum Pemberian Kredit)</strong>
            </span>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <thead>
                    <tr>
                        <th colspan="5" class="text-center">Nilai Faktor 10</th>
                    </tr>
                                ...
                                <td colspan="5" class="text-center">
                                    ...
                                    switch ($rataRata) {
                                        case 1:
                                            ...
                                            echo "<li>BPR telah memiliki, mengevaluasi, dan menginikan secara berkala kebijakan, sistem dan prosedur tertulis terkait BMPK dengan ruang lingkup sangat memadai, serta melaksanakan kebijakan, sistem dan prosedur, termasuk sosialisasi kebijakan BMPK secara berkala kepada seluruh sumber daya manusia BPR.</li>";
                                            echo "<li>Proses pemberian kredit oleh BPR kepada pihak terkait dan/atau pemberian kredit besar telah memenuhi Peraturan Otoritas Jasa Keuangan mengenai BMPK dan memperhatikan prinsip kehati-hatian maupun peraturan perundang-undangan, termasuk melakukan pemantauan terhadap seluruh proses pemberian kredit secara berkala sehingga tidak terdapat pelanggaran dan pelampauan BMPK.</li>";
                                            echo "<li>Laporan pemberian kredit oleh BPR kepada pihak terkait dan/atau pemberian kredit yang melanggar dan/atau melampaui BMPK telah disampaikan secara berkala kepada Otoritas Jasa Keuangan secara lengkap, akurat, kini, utuh, dan tepat waktu sesuai ketentuan Otoritas Jasa Keuangan.</li>";
                                            echo "</ol>";
                                            break;
                                        case 2:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR telah memiliki, mengevaluasi, dan menginikan kebijakan, sistem dan prosedur tertulis terkait BMPK dengan ruang lingkup memadai, serta melaksanakan kebijakan, sistem dan prosedur, termasuk sosialisasi kebijakan BMPK kepada seluruh sumber daya manusia BPR.</li>";
                                            echo "<li>Proses pemberian kredit oleh BPR kepada pihak terkait dan/atau pemberian kredit besar sebagian besar telah memenuhi Peraturan Otoritas Jasa Keuangan mengenai BMPK dan memperhatikan prinsip kehati hatian maupun peraturan perundang-undangan, termasuk melakukan pemantauan terhadap proses pemberian kredit sehingga penyelesaian pelanggaran dan/atau pelampauan BMPK dilakukan dengan segera.</li>";
                                            echo "<li>Laporan pemberian kredit oleh BPR kepada pihak terkait dan/atau pemberian kredit yang melanggar dan/atau melampaui BMPK telah disampaikan secara berkala kepada Otoritas Jasa Keuangan secara lengkap, akurat, kini, utuh, dan tepat waktu sesuai ketentuan Otoritas Jasa Keuangan.</li>";
                                            echo "</ol>";
                                            break;
                                        case 3:
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR telah memiliki dan mengevaluasi kebijakan, sistem dan prosedur tertulis terkait BMPK dengan ruang lingkup cukup memadai, serta melaksanakan kebijakan, sistem dan prosedur, termasuk sosialisasi kebijakan BMPK kepada seluruh sumber daya manusia BPR.</li>";
                                            echo "<li>Proses pemberian kredit oleh BPR kepada pihak terkait dan/atau pemberian kredit besar telah memenuhi sebagian Peraturan Otoritas Jasa Keuangan mengenai BMPK dan memperhatikan prinsip kehati-hatian maupun peraturan perundang-undangan, termasuk melakukan pemantauan terhadap proses pemberian kredit sehingga penyelesaian pelanggaran dan/atau pelampauan BMPK dilakukan dengan baik.</li>";
                                            echo "<li>Laporan pemberian kredit oleh BPR kepada pihak terkait dan/atau pemberian kredit yang melanggar dan/atau melampaui BMPK telah disampaikan kepada Otoritas Jasa Keuangan secara lengkap, akurat, kini, utuh, dan tepat waktu sesuai ketentuan Otoritas Jasa Keuangan.</li>";
                                            echo "</ol>";
                                            break;
                                        case 4:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR telah memiliki kebijakan, sistem dan prosedur tertulis terkait BMPK namun ruang lingkup kurang memadai, sehingga pelaksanaan penyelesaian pelanggaran dan/atau pelampauan BMPK tidak terlaksana dengan baik.</li>";
                                            echo "<li>Proses pemberian kredit oleh BPR kepada pihak terkait dan/atau pemberian kredit besar hanya memenuhi sebagian kecil Peraturan Otoritas Jasa Keuangan mengenai BMPK dan memperhatikan prinsip kehati hatian maupun peraturan perundang-undangan, termasuk tidak sepenuhnya melakukan pemantauan terhadap proses pemberian kredit sehingga penyelesaian pelanggaran dan/atau pelampauan BMPK tidak dilakukan dengan baik.</li>";
                                            echo "<li>Laporan pemberian kredit oleh BPR kepada pihak terkait dan/atau pemberian kredit yang melanggar dan/atau melampaui BMPK tidak sepenuhnya disampaikan kepada Otoritas Jasa Keuangan secara lengkap, akurat, kini, utuh, dan tepat waktu sesuai ketentuan Otoritas Jasa Keuangan.</li>";
                                            echo "</ol>";
                                            break;
                                        case 5:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR tidak memiliki kebijakan, sistem dan prosedur tertulis terkait BMPK namun ruang lingkup, sehingga pelaksanaan penyelesaian pelanggaran dan/atau pelampauan BMPK tidak terlaksana dengan baik.</li>";
                                            echo "<li>Proses pemberian kredit oleh BPR kepada pihak terkait dan/atau pemberian kredit besar tidak memenuhi Peraturan Otoritas Jasa Keuangan mengenai BMPK dan memperhatikan prinsip kehati-hatian maupun peraturan perundang-undangan, termasuk tidak melakukan pemantauan terhadap proses pemberian kredit sehingga penyelesaian pelanggaran dan/atau pelampauan BMPK tidak dilakukan dengan baik.</li>";
                                            echo "<li>Laporan pemberian kredit oleh BPR kepada pihak terkait dan/atau pemberian kredit yang melanggar dan/atau melampaui BMPK tidak disampaikan kepada Otoritas Jasa Keuangan secara lengkap, akurat, kini, utuh, dan tepat waktu sesuai ketentuan Otoritas Jasa Keuangan.</li>";
                                            echo "</ol>";
                                            break;
                                        default:
                                            echo "Belum ada nilai faktor10.";
                                            break;
                                    }
                                    ?>
                                </td>
        ...
        <div class="card-body">
                    ...
                    <tr>
                        <th colspan="5" class="text-center">Kesimpulan
                            <?php if ($userInGroupPE || $userInGroupAdmin):
                                ...
                                $kesimpulanData = array_filter($faktors10, function ($item) use ($kodebpr, $periodeId) {
            ...
            <table class="table">
                <tbody>
                    <?php
                    // Filter faktor10 data for current BPR and period
                    $filteredFaktors = array_filter($faktors10, function ($item) use ($kodebpr, $periodeId) {
                        return $item['kodebpr'] == $kodebpr && $item['periode_id'] == $periodeId;
                    });
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url('faktor10/ubah'); ?>" method="post">
                        <!-- Hidden field untuk faktor10id -->
                        <input type="text" name="faktor10id" id="id-faktor10" value="">
                        <div class="mb-3">
...
<?php if (!empty($faktors10)) { ?>
    <div class="modal fade" id="modalUbahkesimpulan">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Kesimpulan Penilaian Faktor 10 </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('faktor10/ubahkesimpulan'); ?>" method="post">
                        <input type="text" name="faktor10id" id="id-faktor10" value="">
                        <div class="mb-3">
...
<div class="modal fade" id="modaltambahNilai">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?= base_url('faktor10/tambahNilai'); ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title">Faktor 10</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <input type="text" name="faktor10_id" id="id-faktor10" readonly>
                    <div class="mb-3">
                        <label for="sub_category" class="form-label">Sub Kategori: </label>
                        <textarea class="form-control" name="sub_category" id="sub_category" style="height: 100px"
                            readonly></textarea>
...
<script>
    $(document).ready(function () {
        // When the "Tambah Nilai" button is clicked, populate the id-faktor10 input field
        $('#modaltambahNilai').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var faktor10Id = button.data('id'); // Extract the faktor10_id from data-id attribute

            var modal = $(this);
            modal.find('#id-faktor10').val(faktor10Id); // Set the value of #id-faktor10 input
        });

        // Optional: if you need to clear the value of #id-faktor10 when closing the modal
        $('#modaltambahNilai').on('hidden.bs.modal', function () {
            $(this).find('#id-faktor10').val('');
        });
    });
</script>
        ...
        <div class="modal-content">
            <form action="<?= base_url('faktor10/tambahKomentar'); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor10_id" id="id-faktor10">
...
<div class="modal fade" id="modalHapusnilai10">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="btnHapusnilai10">Yakin</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?= base_url('faktor10/save_komentar'); ?>',
                method: 'POST',
                data: formData,
                dataType: 'json',
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateBadge(faktor10Id, newCount) {
            const badge = document.getElementById('notification-badge-' + faktor10Id);
            if (badge) {
                if (newCount > 0) {
        ...
        function fetchAndDisplayComments(faktor10Id, kodebpr, periodeId) {
            const modal = $('#modaltambahKomentar');
            modal.find('#komentarLamaList').html('<li>Memuat komentar...</li>'); // Show loading message

            $.ajax({
                url: '<?= base_url('faktor10/getKomentarByFaktorId'); ?>/' + faktor10Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                const faktor10Id = this.getAttribute('data-faktor-id');
                ...
                $('#modaltambahKomentar').find('#id-faktor10').val(faktor10Id);

                // Fetch and display comments when the modal opens
                fetchAndDisplayComments(faktor10Id, kodebpr, periodeId);

                // AJAX call to mark comments as read for the current user
                $.ajax({
                    url: '<?= base_url('faktor10/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        faktor10_id: faktor10Id,
                        kodebpr: kodebpr,
                        user_id: userId,
                        periode_id: periodeId,
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            updateBadge(faktor10Id, 0); // Set badge to 0 after comments are marked read
                        } else {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            const faktor10Id = form.find('#id-faktor10').val(); // Get faktor10Id from the form's hidden input
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        fetchAndDisplayComments(faktor10Id, GLOBAL_KODEBPR, GLOBAL_ACTIVE_PERIODE_ID);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response && typeof response.unread_count !== 'undefined') {
                            updateBadge(faktor10Id, response.unread_count);
                        }
                    },
                    error: function (xhr, status, error) {
                        console.error('Error fetching unread count for factor ' + faktor10Id + ':', error);
                    }
                });
            });
        }
        ...
        pollUnreadCounts();
        // Set up polling interval (e.g., every 100 seconds)
    ...
    $(document).ready(function () {
        $('.btn-accdekom').on('click', function () {
            var faktor10Id = $(this).data('faktorid');
            var kodebpr = $(this).data('kodebpr');
            var periodeId = $(this).data('periodeid');

            $.ajax({
                url: '<?= base_url('faktor10/accdekom'); ?>',
                method: 'POST',
                data: {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor10/accdekom2'); ?>',
                method: 'POST',
                data: {
                    faktor10id: faktor10Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor10/accdekom'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor10id: faktor10Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor10/accdekom2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor10id: faktor10Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdir2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor10/accdir2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor10id: faktor10Id,
                    kodebpr: kodebpr,
