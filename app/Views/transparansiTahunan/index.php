    ...
    <div class="card">
        <div class="card-reader">
            <div class="row">
                ...
                <div class="col-md">
                    ...
                    <a href="/transparansiTahunan/excel" class="btn btn-outline-success shadow float-right mt-3">Excel <i class="fa fa-file-excel"></i></a>
                </div>
            </div>
        ...
        <div class="card-body">
            <table class="table table-striped">
                ...
                <!-- Table body -->
                <tbody>
                    <?php if(empty($transparansiTahunan)) { ?>
                        <tr>
                            <td scope="row"></td>
                            <td></td>
                            <td></td>
                    ...
                    <?php } else { ?>
                    <?php foreach ($transparansiTahunan as $row) : ?>
                        <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('transparansiTahunan/ubah'); ?>" method="post">
                <input type="hidden" name="id" id="id-transparansiTahunan">
...
<div class="modal fade" id="modalTambah">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('transparansiTahunan/tambahI'); ?>" method="post">
                <div class="form-group">
                    <label for="transparansiTahunan">Input Nama Data:</label>
