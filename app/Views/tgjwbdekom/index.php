...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-headertitle">
            ...
            <h1 class="h3 mb-4 text-gray-800 text-center"><?= $judul; ?><br>(E0202)</h1>
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <?php if ($userInGroupDekom || $userInGroupDireksi || $userInGroupPE || $userInGroupAdmin): ?>
                        <button type="button" class="btn btn-outline-success shadow btn-sm" data-toggle="modal"
                            data-target="#modalTambahkomentar" disabled><i class="far fa-comment"></i></button>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-hover">
                <tbody>
                    <?php if (empty($tgjwbdekom)) { ?>
                        <tr>
                            <th style="width: 30%; color: black;">Nama Dewan Komisaris:</th>
                                ...
                                <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                                    <td colspan="3">
                                        <button type="button" class="btn btn-outline-warning btn-sm" data-toggle="modal"
                                            ...
                                            data-dekom="<?= $row['dekom']; ?>" data-nik="<?= $row['nik']; ?>"
                                            data-tugastgjwbdekom="<?= $row['tugastgjwbdekom']; ?>"><i
            ...
            <table class="table table-bordered table-hover">
                <?php
                // Mengambil data tindaklanjut dan penjelasanlanjut dari $penjelasantindak berdasarkan ID yang sesuai
                $tindaklanjut = '';
                $penjelasanlanjut = '';
                $id = '';
                ...
                <tbody>
                    <?php if (empty($penjelastindak)) { ?>
                        <tr>
                            <th class="table-info" style="width: 30%; color: black;">Tindak Lanjut Rekomendasi Dewan
                                Komisaris :
                            </th>
                        </tr>
                        <tr>
                    ...
                    <?php } else { ?>
                        <?php foreach ($penjelastindak as $row): ?>
                            <tr>
                                <th colspan="2" class="table-info" style="width: 30%; color: black;">Rekomendasi Dewan untuk
                                    Komisaris BPR :</th>
                            </tr>
                            <tr>
                                <td colspan="2">
                        ...
                        <div class="card shadow-sm approval-card">
                            <div class="card-body approval-card-body">
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Tgjwbdekom/approveSemuaKom') ?>"
                                    ...
                                    <a href="<?= base_url('Tgjwbdekom/unapproveSemuaKom') ?>"
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm approvaldir-card">
                            <div
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Tgjwbdekom/approveSemuaDirut') ?>"
                                    ...
                                    <a href="<?= base_url('Tgjwbdekom/unapproveSemuaDirut') ?>"
            ...
            <div class="d-flex justify-content-center mb-5">
                <div class="d-flex justify-content-center gap-2 mb-5">
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        <a href="<?= base_url('Tgjwbdekom/exporttxttgjwbdekom'); ?>" class="btn btn-secondary btn-sm">
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group me-2" role="group" aria-label="First group">
                                <button type="button" class="btn btn-outline-primary btn-sm"
                                    onclick="window.location.href='<?= base_url('Tgjwbdir') ?>'">
                                    << </button>
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            onclick="window.location.href='<?= base_url('Tgjwbkomite') ?>'">>></button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Tgjwbdekom/ubah'); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="tugastgjwbdekom" class="form-label">Input Tugas dan Tanggung Jawab Anggota Dewan
                                Komisaris BPR: </label>
                            <textarea class="form-control" type="text" name="tugastgjwbdekom" id="tugastgjwbdekom"
                                style="height: 150px"
                                placeholder="<?= isset($row['tugastgjwbdekom']) ? esc($row['tugastgjwbdekom']) : ''; ?>"
                                required></textarea>
                        </div>
...
<div class="modal fade" id="modalTambahketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Penjelasan dan Tindak Lanjut Anggota Dewan Komisaris</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('Tgjwbdekom/tambahketerangan'); ?>" method="post">
                    <input type="hidden" name="id" id="id-penjelastindak"> <!-- Hidden field to pass the ID -->

                    <div class="form-group">
                        <label for="tindaklanjut" class="form-label">Tindak Lanjut Rekomendasi Dewan Komisaris BPR:
                        </label>
...
<div class="modal fade" id="modaleditketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Tgjwbdekom/editketerangan'); ?>" method="post">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Tgjwbdekom/tambahtgjwbdekom'); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" name="tugastgjwbdekom" id="tugastgjwbdekom" class="form-control"
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    ...
                    window.location.href = "/Tgjwbdekom/setNullKolomTindak/" + id;
                }
            });
        });
    });
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    window.location.href = "/Tgjwbdekom/setNullKolomPenjelaslanjut/" + id;
                }
            });
        });
    });
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchAndDisplayComments(Id, kodebpr, periodeId) {
            ...
            $.ajax({
                url: '<?= base_url('Tgjwbdekom/getKomentarByFaktorId'); ?>/' + Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                $.ajax({
                    url: '<?= base_url('Tgjwbdekom/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function pollUnreadCounts() {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('Tgjwbdekom/getUnreadCommentCountForFactor'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function refreshBadgeForAllUsers(exceptUserId) {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('Tgjwbdekom/getUnreadCommentCountForAllUsers'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
