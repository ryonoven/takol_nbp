...
<div class="container-fluid">
    ...
    <div class="card card-body">
        <div class="table-vertical">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span style="flex: 1; text-align: left;">
                    <?php
                    $allApproved = true;
                    $requiredFaktor5Ids = range(1, 6);

                    foreach ($requiredFaktor5Ids as $faktor5Id) {
                        $item = array_filter(
                            $faktors5,
                            fn($f) =>
                            $f['id'] == $faktor5Id
                            ...
                            <?php foreach ($faktors5 as $row): ?>
                                <?php if ($row['sph'] == 'Struktur'): ?>
                                    <tr>
                                        ...
                                        $userSpecificData = array_filter($faktors5, function ($item) use ($row, $kodebpr, $periodeId) {
                                        ...
                                        <td>
                                            <?php if ($userInGroupAdmin || $userInGroupPE): ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <button type="button" data-toggle="modal" data-target="#modalHapusnilai5" id="btn-hapus"
                                        ...
                                        <td>
                                            ...
                                            $initialUnreadCount = $commentReads5Model->countUnreadCommentsForUserByFactor(
                                                $row['id'],
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekomValue == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor5/unapprovedekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor5id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor5/accdekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor5id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom2): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekom2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor5/unapprovedekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor5id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor5/accdekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor5id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDireksi2 || $userInGroupDireksi): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdir2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor5/unapprovedir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor5id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor5/accdir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor5id" value="<?= $row['id']; ?>" />
        ...
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <span class="label" style="flex: 3; margin-right: 10px;">
                <strong>Kesimpulan Penilaian Faktor 5 (Penanganan Benturan Kepentingan)</strong>
            </span>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <thead>
                    <tr>
                        <th colspan="5" class="text-center">Nilai Faktor 5</th>
                    </tr>
                                ...
                                <td colspan="5" class="text-center">
                                    ...
                                    switch ($rataRata) {
                                        case 1:
                                            ...
                                            echo "<li>BPR telah memiliki dan menginikan secara berkala kebijakan benturan kepentingan dengan ruang lingkup sangat memadai.</li>";
                                            echo "<li>Tidak terdapat transaksi yang memiliki benturan kepentingan.</li>";
                                            echo "<li>Pelaksanaan tugas, fungsi, dan wewenang Direksi, Dewan Komisaris, Pejabat Eksekutif, dan pegawai BPR terkait dengan penanganan benturan kepentingan dilakukan secara sangat baik.</li>";
                                            echo "</ol>";
                                            break;
                                        case 2:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR telah memiliki dan menginikan kebijakan benturan kepentingan dengan ruang lingkup memadai, serta berhasil menangani benturan kepentingan dengan baik sesuai dengan kebijakan.</li>";
                                            echo "<li>Tidak terdapat transaksi yang memiliki benturan kepentingan dan apabila terdapat benturan kepentingan ditangani dengan baik serta tidak menimbulkan kerugian atau mengurangi keuntungan BPR, diungkapkan seluruhnya dalam setiap keputusan, dan telah terdokumentasi dengan sangat baik.</li>";
                                            echo "<li>Pelaksanaan tugas, fungsi, dan wewenang Direksi, Dewan Komisaris, Pejabat Eksekutif, dan pegawai BPR terkait dengan penanganan benturan kepentingan dilakukan secara baik.</li>";
                                            echo "</ol>";
                                            break;
                                        case 3:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR telah memiliki kebijakan benturan kepentingan dengan ruang lingkup cukup memadai, serta penanganan benturan kepentingan dilakukan dengan cukup baik sesuai dengan kebijakan.</li>";
                                            echo "<li>Terdapat benturan kepentingan yang belum sepenuhnya ditangani dan menimbulkan kerugian atau mengurangi keuntungan BPR, diungkapkan seluruhnya dalam setiap keputusan, dan telah terdokumentasi dengan baik.</li>";
                                            echo "<li>Pelaksanaan tugas, fungsi, dan wewenang Direksi, Dewan Komisaris, Pejabat Eksekutif, dan pegawai BPR terkait dengan penanganan benturan kepentingan dilakukan secara cukup baik.</li>";
                                            echo "</ol>";
                                            break;
                                        case 4:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR telah memiliki kebijakan benturan kepentingan dengan ruang lingkup kurang memadai, sehingga penanganan benturan kepentingan kurang berhasil.</li>";
                                            echo "<li>Terdapat benturan kepentingan yang belum sepenuhnya ditangani dan menimbulkan kerugian atau mengurangi keuntungan BPR, diungkapkan sebagian dalam setiap keputusan, dan terdokumentasi dengan kurang baik.</li>";
                                            echo "<li>Pelaksanaan tugas, fungsi, dan wewenang Direksi, Dewan Komisaris, Pejabat Eksekutif, dan pegawai BPR terkait dengan penanganan benturan kepentingan dilakukan secara kurang baik.</li>";
                                            echo "</ol>";
                                            break;
                                        case 5:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR tidak memiliki kebijakan benturan kepentingan, sehingga penanganan benturan kepentingan tidak berhasil.</li>";
                                            echo "<li>Seluruh benturan kepentingan tidak ditangani dan menimbulkan kerugian atau mengurangi keuntungan BPR, tidak diungkapkan dalam setiap keputusan, dan tidak terdokumentasi.</li>";
                                            echo "<li>Pelaksanaan tugas, fungsi, dan wewenang Direksi, Dewan Komisaris, Pejabat Eksekutif, dan pegawai BPR terkait dengan penanganan benturan kepentingan dilakukan secara tidak baik.</li>";
                                            echo "</ol>";
                                            break;
                                        default:
                                            echo "Belum ada nilai Faktor 5.";
                                            break;
                                    }
                                    ?>
                                </td>
        ...
        <div class="card-body">
                    ...
                    <tr>
                        <th colspan="5" class="text-center">Kesimpulan
                            <?php if ($userInGroupPE || $userInGroupAdmin):
                                ...
                                $kesimpulanData = array_filter($faktors5, function ($item) use ($kodebpr, $periodeId) {
            ...
            <table class="table">
                <tbody>
                    <?php
                    // Filter faktor5 data for current BPR and period
                    $filteredFaktors = array_filter($faktors5, function ($item) use ($kodebpr, $periodeId) {
                        return $item['kodebpr'] == $kodebpr && $item['periode_id'] == $periodeId;
                    });
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url('faktor5/ubah'); ?>" method="post">
                        <!-- Hidden field untuk faktor5id -->
                        <input type="text" name="faktor5id" id="id-faktor5" value="">
                        <div class="mb-3">
...
<?php if (!empty($faktors5)) { ?>
    <div class="modal fade" id="modalUbahkesimpulan">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Kesimpulan Penilaian Faktor 5 </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('faktor5/ubahkesimpulan'); ?>" method="post">
                        <input type="text" name="faktor5id" id="id-faktor5" value="">
                        <div class="mb-3">
...
<div class="modal fade" id="modaltambahNilai">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?= base_url('faktor5/tambahNilai'); ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title">Faktor 5</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <input type="text" name="faktor5_id" id="id-faktor5" readonly>
                    <div class="mb-3">
                        <label for="sub_category" class="form-label">Sub Kategori: </label>
                        <textarea class="form-control" name="sub_category" id="sub_category" style="height: 100px"
                            readonly></textarea>
...
<script>
    $(document).ready(function () {
        // When the "Tambah Nilai" button is clicked, populate the id-faktor5 input field
        $('#modaltambahNilai').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var faktor5Id = button.data('id'); // Extract the faktor5_id from data-id attribute

            var modal = $(this);
            modal.find('#id-faktor5').val(faktor5Id); // Set the value of #id-faktor5 input
        });

        // Optional: if you need to clear the value of #id-faktor5 when closing the modal
        $('#modaltambahNilai').on('hidden.bs.modal', function () {
            $(this).find('#id-faktor5').val('');
        });
    });
</script>
        ...
        <div class="modal-content">
            <form action="<?= base_url('faktor5/tambahKomentar'); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor5_id" id="id-faktor5">
...
<div class="modal fade" id="modalHapusnilai5">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="btnHapusnilai5">Yakin</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?= base_url('faktor5/save_komentar'); ?>',
                method: 'POST',
                data: formData,
                dataType: 'json',
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateBadge(faktor5Id, newCount) {
            const badge = document.getElementById('notification-badge-' + faktor5Id);
            if (badge) {
                if (newCount > 0) {
        ...
        function fetchAndDisplayComments(faktor5Id, kodebpr, periodeId) {
            const modal = $('#modaltambahKomentar');
            modal.find('#komentarLamaList').html('<li>Memuat komentar...</li>'); // Show loading message

            $.ajax({
                url: '<?= base_url('faktor5/getKomentarByFaktorId'); ?>/' + faktor5Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                const faktor5Id = this.getAttribute('data-faktor-id');
                ...
                $('#modaltambahKomentar').find('#id-faktor5').val(faktor5Id);

                // Fetch and display comments when the modal opens
                fetchAndDisplayComments(faktor5Id, kodebpr, periodeId);

                // AJAX call to mark comments as read for the current user
                $.ajax({
                    url: '<?= base_url('faktor5/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        faktor5_id: faktor5Id,
                        kodebpr: kodebpr,
                        user_id: userId,
                        periode_id: periodeId,
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            updateBadge(faktor5Id, 0); // Set badge to 0 after comments are marked read
                        } else {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            const faktor5Id = form.find('#id-faktor5').val(); // Get faktor5Id from the form's hidden input
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        fetchAndDisplayComments(faktor5Id, GLOBAL_KODEBPR, GLOBAL_ACTIVE_PERIODE_ID);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response && typeof response.unread_count !== 'undefined') {
                            updateBadge(faktor5Id, response.unread_count);
                        }
                    },
                    error: function (xhr, status, error) {
                        console.error('Error fetching unread count for factor ' + faktor5Id + ':', error);
                    }
                });
            });
        }
    ...
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor5/accdekom2'); ?>',
                method: 'POST',
                data: {
                    faktor5id: faktor5Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor5/accdekom'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor5id: faktor5Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor5/accdekom2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor5id: faktor5Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdir2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor5/accdir2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor5id: faktor5Id,
                    kodebpr: kodebpr,
