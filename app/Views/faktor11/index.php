...
<div class="container-fluid">
    ...
    <div class="card card-body">
        <div class="table-vertical">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span style="flex: 1; text-align: left;">
                    <?php
                    $allApproved = true;
                    $requiredFaktor11Ids = range(1, 13);

                    foreach ($requiredFaktor11Ids as $faktor11Id) {
                        $item = array_filter(
                            $faktors11,
                            fn($f) =>
                            $f['id'] == $faktor11Id
                            ...
                            <?php foreach ($faktors11 as $row): ?>
                                <?php if ($row['sph'] == 'Struktur'): ?>
                                    <tr>
                                        ...
                                        $userSpecificData = array_filter($faktors11, function ($item) use ($row, $kodebpr, $periodeId) {
                                        ...
                                        <td>
                                            <?php if ($userInGroupAdmin || $userInGroupPE): ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <button type="button" data-toggle="modal" data-target="#modalHapusnilai11"
                                        ...
                                        <td>
                                            ...
                                            $initialUnreadCount = $commentReads11Model->countUnreadCommentsForUserByFactor(
                                                $row['id'],
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekomValue == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor11/unapprovedekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor11id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor11/accdekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor11id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom2): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekom2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor11/unapprovedekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor11id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor11/accdekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor11id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDireksi2 || $userInGroupDireksi): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdir2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor11/unapprovedir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor11id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor11/accdir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor11id" value="<?= $row['id']; ?>" />
        ...
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <span class="label" style="flex: 3; margin-right: 10px;">
                <strong>Kesimpulan Penilaian Faktor 11 (Integritas Pelaporan dan Sistem Teknologi Informasi)</strong>
            </span>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <thead>
                    <tr>
                        <th colspan="5" class="text-center">Nilai Faktor 11</th>
                    </tr>
                                ...
                                <td colspan="5" class="text-center">
                                    ...
                                    switch ($rataRata) {
                                        case 1:
                                            ...
                                            echo "<li>BPR memiliki sistem pelaporan keuangan dan nonkeuangan yang didukung oleh sistem informasi manajemen yang sangat memadai sesuai ketentuan termasuk sumber daya manusia yang kompeten sehingga penyusunan laporan dilakukan secara lengkap, akurat, kini, utuh, dan tepat waktu.</li>";
                                            echo "<li>BPR memiliki pelaporan internal yang didukung oleh sistem informasi manajemen dan meningkatkan kualitas proses pengambilan keputusan oleh Direksi dan kualitas proses pengawasan oleh Dewan Komisaris, serta tidak terdapat penyalahgunaan dan pemanfaatan dalam rangka rekayasa keuangan dan/atau rekayasa hukum.</li>";
                                            echo "<li>BPR telah memiliki dan menginikan secara berkala kebijakan dan prosedur terkait integritas pelaporan dan sistem teknologi informasi dengan ruang lingkup sangat memadai, sehingga penyampaian pelaporan dilakukan sesuai dengan kebijakan dan prosedur.</li>";
                                            echo "<li>BPR melaksanakan transparansi informasi mengenai produk, layanan dan/atau penggunaan data nasabah BPR dengan berpedoman pada persyaratan dan tata cara sesuai ketentuan Otoritas Jasa Keuangan sehingga tidak terdapat laporan pengaduan dari nasabah.</li>";
                                            echo "</ol>";
                                            break;
                                        case 2:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR memiliki sistem pelaporan keuangan dan nonkeuangan yang didukung oleh sistem informasi manajemen yang memadai sesuai ketentuan termasuk sumber daya manusia yang kompeten sehingga penyusunan laporan dilakukan secara lengkap, akurat, kini, utuh, dan tepat waktu.</li>";
                                            echo "<li>BPR memiliki pelaporan internal yang didukung oleh sistem informasi manajemen dan dapat meningkatkan kualitas proses pengambilan keputusan oleh Direksi dan kualitas proses pengawasan oleh Dewan Komisaris, serta tidak terdapat penyalahgunaan dan pemanfaatan dalam rangka rekayasa keuangan dan/atau rekayasa hukum.</li>";
                                            echo "<li>BPR telah memiliki dan menginikan kebijakan dan prosedur terkait integritas pelaporan dan sistem teknologi informasi dengan ruang lingkup memadai, sehingga penyampaian pelaporan dilakukan sesuai dengan kebijakan dan prosedur.</li>";
                                            echo "<li>BPR melaksanakan transparansi informasi mengenai produk, layanan dan/atau penggunaan data nasabah BPR dengan berpedoman pada persyaratan dan tata cara sesuai ketentuan Otoritas Jasa Keuangan meskipun terdapat laporan pengaduan dari nasabah yang tidak bersifat signifikan dan dapat ditindaklanjuti segera.</li>";
                                            echo "</ol>";
                                            break;
                                        case 3:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR memiliki sistem pelaporan keuangan dan nonkeuangan yang didukung oleh sistem informasi manajemen yang cukup memadai sesuai ketentuan termasuk sumber daya manusia yang kompeten sehingga penyusunan laporan dilakukan secara lengkap, akurat, kini, utuh, dan tepat waktu.</li>";
                                            echo "<li>BPR belum sepenuhnya memiliki pelaporan internal yang didukung oleh sistem informasi manajemen dan belum dapat meningkatkan kualitas proses pengambilan keputusan oleh Direksi dan kualitas proses pengawasan oleh Dewan Komisaris, walaupun tidak terdapat penyalahgunaan dan pemanfaatan dalam rangka rekayasa keuangan dan/atau rekayasa hukum.</li>";
                                            echo "<li>BPR telah memiliki kebijakan dan prosedur terkait integritas pelaporan dan sistem teknologi informasi dengan ruang lingkup cukup memadai, sehingga penyampaian pelaporan dilakukan cukup sesuai dengan kebijakan dan prosedur.</li>";
                                            echo "<li>BPR melaksanakan transparansi informasi mengenai produk, layanan dan/atau penggunaan data nasabah BPR dengan berpedoman pada persyaratan dan tata cara sesuai ketentuan Otoritas Jasa Keuangan meskipun terdapat laporan pengaduan dari nasabah yang bersifat cukup signifikan dan dapat ditindaklanjuti.</li>";
                                            echo "</ol>";
                                            break;
                                        case 4:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR memiliki sistem pelaporan keuangan dan nonkeuangan yang didukung oleh sistem informasi manajemen yang kurang memadai sesuai ketentuan termasuk sumber daya manusia yang kompeten sehingga penyusunan laporan tidak sepenuhnya dilakukan secara lengkap, akurat, kini, utuh dan tepat waktu.</li>";
                                            ...
                                            echo "<li>BPR telah memiliki kebijakan dan prosedur terkait integritas pelaporan dan sistem teknologi informasi dengan ruang lingkup kurang memadai, sehingga penyampaian pelaporan dilakukan kurang sesuai dengan kebijakan dan prosedur.</li>";
                                            echo "<li>BPR belum sepenuhnya melaksanakan transparansi informasi mengenai produk, layanan dan/atau penggunaan data nasabah BPR dengan berpedoman pada persyaratan dan tata cara sesuai ketentuan Otoritas Jasa Keuangan sehingga terdapat laporan pengaduan dari nasabah yang bersifat signifikan dan tidak ditindaklanjuti segera.</li>";
                                            echo "</ol>";
                                            break;
                                        case 5:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>BPR tidak memiliki sistem pelaporan keuangan dan nonkeuangan yang didukung oleh sistem informasi manajemen sesuai ketentuan termasuk sumber daya manusia yang tidak kompeten sehingga penyusunan laporan dilakukan secara tidak lengkap, tidak akurat, tidak kini, tidak utuh, dan disampaikan melebihi batas waktu.</li>";
                                            echo "<li>BPR tidak memiliki pelaporan internal yang didukung oleh sistem informasi manajemen sehingga tidak dapat meningkatkan kualitas proses pengambilan keputusan oleh Direksi dan kualitas proses pengawasan oleh Dewan Komisaris, serta terdapat penyalahgunaan dan pemanfaatan dalam rangka rekayasa keuangan dan/atau rekayasa hukum.</li>";
                                            echo "<li>BPR tidak memiliki kebijakan dan prosedur terkait integritas pelaporan dan sistem teknologi informasi, sehingga penyampaian pelaporan tidak dilakukan sesuai dengan kebijakan dan prosedur.</li>";
                                            echo "<li>BPR tidak melaksanakan transparansi informasi mengenai produk, layanan dan/atau penggunaan data nasabah BPR dengan berpedoman pada persyaratan dan tata cara sesuai ketentuan Otoritas Jasa Keuangan sehingga terdapat laporan pengaduan dari nasabah dan tidak dapat ditindaklanjuti.</li>";
                                            echo "</ol>";
                                            break;
                                        default:
                                            echo "Belum ada nilai faktor11.";
                                            break;
                                    }
                                    ?>
                                </td>
        ...
        <div class="card-body">
                    ...
                    <tr>
                        <th colspan="5" class="text-center">Kesimpulan
                            <?php if ($userInGroupPE || $userInGroupAdmin):
                                ...
                                $kesimpulanData = array_filter($faktors11, function ($item) use ($kodebpr, $periodeId) {
            ...
            <table class="table">
                <tbody>
                    <?php
                    // Filter faktor11 data for current BPR and period
                    $filteredFaktors = array_filter($faktors11, function ($item) use ($kodebpr, $periodeId) {
                        return $item['kodebpr'] == $kodebpr && $item['periode_id'] == $periodeId;
                    });
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url('faktor11/ubah'); ?>" method="post">
                        <!-- Hidden field untuk faktor11id -->
                        <input type="hidden" name="faktor11id" id="id-faktor11" value="">
                        <div class="mb-3">
...
<?php if (!empty($faktors11)) { ?>
    <div class="modal fade" id="modalUbahkesimpulan">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Kesimpulan Penilaian Faktor 11 </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('faktor11/ubahkesimpulan'); ?>" method="post">
                        <input type="hidden" name="faktor11id" id="id-faktor11" value="">
                        <div class="mb-3">
...
<div class="modal fade" id="modaltambahNilai">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?= base_url('faktor11/tambahNilai'); ?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title">Faktor 11</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor11_id" id="id-faktor11" readonly>
                    <div class="mb-3">
                        <label for="sub_category" class="form-label">Sub Kategori: </label>
                        <textarea class="form-control" name="sub_category" id="sub_category" style="height: 100px"
                            readonly></textarea>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="tambahNilai" class="btn btn-primary">Simpan</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    $(document).ready(function () {
        // When the "Tambah Nilai" button is clicked, populate the id-faktor11 input field
        $('#modaltambahNilai').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var faktor11Id = button.data('id'); // Extract the faktor11_id from data-id attribute

            var modal = $(this);
            modal.find('#id-faktor11').val(faktor11Id); // Set the value of #id-faktor11 input
        });

        // Optional: if you need to clear the value of #id-faktor11 when closing the modal
        $('#modaltambahNilai').on('hidden.bs.modal', function () {
            $(this).find('#id-faktor11').val('');
        });
    });
</script>
        ...
        <div class="modal-content">
            <form action="<?= base_url('faktor11/tambahKomentar'); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor11_id" id="id-faktor11">
...
<div class="modal fade" id="modalHapusnilai11">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="btnHapusnilai11">Yakin</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?= base_url('faktor11/save_komentar'); ?>',
                method: 'POST',
                data: formData,
                dataType: 'json',
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateBadge(faktor11Id, newCount) {
            const badge = document.getElementById('notification-badge-' + faktor11Id);
            if (badge) {
                if (newCount > 0) {
        ...
        function fetchAndDisplayComments(faktor11Id, kodebpr, periodeId) {
            const modal = $('#modaltambahKomentar');
            modal.find('#komentarLamaList').html('<li>Memuat komentar...</li>'); // Show loading message

            $.ajax({
                url: '<?= base_url('faktor11/getKomentarByFaktorId'); ?>/' + faktor11Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                const faktor11Id = this.getAttribute('data-faktor-id');
                ...
                $('#modaltambahKomentar').find('#id-faktor11').val(faktor11Id);

                // Fetch and display comments when the modal opens
                fetchAndDisplayComments(faktor11Id, kodebpr, periodeId);

                // AJAX call to mark comments as read for the current user
                $.ajax({
                    url: '<?= base_url('faktor11/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        faktor11_id: faktor11Id,
                        kodebpr: kodebpr,
                        user_id: userId,
                        periode_id: periodeId,
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            updateBadge(faktor11Id, 0); // Set badge to 0 after comments are marked read
                        } else {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            const faktor11Id = form.find('#id-faktor11').val(); // Get faktor11Id from the form's hidden input
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        fetchAndDisplayComments(faktor11Id, GLOBAL_KODEBPR, GLOBAL_ACTIVE_PERIODE_ID);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response && typeof response.unread_count !== 'undefined') {
                            updateBadge(faktor11Id, response.unread_count);
                        }
                    },
                    error: function (xhr, status, error) {
                        console.error('Error fetching unread count for factor ' + faktor11Id + ':', error);
                    }
                });
            });
        }
        ...
        pollUnreadCounts();
        // Set up polling interval (e.g., every 110 seconds)
    ...
    $(document).ready(function () {
        $('.btn-accdekom').on('click', function () {
            var faktor11Id = $(this).data('faktorid');
            var kodebpr = $(this).data('kodebpr');
            var periodeId = $(this).data('periodeid');

            $.ajax({
                url: '<?= base_url('faktor11/accdekom'); ?>',
                method: 'POST',
                data: {
                    faktor11id: faktor11Id,
                    kodebpr: kodebpr,
                    periode_id: periodeId,
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor11/accdekom2'); ?>',
                method: 'POST',
                data: {
                    faktor11id: faktor11Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor11/accdekom'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor11id: faktor11Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor11/accdekom2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor11id: faktor11Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdir2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor11/accdir2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor11id: faktor11Id,
                    kodebpr: kodebpr,
