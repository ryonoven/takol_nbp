...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-headertitle">
            ...
            <h1 class="h3 mb-4 text-gray-800 text-center"><?= $judul; ?><br>(E0402)</h1>
        </div>
        ...
        <div class="card-body">
                    ...
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        <div class="btn-group" role="group" aria-label="Button group">
                            <button type="button" class="btn btn-primarys btn-sm" data-toggle="modal"
                                data-target="#modalTambahsahamdir"><i class="fa fa-plus"></i> Tambah Data Hubungan Keluarga
            ...
            <table class="table table-bordered table-hover">
                <tbody>
                    <?php if (
                        empty($keluargadirdekompshm) || !array_filter($keluargadirdekompshm, function ($row) {
                        return $row['jabatan'] === 'Direksi' &&
                            !empty($row['nama']) && !is_null($row['nama']) &&
                            !empty($row['nik']) && !is_null($row['nik']) &&
                            !empty($row['hubkeldir']) && !is_null($row['hubkeldir']) &&
                            !empty($row['hubkeldekom']) && !is_null($row['hubkeldekom']) &&
                            !empty($row['hubkelpshm']) && !is_null($row['hubkelpshm']);
                    })
                    ) { ?>
                        <tr>
                    ...
                    <?php } else { ?>
                        <?php
                        $i = 1;
                        foreach ($keluargadirdekompshm as $row):
                            if (
                                !empty($row['nama']) && !is_null($row['nama']) &&
                                !empty($row['nik']) && !is_null($row['nik']) &&
                                !empty($row['hubkeldir']) && !is_null($row['hubkeldir']) &&
                                ...
                                <tr>
                                    <th>Hubungan Keluarga Dengan Anggota Direksi Lain di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubkeldir']); ?></td>
                                </tr>
                                <tr>
                                    <th>Hubungan Keluarga Dengan Anggota Dewan Komisaris Lain di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubkeldekom']); ?></td>
                                </tr>
                                <tr>
                                    <th>Hubungan Keluarga Dengan Pemegang Saham Lain di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubkelpshm']); ?></td>
                                </tr>
                                <tr>
                                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                                        <td colspan="3">
                                            <button type="button" class="btn btn-outline-warning btn-sm" data-toggle="modal"
                                                ...
                                                data-hubkeldir="<?= htmlspecialchars($row['hubkeldir']); ?>"
                                                data-hubkeldekom="<?= htmlspecialchars($row['hubkeldekom']); ?>"
                                                data-hubkelpshm="<?= htmlspecialchars($row['hubkelpshm'] ?? ''); ?>">
                ...
                <div>
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        ...
                        <button type="button" class="btn btn-primary2 btn-sm" data-toggle="modal"
                            ...
                            <i class="fa fa-plus"></i> Tambah data Hubungan Keluarga Anggota Dewan Komisaris pada BPR
                        </button>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($keluargadirdekompshm as $row):
                            ...
                            if (
                                ...
                                <tr>
                                    <th>Hubungan Keluarga Dengan Anggota Direksi di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubkeldir']); ?></td>
                                </tr>
                                <tr>
                                    <th>Hubungan Keluarga Dengan Anggota Dewan Komisaris di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubkeldekom']); ?></td>
                                </tr>
                                <tr>
                                    <th>Hubungan Keluarga Dengan Pemegang Saham di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubkelpshm']); ?></td>
                                </tr>
                                <tr>
                                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                ...
                <div>
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        ...
                        <button type="button" class="btn btn-primary2 btn-sm" data-toggle="modal"
                            ...
                            <i class="fa fa-plus"></i> Tambah data Hubungan Keluarga Pemegang Saham pada BPR
                        </button>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <div class="card shadow-sm approval-card">
                            <div class="card-body approval-card-body">
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Keluargadirdekompshm/approveSemuaKom') ?>"
                                    ...
                                    <a href="<?= base_url('Keluargadirdekompshm/unapproveSemuaKom') ?>"
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm approvaldir-card">
                            <div
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Keluargadirdekompshm/approveSemuaDirut') ?>"
                                    ...
                                    <a href="<?= base_url('Keluargadirdekompshm/unapproveSemuaDirut') ?>"
            ...
            <div class="d-flex justify-content-center mb-5">
                <div class="d-flex justify-content-center gap-2 mb-5"><?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        <a href="<?= base_url('Keluargadirdekompshm/exporttxtkeluargadirdekompshm'); ?>"
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group me-2" role="group" aria-label="First group">
                                <button type="button" class="btn btn-outline-primary btn-sm"
                                    onclick="window.location.href='<?= base_url('Keuangandirdekompshm') ?>'">
                                    << </button>
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            onclick="window.location.href='<?= base_url('Paketkebijakandirdekom') ?>'">>></button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Keluargadirdekompshm/ubahdata'); ?>" method="post">
                        ...
                        <div class="mb-3">
                            <label for="hubkeldir" class="form-label">Nama Kelompok Usaha BPR:</label>
                            <input class="form-control" type="text" name="hubkeldir" id="hubkeldir"
                                value="<?= isset($row['hubkeldir']) ? esc($row['hubkeldir']) : ''; ?>" maxlength="16"
                                required>
                            <small id="hubkeldir" class="form-text text-muted">Format pengisian: Nama - Hubungan
                                Keluarga. Jika tidak ada data maka isi "Tidak ada"</small>
                        </div>
                        <div class="mb-3">
                            <label for="hubkeldekom" class="form-label">Input Persentase Kepemilikan (%):</label>
                            <input class="form-control" type="text" name="hubkeldekom" id="hubkeldekom"
                                value="<?= isset($row['hubkeldekom']) ? esc($row['hubkeldekom']) : ''; ?>" required>
                            <small id="hubkeldekom" class="form-text text-muted">Format pengisian: Nama - Hubungan
                                Keluarga. Jika tidak ada data maka isi "Tidak ada"</small>
                        </div>
                        <div class="form-group">
                            <label for="hubkelpshm" class="form-label">Input Persentase Kepemilikan (%) Tahun
                                Sebelumnya : </label>
                            <input class="form-control" type="text" name="hubkelpshm" id="hubkelpshm"
                                placeholder="<?= isset($row['hubkelpshm']) ? esc($row['hubkelpshm']) : ''; ?>"
                                required></input>
                            <small id="hubkelpshm" class="form-text text-muted">Format pengisian: Nama - Hubungan
                                Keluarga. Jika tidak ada data maka isi "Tidak ada"</small>
                        </div>
                </div>
...
<div class="modal fade" id="modalTambahketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('keluargadirdekompshm/tambahketerangan'); ?>" method="post">
...
<div class="modal fade" id="modaleditketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('keluargadirdekompshm/editketerangan'); ?>" method="post">
...
<div class="modal fade" id="modalTambahsahamdir">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Hubungan Keluarga Dengan Anggota Direksi Lain di BPR</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('Keluargadirdekompshm/tambahkeldir'); ?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="hubkeldir">Hubungan Keluarga Dengan Anggota Direksi Lain di BPR: </label>
                        <input type="text" name="hubkeldir" id="hubkeldir" class="form-control" required>
                        <small id="hubkeldir" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keluarga. Jika tidak ada data maka isi "Tidak ada"</small>
                    </div>
                    <div class="form-group">
                        <label for="hubkeldekom">Hubungan Keluarga Dengan Anggota Dewan Komisaris Lain di BPR: </label>
                        <input type="text" name="hubkeldekom" id="hubkeldekom" class="form-control" required>
                        <small id="hubkeldekom" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keluarga. Jika tidak ada data maka isi "Tidak ada"</small>
                    </div>
                    <div class="form-group">
                        <label for="hubkelpshm">Hubungan Keluarga Dengan Pemegang Saham Lain di BPR: </label>
                        <input type="text" name="hubkelpshm" id="hubkelpshm" class="form-control" required>
                        <small id="hubkelpshm" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keluarga. Jika tidak ada data maka isi "Tidak ada"</small>
                    </div>
            </div>
...
<div class="modal fade" id="modalTambahsahamdekom">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Hubungan Keluarga Dengan Anggota Dewan Komisaris Lain di BPR</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('Keluargadirdekompshm/tambahkeldekom'); ?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="hubkeldir">Input Hubungan Keluarga Dengan Anggota Direksi Lain di BPR: </label>
                        <input type="text" name="hubkeldir" id="hubkeldir" class="form-control" required>
                        <small id="hubkeldekom" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keluarga. Jika tidak ada data maka isi "Tidak ada"</small>
                    </div>
                    <div class="form-group">
                        <label for="hubkeldekom">Input Hubungan Keluarga Dengan Anggota Dewan Komisaris Lain di BPR:
                        </label>
                        <input type="text" name="hubkeldekom" id="hubkeldekom" class="form-control" required>
                        <small id="hubkeldekom" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keluarga. Jika tidak ada data maka isi "Tidak ada"</small>
                    ...
                    <div class="form-group">
                        <label for="hubkelpshm">Input Hubungan Keluarga Dengan Pemegang Saham di BPR: </label>
                        <input type="text" name="hubkelpshm" id="hubkelpshm" class="form-control" required>
                        <small id="hubkeldekom" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keluarga. Jika tidak ada data maka isi "Tidak ada"</small>
                    </div>
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    ...
                    window.location.href = "/keluargadirdekompshm/setNullKolomTindak/" + id;
                }
            });
        });
    });
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    window.location.href = "/Keluargadirdekompshm/setNullKolomPenjelaslanjut/" + id;
                }
            });
        });
    });
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchAndDisplayComments(Id, kodebpr, periodeId) {
            ...
            $.ajax({
                url: '<?= base_url('keluargadirdekompshm/getKomentarByFaktorId'); ?>/' + Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                $.ajax({
                    url: '<?= base_url('keluargadirdekompshm/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function pollUnreadCounts() {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('keluargadirdekompshm/getUnreadCommentCountForFactor'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function refreshBadgeForAllUsers(exceptUserId) {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('keluargadirdekompshm/getUnreadCommentCountForAllUsers'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
