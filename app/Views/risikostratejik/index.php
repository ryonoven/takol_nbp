        ...
        <div class="table-vertical">
            <div class="button-bar">
                <a href="Showprofilresiko" class="kpmr-btn icon-link icon-link-hover" id="btn-laporan">🡸 Laporan Profil
                    Risiko</a>
                <a href="Stratejikkpmr" class="kpmr-btn" id="btn-risiko">Risiko Stratejik KPMR 🡺</a>
            </div>
                ...
                <div class="text-center flex-grow-1">
                    <div class="text-center">
                        <h4 class="mb-0">
                            ...
                            <strong>Tingkat Risiko Stratejik Inheren</strong>
                        </h4>
            ...
            <div id="editNilai14" class="collapse">
                <div class="p-3 border-top">
                    <?php if (!empty($nilai14)): ?>
                        ...
                        <form action="<?= base_url('Stratejikinheren/simpanNilai14') ?>" method="post">
                            <?= csrf_field() ?>
            ...
            <div class="card-body">
                <div class="mb-2">
                    <strong>A. Kertas Kerja Stratejik Inheren</strong>
                </div>
            ...
            <div class="card mt-3">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0">
                        <i class="fas fa-clipboard-list"></i> Kesimpulan Penilaian Risiko Stratejik Inheren
                    </h6>
                </div>
                <div class="card-body">
                    <?php if (!empty($kesimpulan13) && !empty($kesimpulan13['keterangan'])): ?>
                        ...
                        <?php if (($userInGroupPE ?? false) || ($userInGroupAdmin ?? false)): ?>
                            <div class="collapse" id="editKesimpulan13">
                                <hr>
                                <form action="<?= base_url('Stratejikinheren/simpanKesimpulan13') ?>" method="post">
                                    <?= csrf_field() ?>
                            ...
                            <form action="<?= base_url('Stratejikinheren/simpanKesimpulan13') ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="keterangan" id="keterangan_new" rows="5"
                                        placeholder="Masukkan kesimpulan penilaian risiko stratejik inheren..."
                                        required></textarea>
                                </div>
            ...
            <div class="d-flex justify-content-center gap-2 mt-3">
                <a href="<?= base_url('Stratejikinheren/exporttxtrisikostratejikinheren'); ?>"
                        ...
                        <div class="card shadow-sm approvaldir-card" style="height: 120px;">
                            <div class="card-body approvaldir-card-body">
                                ...
                                <div class="approval-buttons-container">
                                    <a href="<?= base_url('Stratejikinheren/approveSemua') ?>"
                                    ...
                                    <a href="<?= base_url('Stratejikinheren/unapproveSemua') ?>"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Stratejikinheren/ubah'); ?>" method="post">
                    <?= csrf_field() ?>
...
<div class="modal fade" id="modalUbahkesimpulan">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Stratejikinheren/ubahkesimpulan'); ?>" method="post">
                    <?= csrf_field() ?>
...
<div class="modal fade" id="modaltambahNilai">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?= base_url('Stratejikinheren/tambahNilai'); ?>" method="post">
                <?= csrf_field() ?>
                <div class="modal-header">
...
<div class="modal fade" id="modaltambahKomentar">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('Stratejikinheren/tambahKomentar'); ?>" method="post">
                <?= csrf_field() ?>
                <div class="modal-header">
...
<script>
    ...
    function pollUnreadCounts() {
        $.ajax({
            url: `${BASE_URL}/Stratejikinheren/getAllUnreadCounts`,
            method: 'GET',
            dataType: 'json',
    ...
    $(document).ready(function () {
        setTimeout(function () {
            $.ajax({
                url: BASE_URL + '/Stratejikinheren/getFactorsData',
                method: 'GET',
                beforeSend: function () {
    ...
    function renderApprovalButton(faktorId, nilai) {
        <?php if (($userInGroupAdmin ?? false) || ($userInGroupDireksi ?? false) || ($userInGroupDireksi2 ?? false)): ?>
            ...
            return `
            <form action="${BASE_URL}/Stratejikinheren/${action}" method="POST" style="display: inline-block;" class="ml-2 form-approval">
    ...
    function attachEventHandlers() {
        ...
        $('form[action*="Stratejikinheren/ubahkesimpulan"]').off('submit').on('submit', function (e) {
            e.preventDefault();
    ...
    $(document).on('click', '.komentar-button', function () {
        ...
        // Load komentar
        $.ajax({
            url: `${BASE_URL}/Stratejikinheren/getKomentarByFaktorId/${faktorId}`,
            method: 'GET',
            data: {
        ...
        $.ajax({
            url: `${BASE_URL}/Stratejikinheren/markUserCommentsAsRead`,
            method: 'POST',
            data: {
                faktor_id: faktorId,
                kodebpr: GLOBAL_KODEBPR,
    ...
    // ===== FORM SUBMISSIONS =====
    $(document).ready(function () {
        $('form[action*="Stratejikinheren/ubah"]').on('submit', function (e) {
            e.preventDefault();
    ...
    `;
        ...
        $('form[action*="Stratejikinheren/ubahkesimpulan"]').on('submit', function (e) {
            e.preventDefault();
        ...
        $('form[action*="Stratejikinheren/tambahNilai"]').on('submit', function (e) {
            e.preventDefault();
        ...
        $('form[action*="Stratejikinheren/tambahKomentar"]').on('submit', function (e) {
            e.preventDefault();
