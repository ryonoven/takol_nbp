    ...
    <div class="card card-body">
        <div class="table-vertical">
            <div class="button-bar">
                <a href="Stratejikinheren" class="kpmr-btn icon-link icon-link-hover" id="btn-laporan">🡸 Laporan Risiko
                    Stratejik Inheren</a>
            </div>
                ...
                <div class="text-center flex-grow-1">
                    <div class="text-center">
                        <h4 class="mb-0">
                            ...
                            <strong>Tingkat Risiko Stratejik KPMR</strong>
                        </h4>
            ...
            <div id="editNilai14" class="collapse">
                <div class="p-3 border-top">
                    <?php if (!empty($nilai14)): ?>
                        ...
                        <form action="<?= base_url('Stratejikkpmr/simpanNilai14') ?>" method="post">
                            <?= csrf_field() ?>
            ...
            <div class="card-body">
                <div class="mb-2">
                    <strong>A. Kertas Kerja Stratejik KPMR</strong>
                </div>
            ...
            <div class="card mt-3">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0">
                        <i class="fas fa-clipboard-list"></i> Kesimpulan Penilaian Risiko Stratejik KPMR
                    </h6>
                </div>
                <div class="card-body">
                    <?php if (!empty($kesimpulan13) && !empty($kesimpulan13['keterangan'])): ?>
                        ...
                        <?php if (($userInGroupPE ?? false) || ($userInGroupAdmin ?? false)): ?>
                            <div class="collapse" id="editKesimpulan13">
                                <hr>
                                <form action="<?= base_url('Stratejikkpmr/simpanKesimpulan13') ?>" method="post">
                                    <?= csrf_field() ?>
            ...
            <div class="d-flex justify-content-center gap-2 mt-3">
                <a href="<?= base_url('Stratejikkpmr/exporttxtrisikostratejikkpmr'); ?>"
                        ...
                        <div class="card shadow-sm approvaldir-card" style="height: 120px;">
                            <div class="card-body approvaldir-card-body">
                                ...
                                <div class="approval-buttons-container">
                                    <a href="<?= base_url('Stratejikkpmr/approveSemua') ?>"
                                    ...
                                    <a href="<?= base_url('Stratejikkpmr/unapproveSemua') ?>"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Stratejikkpmr/ubah'); ?>" method="post">
                    <?= csrf_field() ?>
...
<div class="modal fade" id="modalUbahkesimpulan">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Stratejikkpmr/ubahkesimpulan'); ?>" method="post">
                    <?= csrf_field() ?>
...
<div class="modal fade" id="modaltambahNilai">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?= base_url('Stratejikkpmr/tambahNilai'); ?>" method="post">
                <?= csrf_field() ?>
                <div class="modal-header">
...
<div class="modal fade" id="modaltambahKomentar">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="<?= base_url('Stratejikkpmr/tambahKomentar'); ?>" method="post">
                <?= csrf_field() ?>
                <div class="modal-header">
...
<script>
    ...
    function pollUnreadCounts() {
        $.ajax({
            url: `${BASE_URL}/Stratejikkpmr/getAllUnreadCounts`,
            method: 'GET',
            dataType: 'json',
    ...
    $(document).ready(function () {
        setTimeout(function () {
            $.ajax({
                url: BASE_URL + '/Stratejikkpmr/getFactorsData',
                method: 'GET',
                beforeSend: function () {
    ...
    function renderApprovalButton(faktorId, nilai) {
        <?php if (($userInGroupAdmin ?? false) || ($userInGroupDireksi ?? false) || ($userInGroupDireksi2 ?? false)): ?>
            ...
            return `
            <form action="${BASE_URL}/Stratejikkpmr/${action}" method="POST" style="display: inline-block;" class="ml-2 form-approval">
    ...
    function attachEventHandlers() {
        ...
        $('form[action*="Stratejikkpmr/ubahkesimpulan"]').off('submit').on('submit', function (e) {
            e.preventDefault();
    ...
    $(document).on('click', '.komentar-button', function () {
        ...
        // Load komentar
        $.ajax({
            url: `${BASE_URL}/Stratejikkpmr/getKomentarByFaktorId/${faktorId}`,
            method: 'GET',
            data: {
        ...
        $.ajax({
            url: `${BASE_URL}/Stratejikkpmr/markUserCommentsAsRead`,
            method: 'POST',
            data: {
                faktor_id: faktorId,
                kodebpr: GLOBAL_KODEBPR,
    ...
    // ===== FORM SUBMISSIONS =====
    $(document).ready(function () {
        $('form[action*="Stratejikkpmr/ubah"]').on('submit', function (e) {
            e.preventDefault();
    ...
    `;
        ...
        $('form[action*="Stratejikkpmr/ubahkesimpulan"]').on('submit', function (e) {
            e.preventDefault();
        ...
        $('form[action*="Stratejikkpmr/tambahNilai"]').on('submit', function (e) {
            e.preventDefault();
        ...
        $('form[action*="Stratejikkpmr/tambahKomentar"]').on('submit', function (e) {
            e.preventDefault();
