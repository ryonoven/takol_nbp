...
<div class="container-fluid">
    ...
    <div class="card card-body">
        <div class="table-vertical">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <span style="flex: 1; text-align: left;">
                    <?php
                    $allApproved = true;
                    $requiredFaktor2Ids = range(1, 29);

                    foreach ($requiredFaktor2Ids as $faktor2Id) {
                        $item = array_filter(
                            $faktors2,
                            fn($f) =>
                            $f['id'] == $faktor2Id
                            ...
                            <?php foreach ($faktors2 as $row): ?>
                                <?php if ($row['sph'] == 'Struktur'): ?>
                                    <tr>
                                        ...
                                        $userSpecificData = array_filter($faktors2, function ($item) use ($row, $kodebpr, $periodeId) {
                                        ...
                                        <td>
                                            <?php if ($userInGroupAdmin || $userInGroupPE): ?>
                                                ...
                                                <?php else: ?>
                                                    ...
                                                    <button type="button" data-toggle="modal" data-target="#modalHapusnilai2" id="btn-hapus"
                                        ...
                                        <td>
                                            ...
                                            $initialUnreadCount = $commentReads2Model->countUnreadCommentsForUserByFactor(
                                                $row['id'],
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekomValue == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor2/unapprovedekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor2id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor2/accdekom/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor2id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDekom2): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdekom2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor2/unapprovedekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor2id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor2/accdekom2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor2id" value="<?= $row['id']; ?>" />
                                        ...
                                        <?php if ($userInGroupAdmin || $userInGroupDireksi2 || $userInGroupDireksi): ?>
                                            ...
                                            if ($row['kodebpr'] == $kodebpr && $row['periode_id'] == $activePeriodeId) {
                                                ...
                                                if ($accdir2Value == 1) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor2/unapprovedir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor2id" value="<?= $row['id']; ?>" />
                                                    ...
                                                    ?>
                                                    <td>
                                                        <form action="/faktor2/accdir2/<?= $row['id']; ?>" method="POST"
                                                            style="display: inline-block;">
                                                            <input type="hidden" name="kodebpr" value="<?= $kodebpr ?>" />
                                                            <input type="hidden" name="periode_id" value="<?= $periodeId ?>" />
                                                            <input type="hidden" name="faktor2id" value="<?= $row['id']; ?>" />
        ...
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <span class="label" style="flex: 3; margin-right: 10px;">
                <strong>Kesimpulan Penilaian Faktor 2 (Pelaksanaan Tugas, Tanggung Jawab, dan Wewenang Direksi)</strong>
            </span>
        </div>
        <div class="card-body">
            <table class="table table-striped">
                ...
                <thead>
                    <tr>
                        <th colspan="5" class="text-center">Nilai Faktor 2</th>
                    </tr>
                                ...
                                <td colspan="5" class="text-center">
                                    ...
                                    switch ($rataRata) {
                                        case 1:
                                            ...
                                            echo "<li>Memenuhi kondisi terpenuhinya struktur dan/atau infrastruktur sesuai ketentuan, proses penerapan tata kelola dilakukan dengan <b>Sangat Memadai</b>, dan ditunjukkan dengan hasil penerapan tata kelola yang <b>Sangat Baik.</b> Contoh/ilustrasi kondisi yang dapat menjadi indikator tersebut antara lain:</li>";

                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Direksi memenuhi seluruh persyaratan yang harus dipenuhi selama menjabat sesuai dengan ketentuan sehingga tugas dan tanggung jawab terlaksana dengan itikad baik, penuh tanggung jawab, kehati-hatian, dan independen, serta hasil kinerja Direksi dapat dipertanggungjawabkan sepenuhnya kepada pemegang saham melalui RUPS.</li>";
                                            echo "<li>Direksi telah melakukan pemenuhan sumber daya manusia dan struktur organisasi, termasuk membentuk satuan kerja atau mengangkat Pejabat Eksekutif dengan kuantitas dan kualitas sesuai dengan ketentuan dengan mempertimbangkan kompleksitas kegiatan usaha dalam rangka mendukung pelaksanaan tugas dan fungsi Direksi sehingga penyelenggaraan kegiatan usaha pada seluruh jenjang organisasi <b>telah sepenuhnya menerapkan prinsip tata kelola.</b></li>";
                                            echo "<li>Direksi telah memiliki dan menginikan secara berkala pedoman dan tata tertib kerja anggota Direksi sehingga pelaksanaan tugas dan pengambilan keputusan rapat Direksi yang bersifat strategis terlaksana dengan memperhatikan pedoman dan tata tertib kerja.</li>";
                                            echo "<li>Direksi memiliki kemauan dan kemampuan, serta upaya untuk membudayakan pembelajaran secara berkala dan berkelanjutan sehingga terdapat peningkatan pengetahuan, keahlian, dan kemampuan.</li>";
                                            echo "<li>Direksi sesuai dengan tugas dan tanggung jawab melakukan tindak lanjut seluruh temuan audit atau pemeriksaan, dan rekomendasi dari satuan kerja atau pejabat yang bertanggung jawab terhadap pelaksanaan audit intern, auditor ekstern, dan hasil pengawasan Dewan Komisaris, Otoritas Jasa Keuangan, dan/atau otoritas lain sehingga tidak terdapat temuan serupa dan/atau temuan berulang.</li>";
                                            echo "</ol>";
                                            break;
                                        case 2:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            echo "<li>Memenuhi kondisi terpenuhinya struktur dan/atau infrastruktur sesuai ketentuan, proses penerapan tata kelola dilakukan dengan <b>Memadai</b>, dan ditunjukkan dengan hasil penerapan tata kelola yang <b>Baik.</b> Contoh/ilustrasi kondisi yang dapat menjadi indikator tersebut antara lain:</li>";

                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Direksi memenuhi seluruh persyaratan yang harus dipenuhi selama menjabat sesuai dengan ketentuan sehingga tugas dan tanggung jawab terlaksana dengan <b>Baik</b> namun terdapat kelemahan dalam tugas dan tanggung jawab yang tidak signifikan dan dapat diperbaiki dengan segera serta hasil kinerja Direksi dapat dipertanggungjawabkan kepada pemegang saham melalui RUPS.</li>";
                                            echo "<li>Direksi telah melakukan pemenuhan sumber daya manusia dan struktur organisasi, termasuk membentuk satuan kerja atau mengangkat Pejabat Eksekutif dengan kuantitas dan kualitas sesuai dengan ketentuan dalam rangka mendukung pelaksanaan tugas dan fungsi Direksi sehingga penyelenggaraan kegiatan usaha pada seluruh jenjang organisasi <b>telah menerapkan prinsip tata kelola dengan Baik.</b></li>";
                                            echo "<li>Direksi telah memiliki dan menginikan secara berkala pedoman dan tata tertib kerja anggota Direksi sehingga pelaksanaan tugas dan pengambilan keputusan rapat Direksi yang bersifat strategis terlaksana dengan memperhatikan pedoman dan tata tertib kerja.</li>";
                                            echo "<li>Direksi memiliki kemauan dan kemampuan, serta upaya untuk membudayakan pembelajaran secara berkala sehingga terdapat peningkatan pengetahuan, keahlian, dan kemampuan.</li>";
                                            echo "<li>Direksi sesuai dengan tugas dan tanggung jawab telah melakukan tindak lanjut seluruh temuan audit atau pemeriksaan, dan rekomendasi dari satuan kerja atau pejabat yang bertanggung jawab terhadap pelaksanaan audit intern, auditor ekstern, dan hasil pengawasan Dewan Komisaris, Otoritas Jasa Keuangan, dan/atau otoritas lain namun terdapat temuan yang bersifat administratif.</li>";
                                            echo "</ol>";
                                            break;
                                        case 3:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            ...
                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Direksi memenuhi seluruh persyaratan yang harus dipenuhi selama menjabat sesuai dengan ketentuan sehingga tugas dan tanggung jawab terlaksana dengan <b>cukup baik</b> namun terdapat kelemahan dalam tugas dan tanggung jawab dan dapat diperbaiki serta hasil kinerja Direksi dapat dipertanggungjawabkan kepada pemegang saham melalui RUPS</li>";
                                            echo "<li>Direksi telah melakukan pemenuhan sumber daya manusia dan struktur organisasi, termasuk membentuk satuan kerja atau mengangkat Pejabat Eksekutif dengan kuantitas dan kualitas sesuai dengan ketentuan dalam rangka mendukung pelaksanaan tugas dan fungsi Direksi sehingga penyelenggaraan kegiatan usaha pada seluruh jenjang organisasi <b>telah menerapkan prinsip tata kelola dengan cukup baik.</b></li>";
                                            echo "<li>Direksi telah memiliki pedoman dan tata tertib kerja anggota Direksi sehingga pelaksanaan tugas dan pengambilan keputusan rapat Direksi yang bersifat strategis terlaksana dengan memperhatikan pedoman dan tata tertib kerja.</li>";
                                            echo "<li>Direksi memiliki kemauan dan kemampuan, serta upaya untuk membudayakan pembelajaran sehingga terdapat peningkatan pengetahuan, keahlian, dan kemampuan.</li>";
                                            echo "<li>Direksi sesuai dengan tugas dan tanggung jawab telah melakukan tindak lanjut seluruh temuan audit atau pemeriksaan, dan rekomendasi dari satuan kerja atau pejabat yang bertanggung jawab terhadap pelaksanaan audit intern, auditor ekstern, dan hasil pengawasan Dewan Komisaris, Otoritas Jasa Keuangan, dan/atau otoritas lain namun terdapat temuan berulang yang bersifat administratif.</li>";
                                            echo "</ol>";
                                            break;
                                        case 4:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            echo "<li>Belum sepenuhnya terpenuhi struktur dan/atau infrastruktur sesuai ketentuan, proses penerapan tata kelola dilakukan dengan <b>Kurang Memadai</b>, dan ditunjukkan dengan hasil penerapan tata kelola yang <b>Kurang Baik.</b> Contoh/ilustrasi kondisi yang dapat menjadi indikator tersebut antara lain:</li>";

                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Direksi memenuhi sebagian persyaratan yang harus dipenuhi selama menjabat sesuai dengan ketentuan sehingga pelaksanaan tugas dan tanggung jawab kurang berjalan dengan baik dan hasil kinerja Direksi tidak sepenuhnya dapat dipertanggungjawabkan kepada pemegang saham melalui RUPS.</li>";
                                            echo "<li>Direksi tidak melakukan pemenuhan sumber daya manusia dan struktur organisasi, termasuk pembentukan satuan kerja atau pengangkatan Pejabat Eksekutif dengan kuantitas dan kualitas yang <b>tidak sesuai</b> dengan ketentuan sehingga kurang mendukung pelaksanaan tugas dan fungsi Direksi sehingga penyelenggaraan kegiatan usaha pada seluruh jenjang organisasi <b>tidak sepenuhnya menerapkan prinsip tata kelola.</li>";
                                            echo "<li>Direksi telah memiliki pedoman dan tata tertib kerja anggota Direksi namun ruang lingkup belum sesuai dengan ketentuan sehingga pelaksanaan tugas dan pengambilan keputusan rapat Direksi yang bersifat strategis tidak terlaksana dengan baik.</li>";
                                            echo "<li>Direksi <b>kurang memiliki</b> kemauan dan kemampuan, serta upaya untuk membudayakan pembelajaran secara berkelanjutan sehingga tidak terdapat peningkatan pengetahuan, keahlian, dan kemampuan.</li>";
                                            echo "<li>Direksi telah melakukan tindak lanjut terhadap sebagian temuan audit atau pemeriksaan, dan rekomendasi dari satuan kerja atau pejabat yang bertanggung jawab terhadap pelaksanaan audit intern, auditor ekstern, dan hasil pengawasan Dewan Komisaris, Otoritas Jasa Keuangan, dan/atau otoritas lain sehingga terdapat temuan dan/atau temuan berulang yang bersifat substantif.</li>";
                                            echo "</ol>";
                                            break;
                                        case 5:
                                            echo "<p style='text-align: justify; padding-left: 0px;'>";
                                            echo "<li>Tidak terpenuhi struktur dan/atau infrastruktur sesuai ketentuan, proses penerapan tata kelola dilakukan dengan <b>Tidak Memadai</b>, dan ditunjukkan dengan hasil penerapan tata kelola yang tidak baik. Contoh/ilustrasi kondisi yang dapat menjadi indikator tersebut antara lain:</li>";

                                            echo "<ol style='text-align: left; padding-left: 40px;' type='a'>";
                                            echo "<li>Direksi tidak memenuhi seluruh persyaratan yang harus dipenuhi selama menjabat sesuai dengan ketentuan sehingga pelaksanaan tugas dan tanggung jawab tidak berjalan dengan baik dan hasil kinerja Direksi tidak dapat dipertanggungjawabkan kepada pemegang saham melalui RUPS.</li>";
                                            echo "<li>Direksi tidak melakukan pemenuhan sumber daya manusia dan struktur organisasi, termasuk tidak membentuk satuan kerja atau mengangkat Pejabat Eksekutif sesuai dengan ketentuan dalam rangka mendukung pelaksanaan tugas dan fungsi Direksi sehingga prinsip tata kelola tidak dapat diterapkan dalam penyelenggaraan kegiatan usaha pada seluruh jenjang organisasi.</li>";
                                            echo "<li>Direksi tidak memiliki pedoman dan tata tertib kerja anggota Direksi sehingga pelaksanaan tugas dan pengambilan keputusan rapat Direksi yang bersifat strategis tidak dapat terlaksana dengan baik.</li>";
                                            echo "<li>Direksi tidak memiliki pedoman dan tata tertib kerja anggota Direksi sehingga pelaksanaan tugas dan pengambilan keputusan rapat Direksi yang bersifat strategis tidak dapat terlaksana dengan baik. Direksi tidak memiliki kemauan dan kemampuan, serta upaya untuk membudayakan pembelajaran secara berkelanjutan sehingga tidak terdapat peningkatan pengetahuan, keahlian, dan kemampuan.</li>";
                                            echo "<li>Direksi tidak melakukan tindak lanjut seluruh temuan audit atau pemeriksaan, dan rekomendasi dari satuan kerja atau pejabat yang bertanggung jawab terhadap pelaksanaan audit intern, auditor ekstern, dan hasil pengawasan Dewan Komisaris, Otoritas Jasa Keuangan, dan/atau otoritas lain sehingga terdapat temuan dan/atau temuan berulang yang bersifat substantif.</li>";
                                            echo "</ol>";
                                            break;
                                        default:
                                            echo "Belum ada nilai faktor2.";
                                            break;
                                    }
                                    ?>
                                </td>
        ...
        <div class="card-body">
                    ...
                    <tr>
                        <th colspan="5" class="text-center">Kesimpulan
                            <?php if ($userInGroupPE || $userInGroupAdmin):
                                ...
                                $kesimpulanData = array_filter($faktors2, function ($item) use ($kodebpr, $periodeId) {
            ...
            <table class="table">
                <tbody>
                    <?php
                    // Filter faktor2 data for current BPR and period
                    $filteredFaktors = array_filter($faktors2, function ($item) use ($kodebpr, $periodeId) {
                        return $item['kodebpr'] == $kodebpr && $item['periode_id'] == $periodeId;
                    });
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="<?= base_url('faktor2/ubah'); ?>" method="post">
                        <!-- Hidden field untuk faktor2id -->
                        <input type="hidden" name="faktor2id" id="id-faktor2" value="">
                        <div class="mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <select name="nilai" id="nilai" class="form-control" required>
                                <option>Pilih nilai faktor2</option>
...
<?php if (!empty($faktors2)) { ?>
    <div class="modal fade" id="modalUbahkesimpulan">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Kesimpulan Penilaian Faktor 2 </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('faktor2/ubahkesimpulan'); ?>" method="post">
                        <input type="hidden" name="faktor2id" id="id-faktor2" value="">
                        <div class="mb-3">
...
<div class="modal fade" id="modaltambahNilai">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="<?= base_url('faktor2/tambahNilai'); ?>" method="post">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor2_id" id="id-faktor2" readonly>
                    <div class="mb-3">
                        <label for="sub_category" class="form-label">Sub Kategori: </label>
                        <textarea class="form-control" name="sub_category" id="sub_category" style="height: 100px"
                            readonly></textarea>
...
<script>
    $(document).ready(function () {
        // When the "Tambah Nilai" button is clicked, populate the id-faktor2 input field
        $('#modaltambahNilai').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            var faktor2Id = button.data('id'); // Extract the faktor2_id from data-id attribute

            var modal = $(this);
            modal.find('#id-faktor2').val(faktor2Id); // Set the value of #id-faktor2 input
        });

        // Optional: if you need to clear the value of #id-faktor2 when closing the modal
        $('#modaltambahNilai').on('hidden.bs.modal', function () {
            $(this).find('#id-faktor2').val('');
        });
    });
</script>
        ...
        <div class="modal-content">
            <form action="<?= base_url('faktor2/tambahKomentar'); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="faktor2_id" id="id-faktor2">
...
<div class="modal fade" id="modalHapusnilai2">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="btnHapusnilai2">Yakin</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?= base_url('faktor2/save_komentar'); ?>',
                method: 'POST',
                data: formData,
                dataType: 'json',
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function updateBadge(faktor2Id, newCount) {
            const badge = document.getElementById('notification-badge-' + faktor2Id);
            if (badge) {
                if (newCount > 0) {
        ...
        function fetchAndDisplayComments(faktor2Id, kodebpr, periodeId) {
            const modal = $('#modaltambahKomentar');
            modal.find('#komentarLamaList').html('<li>Memuat komentar...</li>'); // Show loading message

            $.ajax({
                url: '<?= base_url('faktor2/getKomentarByFaktorId'); ?>/' + faktor2Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                const faktor2Id = this.getAttribute('data-faktor-id');
                ...
                $('#modaltambahKomentar').find('#id-faktor2').val(faktor2Id);

                // Fetch and display comments when the modal opens
                fetchAndDisplayComments(faktor2Id, kodebpr, periodeId);

                // AJAX call to mark comments as read for the current user
                $.ajax({
                    url: '<?= base_url('faktor2/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        faktor2_id: faktor2Id,
                        kodebpr: kodebpr,
                        user_id: userId,
                        periode_id: periodeId,
                    ...
                    success: function (response) {
                        if (response.status === 'success') {
                            updateBadge(faktor2Id, 0); // Set badge to 0 after comments are marked read
                        } else {
        ...
        $('#formTambahKomentar').on('submit', function (e) {
            ...
            const faktor2Id = form.find('#id-faktor2').val(); // Get faktor2Id from the form's hidden input
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status === 'success') {
                        ...
                        fetchAndDisplayComments(faktor2Id, GLOBAL_KODEBPR, GLOBAL_ACTIVE_PERIODE_ID);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response && typeof response.unread_count !== 'undefined') {
                            updateBadge(faktor2Id, response.unread_count);
                        }
                    },
                    error: function (xhr, status, error) {
                        console.error('Error fetching unread count for factor ' + faktor2Id + ':', error);
                    }
                });
            });
        }
    ...
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor2/accdekom2'); ?>',
                method: 'POST',
                data: {
                    faktor2id: faktor2Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom').on('click', function () {
            ...
            $.ajax({
                url: '<?= base_url('faktor2/accdekom'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor2id: faktor2Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdekom2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor2/accdekom2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor2id: faktor2Id,
                    kodebpr: kodebpr,
...
<script>
    $(document).ready(function () {
        ...
        $('.btn-accdir2').on('click', function () {
            ...
            // Kirim permintaan AJAX ke server
            $.ajax({
                url: '<?= base_url('faktor2/accdir2'); ?>', // Gunakan base_url() agar lebih robust
                method: 'POST',
                data: {
                    faktor2id: faktor2Id,
                    kodebpr: kodebpr,
