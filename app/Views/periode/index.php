                    ...
                    <?php else: ?>
                        <div class="list-group">
                            <?php foreach ($periodes as $periode): ?>
                                <form action="<?= base_url('periode/handlePeriode') ?>" method="post" class="mb-2">
                                    ...
                                    <button type="submit"
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <strong>Periode Pelaporan Semester <?= esc($periode['semester']) ?> Tahun
                                                    <?= esc($periode['tahun']) ?></strong><br>
