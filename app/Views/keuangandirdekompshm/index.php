...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-headertitle">
            ...
            <h1 class="h3 mb-4 text-gray-800 text-center"><?= $judul; ?><br>(E0401)</h1>
        </div>
        ...
        <div class="card-body">
                    ...
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        <div class="btn-group" role="group" aria-label="Button group">
                            <button type="button" class="btn btn-primarys btn-sm" data-toggle="modal"
                                data-target="#modalTambahsahamdir"><i class="fa fa-plus"></i> Tambah Data Hubungan Keuangan
                                Anggota Direksi pada BPR</button>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            <table class="table table-info table-hover">
                <thead class="thead-primary">
                    <tr>
                        <th>Hubungan Keuangan Anggota Direksi pada BPR</th>
                    </tr>
                </thead>
            </table>
            <table class="table table-bordered table-hover">
                <tbody>
                    <?php if (
                        empty($keuangandirdekompshm) || !array_filter($keuangandirdekompshm, function ($row) {
                        return $row['jabatan'] === 'Direksi' &&
                            !empty($row['nama']) && !is_null($row['nama']) &&
                            !empty($row['nik']) && !is_null($row['nik']) &&
                            !empty($row['hubdir']) && !is_null($row['hubdir']) &&
                            !empty($row['hubdekom']) && !is_null($row['hubdekom']) &&
                            !empty($row['hubpshm']) && !is_null($row['hubpshm']);
                    })
                    ) { ?>
                        <tr>
                    ...
                    <?php } else { ?>
                        <?php
                        $i = 1;
                        foreach ($keuangandirdekompshm as $row):
                            ...
                            if (
                                ...
                                <tr>
                                    <th>Hubungan Keuangan Dengan Anggota Direksi Lain di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubdir']); ?></td>
                                </tr>
                                <tr>
                                    <th>Hubungan Keuangan Dengan Anggota Dewan Komisaris Lain di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubdekom']); ?></td>
                                </tr>
                                <tr>
                                    <th>Hubungan Keuangan Dengan Pemegang Saham Lain di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubpshm']); ?></td>
                                </tr>
                                <tr>
                                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                                        <td colspan="3">
                                            <button type="button" class="btn btn-outline-warning btn-sm" data-toggle="modal"
                                                ...
                                                data-hubdir="<?= htmlspecialchars($row['hubdir']); ?>"
                                                data-hubdekom="<?= htmlspecialchars($row['hubdekom']); ?>"
                                                data-hubpshm="<?= htmlspecialchars($row['hubpshm'] ?? ''); ?>">
                ...
                <div>
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        ...
                        <button type="button" class="btn btn-primary2 btn-sm" data-toggle="modal"
                            ...
                            <i class="fa fa-plus"></i> Tambah data Hubungan Keuangan Anggota Dewan Komisaris pada BPR
                        </button>
                    <?php endif; ?>
                </div>
            </div>
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($keuangandirdekompshm as $row):
                            ...
                            if (
                                ...
                                <tr>
                                    <th>Hubungan Keuangan Dengan Anggota Direksi di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubdir']); ?></td>
                                </tr>
                                <tr>
                                    <th>Hubungan Keuangan Dengan Anggota Dewan Komisaris di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubdekom']); ?></td>
                                </tr>
                                <tr>
                                    <th>Hubungan Keuangan Dengan Pemegang Saham di BPR :</th>
                                    <td><?= htmlspecialchars($row['hubpshm']); ?></td>
                                </tr>
                                <tr>
                                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                ...
                <div>
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        ...
                        <button type="button" class="btn btn-primary2 btn-sm" data-toggle="modal"
                            ...
                            <i class="fa fa-plus"></i> Tambah data Hubungan Keuangan Pemegang Saham pada BPR
                        </button>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <div class="card shadow-sm approval-card">
                            <div class="card-body approval-card-body">
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Keuangandirdekompshm/approveSemuaKom') ?>"
                                    ...
                                    <a href="<?= base_url('Keuangandirdekompshm/unapproveSemuaKom') ?>"
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm approvaldir-card">
                            <div
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Keuangandirdekompshm/approveSemuaDirut') ?>"
                                    ...
                                    <a href="<?= base_url('Keuangandirdekompshm/unapproveSemuaDirut') ?>"
            ...
            <div class="d-flex justify-content-center mb-5">
                <div class="d-flex justify-content-center gap-2 mb-5">
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        <a href="<?= base_url('Keuangandirdekompshm/exporttxtkeuangandirdekompshm'); ?>"
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group me-2" role="group" aria-label="First group">
                                <button type="button" class="btn btn-outline-primary btn-sm"
                                    onclick="window.location.href='<?= base_url('Shmdirdekomlain') ?>'">
                                    << </button>
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            onclick="window.location.href='<?= base_url('Keluargadirdekompshm') ?>'">>></button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Keuangandirdekompshm/ubahdata'); ?>" method="post">
                        ...
                        <div class="mb-3">
                            <label for="hubdir" class="form-label">Nama Kelompok Usaha BPR:</label>
                            <input class="form-control" type="text" name="hubdir" id="hubdir"
                                value="<?= isset($row['hubdir']) ? esc($row['hubdir']) : ''; ?>" maxlength="16" required>
                            <small id="hubdir" class="form-text text-muted">Format pengisian: Nama - Hubungan
                                Keuangan. Jika tidak ada data maka isi "Tidak ada"</small>
                        </div>
                        <div class="mb-3">
                            <label for="hubdekom" class="form-label">Input Persentase Kepemilikan (%):</label>
                            <input class="form-control" type="text" name="hubdekom" id="hubdekom"
                                value="<?= isset($row['hubdekom']) ? esc($row['hubdekom']) : ''; ?>" required>
                            <small id="hubdekom" class="form-text text-muted">Format pengisian: Nama - Hubungan
                                Keuangan. Jika tidak ada data maka isi "Tidak ada"</small>
                        </div>
                        <div class="form-group">
                            <label for="hubpshm" class="form-label">Input Persentase Kepemilikan (%) Tahun
                                Sebelumnya : </label>
                            <input class="form-control" type="text" name="hubpshm" id="hubpshm"
                                placeholder="<?= isset($row['hubpshm']) ? esc($row['hubpshm']) : ''; ?>" required></input>
                            <small id="hubpshm" class="form-text text-muted">Format pengisian: Nama - Hubungan
                                Keuangan. Jika tidak ada data maka isi "Tidak ada"</small>
                        </div>
                </div>
...
<div class="modal fade" id="modalTambahketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('keuangandirdekompshm/tambahketerangan'); ?>" method="post">
...
<div class="modal fade" id="modaleditketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('keuangandirdekompshm/editketerangan'); ?>" method="post">
...
<div class="modal fade" id="modalTambahsahamdir">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Hubungan Keuangan Dengan Anggota Direksi Lain di BPR</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('Keuangandirdekompshm/tambahsahamdir'); ?>" method="post">
                    <div class="form-group">
                        <label for="nama">Input Nama Anggota Direksi:</label>
                    ...
                    <div class="form-group">
                        <label for="hubdir">Hubungan Keuangan Dengan Anggota Direksi Lain di BPR: </label>
                        <input type="text" name="hubdir" id="hubdir" class="form-control" required>
                        <small id="hubdir" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keuangan. Jika tidak ada data maka isi "Tidak ada"</small>
                    </div>
                    <div class="form-group">
                        <label for="hubdekom">Hubungan Keuangan Dengan Anggota Dewan Komisaris Lain di BPR: </label>
                        <input type="text" name="hubdekom" id="hubdekom" class="form-control" required>
                        <small id="hubdekom" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keuangan. Jika tidak ada data maka isi "Tidak ada"</small>
                    </div>
                    <div class="form-group">
                        <label for="hubpshm">Hubungan Keuangan Dengan Pemegang Saham Lain di BPR: </label>
                        <input type="text" name="hubpshm" id="hubpshm" class="form-control" required>
                        <small id="hubpshm" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keuangan. Jika tidak ada data maka isi "Tidak ada"</small>
                    </div>
            </div>
...
<div class="modal fade" id="modalTambahsahamdekom">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Hubungan Keuangan Dengan Anggota Dewan Komisaris Lain di BPR</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= base_url('Keuangandirdekompshm/tambahsahamdekom'); ?>" method="post">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="hubdir">Input Hubungan Keuangan Dengan Anggota Direksi Lain di BPR: </label>
                        <input type="text" name="hubdir" id="hubdir" class="form-control" required>
                        <small id="hubdekom" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keuangan. Jika tidak ada data maka isi "Tidak ada"</small>
                    </div>
                    <div class="form-group">
                        <label for="hubdekom">Input Hubungan Keuangan Dengan Anggota Dewan Komisaris Lain di BPR:
                        </label>
                        <input type="text" name="hubdekom" id="hubdekom" class="form-control" required>
                        <small id="hubdekom" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keuangan. Jika tidak ada data maka isi "Tidak ada"</small>
                    ...
                    <div class="form-group">
                        <label for="hubpshm">Input Hubungan Keuangan Dengan Pemegang Saham di BPR: </label>
                        <input type="text" name="hubpshm" id="hubpshm" class="form-control" required>
                        <small id="hubdekom" class="form-text text-muted">Format pengisian: Nama - Hubungan
                            Keuangan. Jika tidak ada data maka isi "Tidak ada"</small>
                    </div>
...
<div class="modal fade" id="modalTambahsahampshm">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Keuangandirdekompshm/tambahsahampshm'); ?>" method="post">
                    <div class="form-group">
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    ...
                    window.location.href = "/keuangandirdekompshm/setNullKolomTindak/" + id;
                }
            });
        });
    });
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    window.location.href = "/Keuangandirdekompshm/setNullKolomPenjelaslanjut/" + id;
                }
            });
        });
    });
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchAndDisplayComments(Id, kodebpr, periodeId) {
            ...
            $.ajax({
                url: '<?= base_url('keuangandirdekompshm/getKomentarByFaktorId'); ?>/' + Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                $.ajax({
                    url: '<?= base_url('keuangandirdekompshm/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function pollUnreadCounts() {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('keuangandirdekompshm/getUnreadCommentCountForFactor'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function refreshBadgeForAllUsers(exceptUserId) {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('keuangandirdekompshm/getUnreadCommentCountForAllUsers'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
