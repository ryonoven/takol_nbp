...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-headertitle">
            ...
            <h1 class="h3 mb-4 text-gray-800 text-center"><?= $judul; ?><br>(E0301)</h1>
        </div>
        ...
        <div class="card-body">
                    ...
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        <div class="btn-group" role="group" aria-label="Button group">
                            <button type="button" class="btn btn-primarys btn-sm" data-toggle="modal"
                                data-target="#modalTambahsahamdir"><i class="fa fa-plus"></i> Tambah Data Saham Direksi pada
                                BPR</button>
                        </div>
                    <?php endif; ?>
                </div>
                    ...
                    <?php if (empty($sahamdirdekom)) { ?>
                        <tr>
                            <td colspan="3" class="text-center">
                                <em>Tidak ada data kepemilikan saham anggota Direksi pada BPR</em>
                            </td>
                        </tr>
                    <?php } else { ?>
                        <?php
                        $i = 1;
                        foreach ($sahamdirdekom as $row):
                ...
                <div>
                    <?php if ($userInGroupPE || $userInGroupAdmin): ?>
                        ...
                        <button type="button" class="btn btn-primary2 btn-sm" data-toggle="modal"
                            ...
                            <i class="fa fa-plus"></i> Tambah data kepemilikan saham anggota Dewan Komisaris pada BPR
                        </button>
                    <?php endif; ?>
                </div>
            </div>
                        ...
                        <div class="card shadow-sm approval-card">
                            <div class="card-body approval-card-body">
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Sahamdirdekom/approveSemuaKom') ?>"
                                    ...
                                    <a href="<?= base_url('Sahamdirdekom/unapproveSemuaKom') ?>"
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm approvaldir-card">
                            <div
                                ...
                                <div class="approval-buttons-container"> <a
                                        href="<?= base_url('Sahamdirdekom/approveSemuaDirut') ?>"
                                    ...
                                    <a href="<?= base_url('Sahamdirdekom/unapproveSemuaDirut') ?>"
            ...
            <div class="d-flex justify-content-center mb-5">
                <div class="d-flex justify-content-center gap-2 mb-5">
                    <!-- <a href="<?= base_url('Sahamdirdekom/exporttxtsahamdirdekom'); ?>" class="btn btn-secondary btn-sm">
                        ...
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group me-2" role="group" aria-label="First group">
                                <button type="button" class="btn btn-outline-primary btn-sm"
                                    onclick="window.location.href='<?= base_url('Strukturkomite') ?>'">
                                    << </button>
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                        ...
                                        <button style="background-color: #000; color: #fff;" type="button" class="btn btn-outline-primary btn-sm"
                                        ...
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            onclick="window.location.href='<?= base_url('Shmusahadirdekom') ?>'">>></button>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="modalTambahketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('sahamdirdekom/tambahketerangan'); ?>" method="post">
...
<div class="modal fade" id="modaleditketerangan">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('sahamdirdekom/editketerangan'); ?>" method="post">
...
<div class="modal fade" id="modalTambahsahamdir">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Kepemilikan Saham Anggota Direksi dan Anggota Dewan Komisaris pada BPR
                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            ...
            <div class="modal-body">
                <form action="<?= base_url('Sahamdirdekom/tambahsahamdir'); ?>" method="post">
                    ...
                    <div class="mb-3">
                        <label for="nik" class="form-label">Input NIK:</label>
                        <input class="form-control" type="text" name="nik" id="nikTambah" required>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('Sahamdirdekom/tambahsahamdekom'); ?>" method="post">
                    <div class="form-group">
                        <label for="nama">Input Nama Dewan Komisaris:</label>
                        <input type="text" name="nama" id="nama" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label for="nik" class="form-label">Input NIK:</label>
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    ...
                    window.location.href = "/sahamdirdekom/setNullKolomTindak/" + id;
                }
            });
        });
    });
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btnSetNulls.forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                if (confirm("Apakah Anda yakin hendak menghapus data nilai dan keterangan ini?")) {
                    window.location.href = "/Sahamdirdekom/setNullKolomPenjelaslanjut/" + id;
                }
            });
        });
    });
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function fetchAndDisplayComments(Id, kodebpr, periodeId) {
            ...
            $.ajax({
                url: '<?= base_url('sahamdirdekom/getKomentarByFaktorId'); ?>/' + Id,
                method: 'GET',
                data: {
                    kodebpr: kodebpr,
        ...
        commentButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                $.ajax({
                    url: '<?= base_url('sahamdirdekom/markUserCommentsAsRead'); ?>',
                    method: 'POST',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function pollUnreadCounts() {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('sahamdirdekom/getUnreadCommentCountForFactor'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
        ...
        function refreshBadgeForAllUsers(exceptUserId) {
            ...
            commentButtons.forEach(button => {
                ...
                $.ajax({
                    url: '<?= base_url('sahamdirdekom/getUnreadCommentCountForAllUsers'); ?>',
                    method: 'GET',
                    data: {
                        id: Id,
                        kodebpr: kodebpr,
